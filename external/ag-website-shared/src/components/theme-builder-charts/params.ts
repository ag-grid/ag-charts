...
export const PARAM_GROUPS: ChartsParamGroup[] = [
    ...
    },
    {
        ...
        params: [
            ...
            { key: 'buttonHorizontalPadding', label: 'Button Horizontal Padding', icon: 'horizontalSpacing', min: 0, max: 32 },
            { key: 'buttonVerticalPadding', label: 'Button Vertical Padding', icon: 'verticalSpacing', min: 0, max: 32 },
