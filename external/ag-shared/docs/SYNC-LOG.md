...
- **[AGENTS.md]** Added "Tooling Health Check" section — on every conversation start, verifies canary skills are present and displays a warning if agentic tooling is not initialised.
