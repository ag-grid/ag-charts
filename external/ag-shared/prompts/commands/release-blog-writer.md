---
targets: ['*']
description: 'Write a release blog post for a new version of AG Charts following the established template and style'
---
...
This command MUST write its output to a file (see Final Output below). If using plan mode for drafting, **exit plan mode** before writing the blog post file. Do not finish the command while still in plan mode — the results will be lost.
