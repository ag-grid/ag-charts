---
targets: ['*']
description: 'Run PREVis visual quality evaluation on gallery examples'
---
...
-   [ ] Browser automation ready (if using claude-in-chrome, may need to accept self-signed cert manually first)
...
IMPORTANT: Use the **previs-evaluator** agent (NOT data-viz-designer) for PREVis analysis. The previs-evaluator is specialized for quality assessment and lacks browser automation tools, preventing redundant screenshot capture.
