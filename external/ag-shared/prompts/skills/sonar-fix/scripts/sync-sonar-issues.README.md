...
```bash
SONAR_TOKEN=your_token npx tsx external/prompts/commands/sonar-fix/scripts/sync-sonar-issues.ts
```
...
```bash
SONAR_TOKEN=your_token npx tsx external/prompts/commands/sonar-fix/scripts/sync-sonar-issues.ts --dry-run
```
...
```bash
SONAR_TOKEN=your_token npx tsx external/prompts/commands/sonar-fix/scripts/sync-sonar-issues.ts --dry-run --verbose
```
