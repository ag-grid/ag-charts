 ...
 *
 * Usage:
 *   SONAR_TOKEN=<your-token> npx tsx external/prompts/commands/sonar-fix/scripts/sync-sonar-issues.ts
 *
 *   # Dry run (preview only):
 *   SONAR_TOKEN=<your-token> npx tsx external/prompts/commands/sonar-fix/scripts/sync-sonar-issues.ts --dry-run
 *
 *   # Custom projects:
 *   SONAR_TOKEN=<your-token> npx tsx external/prompts/commands/sonar-fix/scripts/sync-sonar-issues.ts \
