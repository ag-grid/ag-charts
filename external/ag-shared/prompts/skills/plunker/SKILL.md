...
This skill guides you through creating and managing Plunker examples for AG Charts demos.

## When to Use This Skill

-   Creating a new Plunker example for AG Charts
-   Forking and modifying an existing plunk
-   Troubleshooting Plunker structure or styling issues
-   Setting up AG Charts demos for sharing
