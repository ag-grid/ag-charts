 ...
 *   * Class instances are replaced with `ClassNameClass {}`, with the exception of classes specified in `REPLACEMENT_CLASS_MAPPING`, which have custom values.
 *   * Other select types are also replaced in the `getReplacementValue` function for better readability
 *
 */
