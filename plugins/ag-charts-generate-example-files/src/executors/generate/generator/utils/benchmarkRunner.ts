...
/**
 * Resolve to compiled benchmarkHarness.src.js.
...
function getCompiledPath(): string {
    ...
    const distPath = path.join(__dirname, 'benchmarkHarness.src.js');
    ...
    const fromSourcePath = path.resolve(
        __dirname,
        '../../../../dist/src/executors/generate/generator/utils/benchmarkHarness.src.js'
    );
 ...
 *
 * Source: benchmarkHarness.src.ts (compiled by Nx build)
 */
