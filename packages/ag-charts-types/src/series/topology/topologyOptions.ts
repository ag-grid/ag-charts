...
export type AgTopologySeriesOptions<TDatum = DatumDefault, TContext = ContextDefault> =
...
export interface AgBaseTopologyThemeOptions<TDatum = DatumDefault, TContext = ContextDefault>
