...
> {
    ...
    /** Configuration for the area at the centre of the series. Has no effect unless `innerRadiusRatio` or `innerRadiusOffset` carves out a centre. */
    innerCircle?: AgSunburstInnerCircle;
    /** Configuration for the labels at the centre of the series. Has no effect unless `innerRadiusRatio` or `innerRadiusOffset` carves out a centre. */
