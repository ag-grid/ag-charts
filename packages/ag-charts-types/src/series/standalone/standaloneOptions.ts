...
import type { AgOrganisationSeriesOptions } from './organisationOptions';
...
export type AgStandaloneSeriesOptions<TDatum = DatumDefault, TContext = ContextDefault> =
    | AgOrganisationSeriesOptions<TDatum, TContext>
