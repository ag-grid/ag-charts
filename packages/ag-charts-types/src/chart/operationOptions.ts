import type { AgGradientColor, AgImageColor, AgPatternColor } from '../series/cartesian/commonOptions';
...
type ExcludeLeaves = string | symbol | number | undefined | AgGradientColor | AgPatternColor | AgImageColor;
