...
export type AgRadialGaugeOptions = AgBasePresetOptions & AgRadialGaugeSeriesOptions;
export type AgLinearGaugeOptions = AgBasePresetOptions & AgLinearGaugeSeriesOptions;
