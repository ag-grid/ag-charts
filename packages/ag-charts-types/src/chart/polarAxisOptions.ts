...
export interface AgAngleCategoryAxisOptions<TContext> extends AgBaseAxisOptions<TContext, AgAngleAxisLabelOptions> {
    type: 'angle-category';
...
export interface AgAngleNumberAxisOptions<TContext>
