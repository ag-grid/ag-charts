...
export const AgCharts = ChartWithConstructor<AgChartProps>((options) => AgChartsAPI.create(options), 'AgCharts');
...
export const AgFinancialCharts = ChartWithConstructor<AgFinancialChartProps>(
