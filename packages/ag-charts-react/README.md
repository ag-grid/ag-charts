...
<div align="center">
    ...
    <div align="center">
        <h4><a href="https://charts.ag-grid.com">🌐 Website</a> • <a href="https://charts.ag-grid.com/react/quick-start/">📖 Documentation</a> • <a href="https://charts.ag-grid.com/gallery/">📊 Gallery</a></h4>
    </div>
    <br>
...
-   `ag-charts-community` is free, available under the MIT license, and comes with core series types, such as [Pie](https://charts.ag-grid.com/react/pie-series/), [Area](https://charts.ag-grid.com/react/area-series/), [Bar](https://charts.ag-grid.com/react/bar-series/), [Scatter](https://charts.ag-grid.com/react/scatter-series/) and [Bubble](https://charts.ag-grid.com/react/bubble-series/) in addition to all of the key features expected from a React charting library, including [Accessibility](https://charts.ag-grid.com/react/accessibility/), [Tooltips](https://charts.ag-grid.com/react/tooltips/), [Themes](https://charts.ag-grid.com/react/themes/), [Markers](https://charts.ag-grid.com/react/markers/), [Legends](https://charts.ag-grid.com/react/legend/), [Axis Types](https://charts.ag-grid.com/react/axes-types/) and [Secondary Axes](https://charts.ag-grid.com/react/axes-secondary/).
-   `ag-charts-enterprise` is available under a commercial license and comes with additional series types, such as [Maps](https://charts.ag-grid.com/react/maps/), [Sankey](https://charts.ag-grid.com/react/sankey-series/), [Radar](https://charts.ag-grid.com/react/radar-area-series/), and [Waterfall](https://charts.ag-grid.com/react/waterfall-series/) Charts as well as advanced interactivity features, like [Animations](https://charts.ag-grid.com/react/animation/), [Context Menus](https://charts.ag-grid.com/react/context-menu/), [Zooming](https://charts.ag-grid.com/react/zoom/), [Navigators](https://charts.ag-grid.com/react/navigator/), [Synchronization](https://charts.ag-grid.com/react/sync/) and much more, including [Financial Charts](https://charts.ag-grid.com/react/financial-charts/).
...
| ----------------------------------------------------------------------- | ------------------- | -------------------- |
| [Bar](https://charts.ag-grid.com/react/bar-series/)                     | ✅                  | ✅                   |
| [Line](https://charts.ag-grid.com/react/line-series/)                   | ✅                  | ✅                   |
| [Area](https://charts.ag-grid.com/react/area-series/)                   | ✅                  | ✅                   |
| [Scatter](https://charts.ag-grid.com/react/scatter-series/)             | ✅                  | ✅                   |
| [Bubble](https://charts.ag-grid.com/react/bubble-series/)               | ✅                  | ✅                   |
| [Pie](https://charts.ag-grid.com/react/pie-series/)                     | ✅                  | ✅                   |
| [Donut](https://charts.ag-grid.com/react/donut-series/)                 | ✅                  | ✅                   |
| [Combination](https://charts.ag-grid.com/react/combination-series/)     | ✅                  | ✅                   |
| [Box Plot](https://charts.ag-grid.com/react/box-plot-series/)           | ❌                  | ✅                   |
| [Bullet](https://charts.ag-grid.com/react/bullet-series/)               | ❌                  | ✅                   |
| [Candlestick](https://charts.ag-grid.com/react/candlestick-series/)     | ❌                  | ✅                   |
| [OHLC](https://charts.ag-grid.com/react/ohlc-series/)                   | ❌                  | ✅                   |
| [Heatmap](https://charts.ag-grid.com/react/heatmap-series/)             | ❌                  | ✅                   |
| [Histogram](https://charts.ag-grid.com/react/histogram-series/)         | ❌                  | ✅                   |
| [Nightingale](https://charts.ag-grid.com/react/nightingale-series/)     | ❌                  | ✅                   |
| [Radar Line](https://charts.ag-grid.com/react/radar-line-series/)       | ❌                  | ✅                   |
| [Radar Area](https://charts.ag-grid.com/react/radar-area-series/)       | ❌                  | ✅                   |
| [Radial Column](https://charts.ag-grid.com/react/radial-column-series/) | ❌                  | ✅                   |
| [Radial Bar](https://charts.ag-grid.com/react/radial-bar-series/)       | ❌                  | ✅                   |
| [Range Area](https://charts.ag-grid.com/react/range-area-series/)       | ❌                  | ✅                   |
| [Range Bar](https://charts.ag-grid.com/react/range-bar-series/)         | ❌                  | ✅                   |
| [Sunburst](https://charts.ag-grid.com/react/sunburst-series/)           | ❌                  | ✅                   |
| [Treemap](https://charts.ag-grid.com/react/treemap-series/)             | ❌                  | ✅                   |
| [Waterfall](https://charts.ag-grid.com/react/waterfall-series/)         | ❌                  | ✅                   |
| [Sankey](https://charts.ag-grid.com/react/sankey-series/)               | ❌                  | ✅                   |
| [Chord](https://charts.ag-grid.com/react/chord-series/)                 | ❌                  | ✅                   |
...
| ---------------------------------------------------------------------------- | ------------------- | -------------------- |
| [Accessibility](https://charts.ag-grid.com/react/accessibility/)             | ✅                  | ✅                   |
| [Localisation](https://charts.ag-grid.com/react/localisation/)               | ✅                  | ✅                   |
| [Series Highlighting](https://charts.ag-grid.com/react/series-highlighting/) | ✅                  | ✅                   |
| [Tooltips](https://charts.ag-grid.com/react/tooltips/)                       | ✅                  | ✅                   |
| [Animations](https://charts.ag-grid.com/react/animation/)                    | ❌                  | ✅                   |
| [Context Menu](https://charts.ag-grid.com/react/context-menu/)               | ❌                  | ✅                   |
| [Crosshairs](https://charts.ag-grid.com/react/axes-crosshairs/)              | ❌                  | ✅                   |
| [Navigator](https://charts.ag-grid.com/react/navigator/)                     | ❌                  | ✅                   |
| [Synchronization](https://charts.ag-grid.com/react/sync/)                    | ❌                  | ✅                   |
| [Zoom](https://charts.ag-grid.com/react/zoom/)                               | ❌                  | ✅                   |
...
The default chart type is [Candlestick](https://charts.ag-grid.com/react/candlestick-series/), with additional types like [OHLC](https://charts.ag-grid.com/react/ohlc-series/) and [Line](https://charts.ag-grid.com/react/line-series/) for versatile data visualisation.
...
> [!IMPORTANT]
> For more information on building React Charts with AG Charts, refer to our [Documentation](https://charts.ag-grid.com/react/quick-start/).
...
AG Charts is used within AG Grid to power the [Integrated Charting](https://www.ag-grid.com/react-data-grid/integrated-charts/) feature.
