...
describe('number format', () => {
    ...
    test('number of significant digits', () => {
        expect(createNumberFormatter(',.3r')(0.077)).toBe('0.0770');
        expect(createNumberFormatter(',.3r')(0.07777)).toBe('0.0778');
        expect(createNumberFormatter(',.3r')(0.77777)).toBe('0.778');
        expect(createNumberFormatter(',.3r')(7.7777)).toBe('7.78');
        expect(createNumberFormatter(',.3r')(77.777)).toBe('77.8');
        expect(createNumberFormatter(',.3r')(777.77)).toBe('778');
        expect(createNumberFormatter(',.3r')(7777.7)).toBe('7,780');
        expect(createNumberFormatter(',.3r')(77777)).toBe('77,800');
    });
    test('grouped thousands', () => {
        expect(createNumberFormatter(',d')(1)).toBe('1');
        expect(createNumberFormatter(',d')(12)).toBe('12');
        expect(createNumberFormatter(',d')(123)).toBe('123');
        expect(createNumberFormatter(',d')(1234)).toBe('1,234');
        expect(createNumberFormatter(',d')(12345)).toBe('12,345');
        expect(createNumberFormatter(',d')(123456)).toBe('123,456');
        expect(createNumberFormatter(',d')(1234567)).toBe('1,234,567');
        expect(createNumberFormatter(',d')(12345678)).toBe('12,345,678');
        expect(createNumberFormatter(',d')(-1)).toBe('\u22121');
        expect(createNumberFormatter(',d')(-12)).toBe('\u221212');
        expect(createNumberFormatter(',d')(-123)).toBe('\u2212123');
        expect(createNumberFormatter(',d')(-1234)).toBe('\u22121,234');
