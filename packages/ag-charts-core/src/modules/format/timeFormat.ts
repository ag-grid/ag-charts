    ...
    while ((match = re.exec(formatString)) !== null) {
        ...
        formatParts.push((date) => {
            switch (spec) {
                ...
                case 'd':
                    return pad(date.getDate(), 2, padChar);
                case 'e':
                    return pad(date.getDate(), 2, padCharMap['_']);
                case 'f':
                    return pad(date.getMilliseconds() * 1000, 6, padChar);
                case 'H':
                    return pad(date.getHours(), 2, padChar);
                case 'I': {
                    const h = date.getHours() % 12 || 12;
                    return pad(h, 2, padChar);
                }
                case 'j':
                    return pad(dayOfYear(date), 3, padChar);
                case 'm':
                    return pad(date.getMonth() + 1, 2, padChar);
                case 'M':
                    return pad(date.getMinutes(), 2, padChar);
                case 'L':
                    return pad(date.getMilliseconds(), 3, padChar);
                case 'p':
                ...
                case 'S':
                    return pad(date.getSeconds(), 2, padChar);
                case 'u':
                    return String(date.getDay() || 7);
                case 'U':
                    return pad(weekOfYear(date, 0), 2, padChar);
                case 'V':
                    return pad(isoWeekOfYear(date), 2, padChar);
                case 'w':
                    return String(date.getDay());
                case 'W':
                    return pad(weekOfYear(date, 1), 2, padChar);
                case 'x':
                ...
                case 'y':
                    return pad(date.getFullYear() % 100, 2, padChar);
                case 'Y':
