...
module.exports = {
    forbidden: [
        ...
        {
            name: 'ag-isolated-locale',
            comment: 'Locale modules should be isolated.',
            severity: 'error',
        ...
        },
        {
            ...
            severity: 'error',
            from: { path: '^src/.*/.*', pathNot: ['src/module-bundles/integrated.ts'] },
            to: {
                path: '^src/[^/]*\\.ts',
                pathNot: ['src/version.ts', 'ag-charts-types/', 'ag-charts-locale/'],
            },
        },
    ],
    options: {
