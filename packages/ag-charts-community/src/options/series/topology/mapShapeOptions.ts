...
export interface AgMapShapeSeriesMarker<TDatum> extends AgSeriesMarkerOptions<AgMapShapeSeriesOptionsKeys, TDatum> {
...
export interface AgMapShapeSeriesThemeableOptions<TDatum = any>
    ...
    background?: AgMapShapeSeriesBackground;
    /** Configuration for the markers used in the series. */
    marker?: AgMapShapeSeriesMarker<TDatum>;
