...
export interface AgNodeClickEvent<TDatum> extends AgNodeBaseClickEvent<'seriesNodeClick', TDatum> {}
export interface AgNodeDoubleClickEvent<TDatum> extends AgNodeBaseClickEvent<'seriesNodeDoubleClick', TDatum> {}
...
export interface AgBaseChartListeners<TDatum> {
    ...
    seriesNodeClick?: (event: AgNodeClickEvent<TDatum>) => any;
    ...
    seriesNodeDoubleClick?: (event: AgNodeDoubleClickEvent<TDatum>) => any;
...
export interface AgSeriesListeners<TDatum> {
    ...
    nodeClick?: (params: AgSeriesNodeClickParams<TDatum>) => void;
    /** The listener to call when a node (marker, column, bar, tile or a pie sector) in the series is double clicked. */
    nodeDoubleClick?: (params: AgSeriesNodeClickParams<TDatum>) => void;
}

export interface AgSeriesNodeClickParams<TDatum> {
    /** Event type. */
    type: 'nodeClick';
    /** Series ID, as specified in series.id (or generated if not specified) */
    seriesId: string;
