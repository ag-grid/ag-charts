...
export * from './chart/interaction/nodeDatumManager';
...
export { BarSeries } from './chart/series/cartesian/barSeries';
export { LineSeries } from './chart/series/cartesian/lineSeries';
export { ScatterSeries } from './chart/series/cartesian/scatterSeries';
