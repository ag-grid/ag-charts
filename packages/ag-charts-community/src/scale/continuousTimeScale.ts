...
export class ContinuousTimeScale extends ContinuousScale<Date, TimeInterval | TimeIntervalUnit | number> {
    static override is(value: unknown): value is ContinuousTimeScale {
        return value instanceof ContinuousTimeScale;
    }

    readonly type = 'continuous-time';
