...
import type { DatumIndexType, IProperties, ISeries, SeriesNodeDatum, SeriesNodeEventTypes } from '../seriesTypes';
...
> {
    ...
    constructor(
        ...
        series: ISeries<number, SeriesNodeDatum<number>, IProperties & { xKey?: string; yKey?: string }>
    ) {
