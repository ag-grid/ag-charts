...
export function getShapeFill(
    ...
    if (isPatternFill(fill)) {
        ...
        return {
            ...
            fillOpacity: 1, //fill.fillOpacity ?? defaultPattern.fillOpacity,
            backgroundFill: fill.backgroundFill ?? defaultPattern.backgroundFill,
            backgroundFillOpacity: 1, //fill.backgroundFillOpacity ?? defaultPattern.backgroundFillOpacity,
    ...
    if (isImageFill(fill)) {
        return {
            ...
            backgroundFillOpacity: 1, //fill.backgroundFillOpacity ?? defaultImage.backgroundFillOpacity,
