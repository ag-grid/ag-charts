...
function isRadialGaugeSeries(series: Series<any, any, any>): series is RadialGaugeSeries {
    return series.type === 'radial-gauge';
}

function isLinearGaugeSeries(series: Series<any, any, any>): series is LinearGaugeSeries {
