...
export const themeOptionsDef: OptionsDefs<AgChartTheme> = {
    ...
    params: {
        ...
        buttonHoverBackgroundColor: colorOrRef,
        buttonHoverBorder: or(boolean, themeParamBorder),
        buttonHoverTextColor: colorOrRef,
        buttonActiveBackgroundColor: colorOrRef,
        buttonActiveBorder: or(boolean, themeParamBorder),
        buttonActiveTextColor: colorOrRef,
