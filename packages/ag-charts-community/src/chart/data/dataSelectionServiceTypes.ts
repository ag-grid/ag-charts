import type { ISeries, ISeriesOptions, SelectionState, SeriesNodeDatum } from '../series/seriesTypes';
...
type SeriesLike = ISeries<SeriesNodeDatum, ISeriesOptions, unknown>;
