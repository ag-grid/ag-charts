        ...
        describe('property tests', () => {
            ...
            it('should extract the configured accumulated values', () => {
                ...
                expect(extractGroupValues(result, 0)).toEqual([
                    [21.73913043478261, 56.52173913043478, 69.56521739130434, 100],
                    [22.22222222222222, 55.55555555555556, 66.66666666666667, 100],
                ]);
                expect(extractGroupValues(result, 1)).toEqual([
                    [15, 52.5, 82.5, 100],
                    [28.571428571428573, 71.42857142857143, 88.0952380952381, 100],
                ]);
            });
            ...
            it('should calculate the domains', () => {
                ...
                expect(result.domain.values).toEqual([
                    ...
                    [52.5, 71.42857142857143],
                    [66.66666666666667, 88.0952380952381],
                    [100, 100],
                ]);
            });
        });
