...
describe('DataController', () => {
    ...
    it('should merge compatible requests with identical definitions', async () => {
        ...
        const promise1 = controller.request('test1', dataRef, def);
        const promise2 = controller.request('test2', dataRef, def);
    ...
    it('should merge compatible requests with different ids', async () => {
        const dataRef = new DataRef(data);
        const promise1 = controller.request('test1', dataRef, {
            props: [
                {
                    id: 'keyProp1-key',
                    property: 'keyProp1',
        ...
        const promise2 = controller.request('test2', dataRef, {
            props: [
                {
                    id: 'keyProp2-key',
                    property: 'keyProp1',
    ...
    it('should not merge incompatible requests', async () => {
        const promise1 = controller.request('test1', new DataRef(data), {
            props: [
                {
                    id: 'keyProp1-key',
                    property: 'keyProp1',
        ...
        const promise2 = controller.request('test2', new DataRef(data), {
            props: [
                {
                    id: 'keyProp2-key',
                    property: 'keyProp2',
    ...
    describe('with multiple data sources', () => {
        it('should extract scoped data for each request with shared scopes', async () => {
            ...
            const promise1 = controller.request('test1', new DataRef(data1), def);
            const promise2 = controller.request('test2', new DataRef(data2), def);
        ...
        it('should extract scoped data for each request with unique scopes', async () => {
            ...
            const promise1 = controller.request('test1', new DataRef(data1), {
                props: [
                    {
                        id: 'keyProp1-key',
                        property: 'keyProp1',
            ...
            const promise2 = controller.request('test2', new DataRef(data2), {
                props: [
                    {
                        id: 'keyProp1-key',
                        property: 'keyProp1',
