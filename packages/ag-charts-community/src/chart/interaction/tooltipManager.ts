...
import type { Tooltip, TooltipContent, TooltipContent2, TooltipMeta, TooltipPointerEvent } from '../tooltip/tooltip';

interface TooltipState {
    content?: TooltipContent | TooltipContent2;
    meta?: TooltipMeta;
}
...
export class TooltipManager {
    ...
    public updateTooltip(callerId: string, meta?: TooltipMeta, content?: TooltipContent | TooltipContent2) {
