...
export const PALETTE_GRAY_FILL = Symbol('palette-gray-fill') as unknown as string;
export const PALETTE_GRAY_STROKE = Symbol('palette-gray-stroke') as unknown as string;
