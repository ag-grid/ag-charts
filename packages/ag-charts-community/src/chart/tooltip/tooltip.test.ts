...
`);
    ...
    describe('Realtime', () => {
        it('should update tooltip correctly', async () => {
            ...
            expect(element.map((e) => e.textContent).join('')).toEqual('4: 1.47');
            ...
            expect(element.map((e) => e.textContent).join('')).toEqual('6: 1.21');
            ...
            expect(element.map((e) => e.textContent).join('')).toEqual('8: 1.48');
