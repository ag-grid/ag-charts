...
import { calculatePlacement } from '../util/placement';
...
export abstract class Chart extends Observable {
    ...
    protected destroyWatermark() {
        this.watermark?.sourceImage.remove();
