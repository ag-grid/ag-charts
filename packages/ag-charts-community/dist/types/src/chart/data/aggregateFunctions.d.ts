...
export declare function sum(id: string, matchGroupId: string): AggregatePropertyDefinition<any, any, [number, number], [number, number]>;
export declare function groupSum(id: string, matchGroupId?: string): AggregatePropertyDefinition<any, any>;
export declare function range(id: string, matchGroupId: string): AggregatePropertyDefinition<any, any, [number, number], [number, number]>;
...
export declare function area(id: string, aggFn: AggregatePropertyDefinition<any, any>, matchGroupId?: string): AggregatePropertyDefinition<any, any, [number, number], [number, number]>;
