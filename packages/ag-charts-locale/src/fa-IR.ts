...
export const AG_CHARTS_LOCALE_FA_IR: Record<string, string> = {
  ...
  ariaAnnounceFlowProportionLink:
    'لینک ${index} از ${count}، از ${from} به ${to}، ${sizeName} ${size}',
  ...
  ariaAnnounceHierarchyDatum:
    'سطح ${level}[number]، ${count}[number] فرزند، ${description}',
  ariaAnnounceHoverDatum: '${datum}',
  ariaDescriptionLegendItem:
    'برای تغییر قابل مشاهده بودن، اسپیس یا اینتر را فشار دهید',
  ...
  ariaLabelLegendItem:
    '${label}، مورد فهرست ${index}[number] از ${count}[number]',
