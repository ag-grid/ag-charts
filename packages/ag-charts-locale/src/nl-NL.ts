...
export const AG_CHARTS_LOCALE_NL_NL: Record<string, string> = {
  ...
  ariaAnnounceFlowProportionLink:
    'link ${index} van ${count}, van ${from} naar ${to}, ${sizeName} ${size}',
  ariaAnnounceFlowProportionNode:
    'knooppunt ${index} van ${count}, ${description}',
  ...
  ariaAnnounceHierarchyDatum:
    'niveau ${level}[number], ${count}[number] kinderen, ${description}',
  ariaAnnounceHoverDatum: '${datum}',
  ariaDescriptionLegendItem:
    'Druk op Spatie of Enter om zichtbaarheid te wisselen',
  ...
  ariaLabelLegendItem:
    '${label}, Legenda-item ${index}[number] van ${count}[number]',
