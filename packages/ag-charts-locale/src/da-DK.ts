...
export const AG_CHARTS_LOCALE_DA_DK: Record<string, string> = {
  ...
  ariaAnnounceFlowProportionLink:
    'link ${index} af ${count}, fra ${from} til ${to}, ${sizeName} ${size}',
  ...
  ariaAnnounceHierarchyDatum:
    'niveau ${level}[number], ${count}[number] børn, ${description}',
  ariaAnnounceHoverDatum: '${datum}',
  ariaDescriptionLegendItem:
    'Tryk på mellemrumstasten eller Enter for at skifte synlighed',
  ...
  ariaLabelLegendItem:
    '${label}, Legend element ${index}[number] af ${count}[number]',
