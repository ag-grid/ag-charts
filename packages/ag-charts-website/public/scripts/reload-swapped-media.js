 ...
 *
 * Dark mode hid this wherever a `-dark` variant exists. Video.tsx swaps src to that file after
 * hydration, and re-setting src restarts resource selection as a side effect, so those videos
 * stalled in light mode alone. Any video without a `-dark` variant stalls in both schemes.
 *
