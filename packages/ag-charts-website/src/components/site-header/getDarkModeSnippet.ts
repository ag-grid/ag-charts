...
const DARK_MODE_SNIPPETS = {
    homepageHero: () => `
        options.theme = localStorage['documentation:darkmode'] === 'dark' ? 'ag-default-dark' : 'ag-default';
        agCharts.AgCharts.update(chart, options);
        document.querySelector('html').setAttribute('data-dark-mode', localStorage['documentation:darkmode'] === 'dark');
        `,
    ...
    vanilla: () => `
        options.theme = {
            ...options.theme,
            baseTheme: localStorage['documentation:darkmode'] === 'dark' ? 'ag-default-dark' : 'ag-default'
        }
        agCharts.AgCharts.update(chart, options);
        document.querySelector('html').setAttribute('data-dark-mode', localStorage['documentation:darkmode'] === 'dark');
        window.addEventListener('message', (event) => {
