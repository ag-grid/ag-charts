...
export const GALLERY_EXAMPLE_COPY: Record<string, GalleryExampleCopy> = {
    ...
    'line-with-gaps': {
        ...
        intro: 'This example shows a [line chart](/r/line-series/) built with AG Charts, comparing ten series whose readings are incomplete. Where a series has no value at a point, the [line breaks rather than joining across the gap](/r/line-series/#missing-data), so absent data is not mistaken for a trend. A [shared tooltip](/r/tooltips/#tooltip-modes) reads every series at once and [label spacing](/r/axes-labels/#skipping) thins the axis labels. Get started with [JavaScript](/javascript/quick-start/), [React](/react/quick-start/), [Angular](/angular/quick-start/) or [Vue](/vue/quick-start/).',
    },
    ...
    'simple-area': {
        ...
        intro: 'This example shows an [area chart](/r/area-series/) built with AG Charts, tracking a single value over time on a [unit time axis](/r/axes-time/#unit-time), with the area under the line filled to emphasise magnitude as well as direction. [Smooth interpolation](/r/area-series/#interpolation) curves the line, and a [style segment](/r/style-segments/#segmentation) recolours the fill and stroke wherever the value falls below zero. Get started with [JavaScript](/javascript/quick-start/), [React](/react/quick-start/), [Angular](/angular/quick-start/) or [Vue](/vue/quick-start/).',
    },
    'area-with-labels': {
    ...
    'area-with-negative-values': {
        ...
        intro: 'This example shows an [area chart](/r/area-series/) built with AG Charts, [overlaying four series](/r/area-series/#multiple-area-series) on a [grouped category axis](/r/axes-types/#grouped-category): two drawn upwards from zero and two downwards, so positive and negative contributions can be read against each other. [Cross lines](/r/axes-cross-lines/#adding-cross-lines) label each phase and mark the break-even point, and a [shared tooltip](/r/tooltips/#tooltip-modes) reads all four series at once. Get started with [JavaScript](/javascript/quick-start/), [React](/react/quick-start/), [Angular](/angular/quick-start/) or [Vue](/vue/quick-start/).',
    },
    ...
    'scatter-with-large-data': {
        ...
        intro: 'This example shows a [scatter chart](/r/scatter-series/) built with AG Charts, spreading a [large dataset](/r/scatter-series/#large-datasets) across 24 series on a [category axis](/r/axes-types/#category), so a dense distribution stays readable column by column. Labelled [cross lines](/r/axes-cross-lines/#adding-cross-lines) mark a reference point and band the value axis into two named regions, and [fixed tick values](/r/axes-intervals/#values) keep the axis labels sparse. Get started with [JavaScript](/javascript/quick-start/), [React](/react/quick-start/), [Angular](/angular/quick-start/) or [Vue](/vue/quick-start/).',
    },
    'scatter-with-custom-markers': {
        ...
        intro: 'This example shows a [scatter chart](/r/scatter-series/) built with AG Charts, comparing two metrics recorded at different frequencies and on different scales. [Custom marker shapes](/r/markers/#custom-marker-shapes) drawn from SVG paths identify each series without a legend lookup, one metric is scaled by a [secondary axis](/r/axes-secondary/#creating-a-secondary-axis), and points are placed against a [unit time axis](/r/axes-time/#unit-time) with [band highlight](/r/axes-crosshairs/#band-highlight) on hover. Get started with [JavaScript](/javascript/quick-start/), [React](/react/quick-start/), [Angular](/angular/quick-start/) or [Vue](/vue/quick-start/).',
    },
    'scatter-with-labels': {
        ...
        intro: 'This example shows a [scatter chart](/r/scatter-series/) built with AG Charts, comparing two series where every point is worth naming, so each carries a [label](/r/series-labels/#placement) above its marker and one series is set apart by a square [marker shape](/r/scatter-series/#markers). [Crosshairs](/r/axes-crosshairs/#enabling-crosshairs) track both axes, [axis label formatters](/r/axes-labels/#formatter) name the extremes of each scale, and a [floating legend](/r/legend/#floating) sits inside the series area. Get started with [JavaScript](/javascript/quick-start/), [React](/react/quick-start/), [Angular](/angular/quick-start/) or [Vue](/vue/quick-start/).',
    },
    'scatter-with-multiple-axes': {
        ...
        intro: 'This example shows a [scatter chart](/r/scatter-series/) built with AG Charts, comparing two measures whose scales are too far apart to share one axis by scaling the second with a [secondary axis](/r/axes-secondary/#creating-a-secondary-axis). [Crosshairs](/r/axes-crosshairs/#enabling-crosshairs) on all three axes read values off each scale, [axis label formatters](/r/axes-labels/#formatter) give each its own units, and a [fixed axis domain](/r/axes-domain/) pins the x-axis to an exact range. Get started with [JavaScript](/javascript/quick-start/), [React](/react/quick-start/), [Angular](/angular/quick-start/) or [Vue](/vue/quick-start/).',
    },
    ...
    'bubble-with-images': {
        ...
        intro: 'This example shows a [bubble chart](/r/bubble-series/) built with AG Charts, where each bubble is filled with its own picture: an [item styler](/r/stylers/#item-stylers) returns a per-datum [image fill](/r/fills/#images), so the mark itself identifies the record. [Labels](/r/bubble-series/#labels) name each bubble, [bubble size](/r/bubble-series/#size) carries a third variable, and [property formatters](/r/formatters/#property-formatters) print the axes in custom notation. Get started with [JavaScript](/javascript/quick-start/), [React](/react/quick-start/), [Angular](/angular/quick-start/) or [Vue](/vue/quick-start/).',
    },
    'bubble-with-patterns': {
        ...
        intro: 'This example shows a [bubble chart](/r/bubble-series/) built with AG Charts, distinguishing five series by texture rather than colour alone: each takes a different [pattern fill](/r/fills/#patterns) from the stock set, which keeps the series separable in print and for colour-blind readers. Position carries two variables and [bubble size](/r/bubble-series/#size) a third. Get started with [JavaScript](/javascript/quick-start/), [React](/react/quick-start/), [Angular](/angular/quick-start/) or [Vue](/vue/quick-start/).',
    },
    ...
    'map-shapes-lines': {
        ...
        intro: 'This example shows a [map chart](/r/maps/) built with AG Charts, tracing a network over its geography: two [map shape series](/r/map-shapes/#simple-map-shapes) supply the area boundaries beneath one [map line series](/r/map-lines/#proportional-line-width) per route, each varying stroke width with volume along the route. A [floating legend](/r/legend/#floating) lists the routes and a [legend event](/r/legend/#legend-events) listener stops a double-click from isolating one. Get started with [JavaScript](/javascript/quick-start/), [React](/react/quick-start/), [Angular](/angular/quick-start/) or [Vue](/vue/quick-start/).',
    },
    'map-lines-markers': {
        ...
        intro: 'This example shows a [map chart](/r/maps/) built with AG Charts, separating context from subject in layers: [background map shapes](/r/map-shapes/#background-shapes) and [background map lines](/r/map-lines/#background-lines) sit beneath a foreground [map line series](/r/map-lines/#simple-map-lines) for the routes of interest and a [map marker series](/r/map-markers/#customisation) of pins for points on them, with a [floating legend](/r/legend/#floating) naming both. Get started with [JavaScript](/javascript/quick-start/), [React](/react/quick-start/), [Angular](/angular/quick-start/) or [Vue](/vue/quick-start/).',
    },
    'map-kitchen-sink': {
        ...
        intro: 'This example shows a [map chart](/r/maps/) built with AG Charts, putting every map series type on one map: [map shape series](/r/map-shapes/#simple-map-shapes) colour regions by category and share a single legend entry, a dashed [map line series](/r/map-lines/#simple-map-lines) traces routes, and two [map marker series](/r/map-markers/#simple-map-markers) mark points of interest, one placed from the topology and one from [latitude and longitude](/r/map-markers/#map-marker-position-from-data) in the data. [Zoom](/r/zoom/) explores the detail. Get started with [JavaScript](/javascript/quick-start/), [React](/react/quick-start/), [Angular](/angular/quick-start/) or [Vue](/vue/quick-start/).',
    },
    ...
    'org-chart-with-many-nodes': {
        ...
        intro: 'This example shows an [org chart](/r/org-chart/) built with AG Charts, keeping a hierarchy readable once it grows too large for a single row of cards: below a set depth the chart switches to a [stacked layout](/r/org-chart/#stacked-layout) instead of spreading wider. Each [expander](/r/org-chart/#expander) reports its direct and total child counts, [zoom buttons](/r/zoom/#buttons) appear once zoomed, and a [context menu](/r/context-menu/) is available on right-click. Get started with [JavaScript](/javascript/quick-start/), [React](/react/quick-start/), [Angular](/angular/quick-start/) or [Vue](/vue/quick-start/).',
    },
    ...
    'quadrant-chart-with-size': {
        ...
        intro: 'This example shows a [quadrant chart](/r/quadrant-chart/) built with AG Charts, adding a third measure to the two that place each point by scaling [marker size](/r/quadrant-chart/#marker-size) between a minimum and maximum, so weight is read alongside position. Square markers and per-region [fills and labels](/r/quadrant-chart/#customisation) separate the four regions, and the [axis labels move to the pivot](/r/quadrant-chart/#axes) rather than staying at the edge. Get started with [JavaScript](/javascript/quick-start/), [React](/react/quick-start/), [Angular](/angular/quick-start/) or [Vue](/vue/quick-start/).',
    },
    ...
    'simple-range-bar': {
        ...
        intro: 'This example shows a [range bar chart](/r/range-bar-series/) built with AG Charts, drawing each category as a bar from its low to its high value, so spread is read directly instead of being inferred from a single point. Bars take a [corner radius](/r/range-bar-series/#corner-radius), an [ordinal time axis](/r/axes-time/#ordinal-time) leaves no gaps for absent dates, a [cross line](/r/axes-cross-lines/#adding-cross-lines) marks the average, and [band highlight](/r/axes-crosshairs/#band-highlight) shades the hovered category. Get started with [JavaScript](/javascript/quick-start/), [React](/react/quick-start/), [Angular](/angular/quick-start/) or [Vue](/vue/quick-start/).',
    },
    ...
    'horizontal-range-bar': {
        ...
        intro: 'This example shows a [horizontal range bar chart](/r/range-bar-series/#horizontal-range-bar) built with AG Charts, comparing two low-to-high spans per category so a shift between them reads as a change in both position and width. An [item styler](/r/stylers/#item-stylers) separates the pair by opacity, the category [axis labels are switched off](/r/axes-labels/#customisation) in favour of [range cross lines](/r/axes-cross-lines/#adding-cross-lines) that group and name each pair, and the value axis sits along the top. Get started with [JavaScript](/javascript/quick-start/), [React](/react/quick-start/), [Angular](/angular/quick-start/) or [Vue](/vue/quick-start/).',
    },
    'horizontal-range-bar-with-labels': {
        ...
        intro: 'This example shows a [horizontal range bar chart](/r/range-bar-series/#horizontal-range-bar) built with AG Charts, reading each bar as a change between two values rather than a static range. An [item styler](/r/stylers/#item-stylers) colours a bar by the direction of that change, a [label formatter](/r/series-labels/#styling) prints an arrow only where the swing is large enough to matter, and the value axis uses a fixed [step interval](/r/axes-intervals/#step) with a [cross line](/r/axes-cross-lines/#adding-cross-lines) marking the prior average. Get started with [JavaScript](/javascript/quick-start/), [React](/react/quick-start/), [Angular](/angular/quick-start/) or [Vue](/vue/quick-start/).',
    },
    ...
    'customised-waterfall': {
        ...
        intro: 'This example shows a [waterfall chart](/r/waterfall-series/) built with AG Charts, accumulating a run of signed percentage changes into a closing [total value](/r/waterfall-series/#total--subtotal-values). Gain, loss and total [series items](/r/waterfall-series/#series-items) are each named and styled in their own right, [cross lines](/r/axes-cross-lines/#adding-cross-lines) mark break-even and shade an acceptable band either side of it, and [format strings](/r/formatters/#format-strings) render every value as a signed percentage. Get started with [JavaScript](/javascript/quick-start/), [React](/react/quick-start/), [Angular](/angular/quick-start/) or [Vue](/vue/quick-start/).',
    },
    ...
    'simple-radar-area': {
        ...
        intro: "This example shows a [radar area chart](/r/radar-area-series/) built with AG Charts, filling the shape each series traces so its overall coverage reads as an area rather than an outline, with partial opacity keeping three overlapping profiles separable. A [property formatter](/r/formatters/#property-formatters) renders every value as a percentage, [gridlines](/r/axes-grid-lines/#enabling-grid-lines) on the angle axis give the shapes a frame, and the tooltip's [placement](/r/tooltips/#placement) falls back between top and bottom. Get started with [JavaScript](/javascript/quick-start/), [React](/react/quick-start/), [Angular](/angular/quick-start/) or [Vue](/vue/quick-start/).",
    },
    'radar-area-with-labels': {
        ...
        intro: 'This example shows a [radar area chart](/r/radar-area-series/) built with AG Charts, comparing two filled profiles where the difference between them at each metric is the point. [Data labels](/r/series-labels/#styling) are enabled on one series so its values read directly, [markers](/r/markers/#marker-shape-size-and-colour) mark every point on both, the radius axis takes the [circle axis shape](/r/radar-area-series/#axis-shape) with a fixed [interval step](/r/axes-intervals/#step), and a [shared tooltip](/r/tooltips/#tooltip-modes) reads both series at once. Get started with [JavaScript](/javascript/quick-start/), [React](/react/quick-start/), [Angular](/angular/quick-start/) or [Vue](/vue/quick-start/).',
    },
    'reversed-radar-area': {
    ...
    'sunburst-with-color-range': {
        ...
        intro: 'This example shows a [sunburst chart](/r/sunburst-series/) built with AG Charts, carrying two measures at once across a nested hierarchy: segment [size](/r/sunburst-series/#sizing) gives one and a continuous [colour scale](/r/colour-scale/#simple-colour-scale) gives the second, so a small segment can still stand out by colour. A [gradient legend](/r/colour-scale/#gradient-legend) maps colour to value and a [property formatter](/r/formatters/#property-formatters) abbreviates it. Get started with [JavaScript](/javascript/quick-start/), [React](/react/quick-start/), [Angular](/angular/quick-start/) or [Vue](/vue/quick-start/).',
    },
    ...
    'chord-customisation': {
        ...
        intro: "This example shows a [chord chart](/r/chord-series/) built with AG Charts, weighting a dense set of connections so the strongest dominate: an [item styler](/r/stylers/#item-stylers) scales each ribbon's opacity by its volume, over and above the width it already carries. [Node width](/r/chord-series/#node-style) is widened with rounded corners, the [link stroke and opacity](/r/chord-series/#link-style) are styled, and the tooltip takes a custom [position](/r/tooltips/#tooltip-position). Get started with [JavaScript](/javascript/quick-start/), [React](/react/quick-start/), [Angular](/angular/quick-start/) or [Vue](/vue/quick-start/).",
    },
    ...
    'customised-funnel': {
        ...
        intro: 'This example shows a [horizontal funnel chart](/r/funnel-series/#horizontal-funnel) built with AG Charts, reading each stage against a target as well as against the stage before it. An [item styler](/r/stylers/#item-stylers) raises the fill opacity of the stages that hit their target, the [drop-off areas](/r/funnel-series/#customisation) are faded, [stage labels](/r/funnel-series/#labels) sit before each bar, and a tooltip with a custom [position](/r/tooltips/#tooltip-position) reports attainment and overall conversion. Get started with [JavaScript](/javascript/quick-start/), [React](/react/quick-start/), [Angular](/angular/quick-start/) or [Vue](/vue/quick-start/).',
    },
    ...
    'simple-cone-funnel': {
        ...
        description:
            'An interactive cone funnel chart built with AG Charts, tapering continuously between stages so the rate of loss reads as a slope. Explore the live example.',
        intro: 'This example shows a [cone funnel chart](/r/cone-funnel-series/) built with AG Charts, which tapers continuously from one stage to the next rather than stepping between bars, so the rate of loss reads as a slope. The drop-off areas take a reduced [fill opacity](/r/cone-funnel-series/#customisation) and a dashed stroke, [stage labels](/r/cone-funnel-series/#labels) sit after each divider, and a [tooltip renderer](/r/tooltips/#modifying-content) reports the conversion at each stage. Get started with [JavaScript](/javascript/quick-start/), [React](/react/quick-start/), [Angular](/angular/quick-start/) or [Vue](/vue/quick-start/).',
    },
    ...
    'simple-linear-gauge': {
        ...
        intro: 'This example shows a [linear gauge chart](/r/linear-gauge/) built with AG Charts, reading a value against its range on a straight bar, which fits where a dial would not. The bar is divided into [segments](/r/linear-gauge/#segmentation) and rounded with a [corner radius](/r/linear-gauge/#corner-radius), its own scale labels are switched off in favour of a series of [targets](/r/linear-gauge/#targets) naming each range, and a [theme override](/r/themes/#overrides) styles those targets consistently. Get started with [JavaScript](/javascript/quick-start/), [React](/react/quick-start/), [Angular](/angular/quick-start/) or [Vue](/vue/quick-start/).',
    },
    ...
    'bar-line-combination': {
        ...
        description:
            'An interactive combination chart built with AG Charts, drawing some measures as bars and others as lines on shared axes so each takes its natural form. Explore the live example.',
        intro: 'This example shows a [combination chart](/r/combination-series/) built with AG Charts, drawing discrete measures as [bar series](/r/bar-series/#simple-bar) and continuous ones as [line series](/r/line-series/#simple-line) on shared axes, so each measure takes the form that suits it while staying directly comparable. A [shared tooltip](/r/tooltips/#tooltip-modes) reads every series at one category, the lines are dashed and marker-free via a [theme override](/r/themes/#overrides), and [band highlight](/r/axes-crosshairs/#band-highlight) shades the hovered category. Get started with [JavaScript](/javascript/quick-start/), [React](/react/quick-start/), [Angular](/angular/quick-start/) or [Vue](/vue/quick-start/).',
    },
    'histogram-scatter-combination': {
        ...
        intro: 'This example shows a [combination chart](/r/combination-series/) built with AG Charts, overlaying a [scatter series](/r/scatter-series/#simple-scatter) on a [histogram series](/r/histogram-series/#simple-histogram) across shared axes, so the individual points that an aggregate hides are shown alongside it. [Mean aggregation](/r/histogram-series/#aggregation) sets each bar to the average of a second measure within its bin, the bars take a corner radius, and both axes [keep their exact extents](/r/axes-domain/#nice-domain) rather than rounding outwards. Get started with [JavaScript](/javascript/quick-start/), [React](/react/quick-start/), [Angular](/angular/quick-start/) or [Vue](/vue/quick-start/).',
    },
    ...
    'radar-line-radar-area-nightingale-combination': {
        ...
        intro: 'This example shows a [combination chart](/r/combination-series/) built with AG Charts, layering three polar series on shared angle and radius axes: a [nightingale series](/r/nightingale-series/#simple-nightingale) gives the sectors, a [radar area series](/r/radar-area-series/#simple-radar-area) fills a second measure behind them with no stroke, and a [radar line series](/r/radar-line-series/#simple-radar-line) traces a third as an outline, so three measures per category are read as one figure. Get started with [JavaScript](/javascript/quick-start/), [React](/react/quick-start/), [Angular](/angular/quick-start/) or [Vue](/vue/quick-start/).',
    },
    'grouped-bar-line-combination': {
        ...
        intro: 'This example shows a [combination chart](/r/combination-series/) built with AG Charts, combining [bar series](/r/bar-series/#simple-bar) and [line series](/r/line-series/#simple-line) whose scales are orders of magnitude apart: a [secondary y-axis](/r/axes-secondary/#creating-a-secondary-axis) keeps the smaller measures readable, and a [grouped category axis](/r/axes-types/#grouped-category) nests the categories. A [custom marker shape](/r/markers/#custom-marker-shapes) matches the line markers to the bars, both axes use compact labels, and a [shared tooltip](/r/tooltips/#tooltip-modes) reads the group at once. Get started with [JavaScript](/javascript/quick-start/), [React](/react/quick-start/), [Angular](/angular/quick-start/) or [Vue](/vue/quick-start/).',
    },
    'step-interpolation-combination': {
        ...
        intro: 'This example shows a [combination chart](/r/combination-series/) built with AG Charts, combining a [range area series](/r/range-area-series/#simple-range-area) with two [line series](/r/line-series/#simple-line), all using [step interpolation](/r/line-series/#interpolation) so each value holds flat until the next period: the honest shape for figures that change in discrete steps rather than continuously. A [grouped category axis](/r/axes-types/#grouped-category) nests the periods and rotates its inner labels, with the value axis pinned to fixed [interval values](/r/axes-intervals/#values). Get started with [JavaScript](/javascript/quick-start/), [React](/react/quick-start/), [Angular](/angular/quick-start/) or [Vue](/vue/quick-start/).',
    },
    'grouped-category-combination': {
        ...
        intro: 'This example shows a [combination chart](/r/combination-series/) built with AG Charts, charting six measures in three different forms without letting any one scale dominate: an [area series](/r/area-series/#simple-area), a [line series](/r/line-series/#simple-line) with [smooth interpolation](/r/line-series/#interpolation) and four [bar series](/r/bar-series/#simple-bar) each read against their own [named axis](/r/axes-secondary/#custom-axis-keys), on a [grouped category axis](/r/axes-types/#grouped-category). A bordered [floating legend](/r/legend/#floating) sits over the series area so it costs no layout space. Get started with [JavaScript](/javascript/quick-start/), [React](/react/quick-start/), [Angular](/angular/quick-start/) or [Vue](/vue/quick-start/).',
    },
    'stacked-bar-area-combination': {
        ...
        intro: "This example shows a [combination chart](/r/combination-series/) built with AG Charts, overlaying an [area series](/r/area-series/#simple-area) with [step interpolation](/r/area-series/#interpolation) on seven [stacked bar series](/r/bar-series/#stacked-bar), so a composition and an independent measure over the same period are read together. A [unit time axis](/r/axes-time/#unit-time) spaces the periods evenly, an [item styler](/r/stylers/#item-stylers) fades each bar's opacity by value, and the value axis sits on the right with a fixed [step interval](/r/axes-intervals/#step). Get started with [JavaScript](/javascript/quick-start/), [React](/react/quick-start/), [Angular](/angular/quick-start/) or [Vue](/vue/quick-start/).",
    },
};
