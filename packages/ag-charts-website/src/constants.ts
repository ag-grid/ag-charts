...
export const PUBLISHED_URLS = {
    ...
    'ag-charts-community/modules': `${NPM_CDN}/ag-charts-community@${agChartsVersion}/`,
    'ag-charts-community': `${NPM_CDN}/ag-charts-community@${agChartsVersion}/dist/package/main.cjs.js`,
    'ag-charts-enterprise/modules': `${NPM_CDN}/ag-charts-enterprise@${agChartsVersion}/`,
 ...
 */
export const FRAMEWORK_REDIRECT_PATH = 'r';
