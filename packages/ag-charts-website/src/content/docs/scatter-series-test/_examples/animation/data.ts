...
export function getRemovedMaleData() {
    return getMaleData().filter((d) => d.height > 170);
}

export function getRemovedFemaleData() {
    return getFemaleData().filter((d) => d.height < 170);
}
