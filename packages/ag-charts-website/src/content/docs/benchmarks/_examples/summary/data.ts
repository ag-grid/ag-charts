    ...
    return [
        ...
        },
        {
            ...
            results: {
                ...
                'integrated charts large scale benchmark after load 4x legend toggle': 1552.844250000002,
                'large-dataset benchmark initial load': 5868.044292,
                'large-dataset benchmark after load 1x legend toggle': 7622.215917000001,
                'large-dataset benchmark after load 1x datum highlight': 2998.8396250000005,
                'large-dataset benchmark after load 4x datum highlight': 5749.84375,
                'large-scale multi-series benchmark initial load': 798.6127080000006,
                'large-scale multi-series benchmark after load 1x legend toggle': 1005.0907920000027,
                'large-scale multi-series benchmark after load 4x legend toggle': 1894.8821669999961,
                'multi-series benchmark initial load': 1807.6933329999997,
                'multi-series benchmark after load 1x legend toggle': 198.61962500000027,
                'multi-series benchmark after load 10x legend toggle': 893.5050420000011,
                'multi-series benchmark after load 1x datum highlight': 80.00333399999363,
                'multi-series benchmark after load 15x datum highlight': 794.3273750000008,
            },
        },
    ];
}
