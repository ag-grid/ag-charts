...
ModuleRegistry.registerModules([CategoryAxisModule, LegendModule, MapLineBackgroundSeriesModule, MapLineSeriesModule, MapMarkerSeriesModule, MapShapeBackgroundSeriesModule, NumberAxisModule]);
