...
// The demo registers the modules it needs in ./Procurement.vue; the community bundle is
...
createApp({
    render: () => h('main', { 'data-demo-id': 'procurement', style: 'position: fixed; inset: 0;' }, h(Procurement)),
}).mount(container);
