...
| `main.tsx` (React seed)                                                                                                               | `main.ts`            | Registers `AllCommunityModule`, appends `<main data-demo-id="financial">` to `#root`, then calls `mount()`.                              |
...
- `<main data-demo-id="financial">` wraps the demo (the demos app shell renders this).
