/** How long the first render waits for the declared web fonts before going ahead with fallbacks. */
 ...
 * single pass in the final font. Waiting here, after the demo's stylesheet has declared its
 * `@font-face` rules and before anything renders, gives the first layout the final fonts. It is
 * also what keeps the React demo pixel-identical with its framework ports, whose first layout
 * already sees the fonts.
 *
