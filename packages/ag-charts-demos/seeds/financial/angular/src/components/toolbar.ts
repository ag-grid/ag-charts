...
@Component({
    selector: 'div[finToolbar]',
    imports: [DemoInfo],
    host: { class: 'fin-toolbar' },
    template: `
        <span class="fin-brand"
            ><svg
                ...
                focusable="false"
            >
                <rect class="fin-brand-mark-badge" width="20" height="20" />
                <g class="fin-brand-mark-glyph">
        ...
        <span class="fin-account">
            <span class="fin-account-label">Funds</span>
            <span class="fin-account-value">{{ funds }}</span>
        </span>
        <span finDemoInfo></span>
    `,
})
export class Toolbar {
    protected readonly funds = DEMO_FUNDS;
}
