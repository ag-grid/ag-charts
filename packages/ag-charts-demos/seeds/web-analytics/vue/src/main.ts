...
import WebAnalytics from './WebAnalytics.vue';

// The demo registers the modules it needs in ./WebAnalytics.vue; the community bundle is
...
createApp({
    render: () => h('main', { 'data-demo-id': 'web-analytics', style: 'position: fixed; inset: 0;' }, h(WebAnalytics)),
}).mount(container);
