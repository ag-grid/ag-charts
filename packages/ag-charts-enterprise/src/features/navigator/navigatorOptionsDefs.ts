    ...
    miniChart: {
        ...
        series: arrayOf(
            typeUnion<Required<AgMiniChartSeriesOptions>>({
                ...
                histogram: without(NewHistogramSeriesModule.options, [...commonIgnoredMiniChartProperties, 'label']),
                ...
                waterfall: without(WaterfallSeriesModule.options, [...commonIgnoredMiniChartProperties, 'direction']),
            })
        ),
    },
};
