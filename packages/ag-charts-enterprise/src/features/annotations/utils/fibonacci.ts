...
const FIBONACCI_RETRACEMENT_RATIOS_4 = [0, 38.2, 50, 61.8, 100];
const FIBONACCI_RETRACEMENT_RATIOS_6 = [0, 23.6, 38.2, 50, 61.8, 78.6, 100];
const FIBONACCI_EXTENSION_RATIOS = [161.8, 261.8, 361.8, 423.6];

const FIBONACCI_RATIOS_MAP: Record<FibonacciBands, number[]> = {
    10: [...FIBONACCI_RETRACEMENT_RATIOS_6, ...FIBONACCI_EXTENSION_RATIOS].sort((a, b) => a - b),
    6: FIBONACCI_RETRACEMENT_RATIOS_6,
    4: FIBONACCI_RETRACEMENT_RATIOS_4,
};
