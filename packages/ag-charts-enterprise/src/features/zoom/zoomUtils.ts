...
import { type BoundingBox, clamp, isNumberEqual, roundTo } from 'ag-charts-core';
 ...
 */
export function pointToRatio(bbox: BoundingBox, x: number, y: number): { x: number; y: number } {
