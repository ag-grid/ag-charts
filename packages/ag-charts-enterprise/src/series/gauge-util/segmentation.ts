import type { Logger, NormalisedGaugeSegmentationIntervalOptions, Scale } from 'ag-charts-core';
import type { AgNumericValue } from 'ag-charts-types';

export function getGaugeSegments(
    interval: NormalisedGaugeSegmentationIntervalOptions | undefined,
    scale: Scale<AgNumericValue, number>,
    maxTicks: number,
    logger: Logger
) {
    const { values, step, count } = interval ?? {};
