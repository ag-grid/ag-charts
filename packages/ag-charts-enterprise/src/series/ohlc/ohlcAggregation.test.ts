...
describe('aggregateOhlcDataFromDataModel - bigint and ISO 8601 time values (render hardening)', () => {
    ...
    it('aggregates bigint high/low values beyond MAX_SAFE_INTEGER', () => {
        ...
        const result = aggregateOhlcDataFromDataModel(
            'number',
