...
export class LicenseManager {
    ...
    private outputExpiredTrialKey(formattedExpiryDate: string) {
        ...
        console.error(
            `* Your license for AG Grid Enterprise expired on ${formattedExpiryDate}.                                                *`
        );
        console.error(
    ...
    private outputIncompatibleVersion(formattedExpiryDate: string, formattedReleaseDate: string) {
        ...
        console.error(
            `* license end date. The license key that you have expires on ${formattedExpiryDate}, however the version of AG Grid you    *`
        );
        console.error(
