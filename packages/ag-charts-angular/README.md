...
<div align="center">
    ...
    <div align="center">
        <h4><a href="https://charts.ag-grid.com">🌐 Website</a> • <a href="https://charts.ag-grid.com/angular/quick-start/">📖 Documentation</a> • <a href="https://charts.ag-grid.com/gallery/">📊 Gallery</a></h4>
    </div>
    <br>
...
-   `ag-charts-community` is free, available under the MIT license, and comes with core series types, such as [Pie](https://charts.ag-grid.com/angular/pie-series/), [Area](https://charts.ag-grid.com/angular/area-series/), [Bar](https://charts.ag-grid.com/angular/bar-series/), [Scatter](https://charts.ag-grid.com/angular/scatter-series/) and [Bubble](https://charts.ag-grid.com/angular/bubble-series/) in addition to all of the key features expected from a Angular charting library, including [Accessibility](https://charts.ag-grid.com/angular/accessibility/), [Tooltips](https://charts.ag-grid.com/angular/tooltips/), [Themes](https://charts.ag-grid.com/angular/themes/), [Markers](https://charts.ag-grid.com/angular/markers/), [Legends](https://charts.ag-grid.com/angular/legend/), [Axis Types](https://charts.ag-grid.com/angular/axes-types/) and [Secondary Axes](https://charts.ag-grid.com/angular/axes-secondary/).
-   `ag-charts-enterprise` is available under a commercial license and comes with additional series types, such as [Maps](https://charts.ag-grid.com/angular/maps/), [Sankey](https://charts.ag-grid.com/angular/sankey-series/), [Radar](https://charts.ag-grid.com/angular/radar-area-series/), and [Waterfall](https://charts.ag-grid.com/angular/waterfall-series/) Charts as well as advanced interactivity features, like [Animations](https://charts.ag-grid.com/angular/animation/), [Context Menus](https://charts.ag-grid.com/angular/context-menu/), [Zooming](https://charts.ag-grid.com/angular/zoom/), [Navigators](https://charts.ag-grid.com/angular/navigator/), [Synchronization](https://charts.ag-grid.com/angular/sync/) and much more, including [Financial Charts](https://charts.ag-grid.com/angular/financial-charts/).
...
| ------------------------------------------------------------------------- | ------------------- | -------------------- |
| [Bar](https://charts.ag-grid.com/angular/bar-series/)                     | ✅                  | ✅                   |
| [Line](https://charts.ag-grid.com/angular/line-series/)                   | ✅                  | ✅                   |
| [Area](https://charts.ag-grid.com/angular/area-series/)                   | ✅                  | ✅                   |
| [Scatter](https://charts.ag-grid.com/angular/scatter-series/)             | ✅                  | ✅                   |
| [Bubble](https://charts.ag-grid.com/angular/bubble-series/)               | ✅                  | ✅                   |
| [Pie](https://charts.ag-grid.com/angular/pie-series/)                     | ✅                  | ✅                   |
| [Donut](https://charts.ag-grid.com/angular/donut-series/)                 | ✅                  | ✅                   |
| [Combination](https://charts.ag-grid.com/angular/combination-series/)     | ✅                  | ✅                   |
| [Box Plot](https://charts.ag-grid.com/angular/box-plot-series/)           | ❌                  | ✅                   |
| [Bullet](https://charts.ag-grid.com/angular/bullet-series/)               | ❌                  | ✅                   |
| [Candlestick](https://charts.ag-grid.com/angular/candlestick-series/)     | ❌                  | ✅                   |
| [OHLC](https://charts.ag-grid.com/angular/ohlc-series/)                   | ❌                  | ✅                   |
| [Heatmap](https://charts.ag-grid.com/angular/heatmap-series/)             | ❌                  | ✅                   |
| [Histogram](https://charts.ag-grid.com/angular/histogram-series/)         | ❌                  | ✅                   |
| [Nightingale](https://charts.ag-grid.com/angular/nightingale-series/)     | ❌                  | ✅                   |
| [Radar Line](https://charts.ag-grid.com/angular/radar-line-series/)       | ❌                  | ✅                   |
| [Radar Area](https://charts.ag-grid.com/angular/radar-area-series/)       | ❌                  | ✅                   |
| [Radial Column](https://charts.ag-grid.com/angular/radial-column-series/) | ❌                  | ✅                   |
| [Radial Bar](https://charts.ag-grid.com/angular/radial-bar-series/)       | ❌                  | ✅                   |
| [Range Area](https://charts.ag-grid.com/angular/range-area-series/)       | ❌                  | ✅                   |
| [Range Bar](https://charts.ag-grid.com/angular/range-bar-series/)         | ❌                  | ✅                   |
| [Sunburst](https://charts.ag-grid.com/angular/sunburst-series/)           | ❌                  | ✅                   |
| [Treemap](https://charts.ag-grid.com/angular/treemap-series/)             | ❌                  | ✅                   |
| [Waterfall](https://charts.ag-grid.com/angular/waterfall-series/)         | ❌                  | ✅                   |
| [Sankey](https://charts.ag-grid.com/angular/sankey-series/)               | ❌                  | ✅                   |
| [Chord](https://charts.ag-grid.com/angular/chord-series/)                 | ❌                  | ✅                   |
...
| ------------------------------------------------------------------------------ | ------------------- | -------------------- |
| [Accessibility](https://charts.ag-grid.com/angular/accessibility/)             | ✅                  | ✅                   |
| [Localisation](https://charts.ag-grid.com/angular/localisation/)               | ✅                  | ✅                   |
| [Series Highlighting](https://charts.ag-grid.com/angular/series-highlighting/) | ✅                  | ✅                   |
| [Tooltips](https://charts.ag-grid.com/angular/tooltips/)                       | ✅                  | ✅                   |
| [Animations](https://charts.ag-grid.com/angular/animation/)                    | ❌                  | ✅                   |
| [Context Menu](https://charts.ag-grid.com/angular/context-menu/)               | ❌                  | ✅                   |
| [Crosshairs](https://charts.ag-grid.com/angular/axes-crosshairs/)              | ❌                  | ✅                   |
| [Navigator](https://charts.ag-grid.com/angular/navigator/)                     | ❌                  | ✅                   |
| [Synchronization](https://charts.ag-grid.com/angular/sync/)                    | ❌                  | ✅                   |
| [Zoom](https://charts.ag-grid.com/angular/zoom/)                               | ❌                  | ✅                   |
...
The default chart type is [Candlestick](https://charts.ag-grid.com/angular/candlestick-series/), with additional types like [OHLC](https://charts.ag-grid.com/angular/ohlc-series/) and [Line](https://charts.ag-grid.com/angular/line-series/) for versatile data visualisation.
...
Maps can display data using [Shapes](https://charts.ag-grid.com/angular/map-shapes/), [Lines](https://charts.ag-grid.com/angular/map-lines/) and [Marker](https://charts.ag-grid.com/angular/map-markers/) series:
...
> [!IMPORTANT]
> For more information on building Angular Charts with AG Charts, refer to our [Documentation](https://charts.ag-grid.com/angular/quick-start/).
...
AG Charts is used within AG Grid to power the [Integrated Charting](https://www.ag-grid.com/angular-data-grid/integrated-charts/) feature.
