...
// node ./tools/release/createGitHubReleaseAttachArtifacts.mjs --app-id=$AG_AUTOMATED_RELEASE_APP_ID --installation-id=$AG_AUTOMATED_RELEASE_INSTALLATION_ID --private-key-path=$AG_AUTOMATED_RELEASE_PRIVATE_KEY --release-version=100.0.0 --artifacts-path=/Users/seanlandsman/dev/ag-grid/b100.0.0
