...
// node ./tools/release/createGitHubReleaseAttachArtifacts.mjs --app-id=$AG_AUTOMATED_RELEASE_APP_ID --installation-id=$AG_AUTOMATED_RELEASE_INSTALLATION_ID --private-key-path=$AG_AUTOMATED_RELEASE_PRIVATE_KEY --release-version=100.0.0 --release-branch=AG-12422 --artifacts-path=/Users/seanlandsman/dev/ag-grid/b100.0.0
...
async function validateRelease() {
    ...
    const releases = await octokit.request('GET /repos/ag-grid/ag-charts/releases', {
        owner: 'ag-grid',
        repo: 'ag-charts',
        headers: {
...
async function uploadArtifactsForRelease(release) {
    ...
    for (const artifactFolder of artifactFolders) {
        ...
        for (const file of fileEntries) {
            ...
            try {
                await octokit.request(`POST /repos/ag-grid/ag-charts/releases/${release.releaseId}/assets`, {
                    owner: 'ag-grid',
                    repo: 'ag-charts',
