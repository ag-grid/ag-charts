---
paths: '**/series/**/*.ts, **/series/**/*.test.ts'
---
...
**See `tools/prompts/guides/series-performance-optimization.md` for comprehensive details.**
...
-   See `tools/prompts/agents/test-writer.md` for detailed patterns
...
1. Check for performance implications (see optimisation guide)
...
-   Performance guide: `tools/prompts/guides/series-performance-optimization.md`
-   Testing patterns: `tools/prompts/agents/test-writer.md`
-   Data processing: `tools/prompts/package-agents/data-AGENTS.md`
