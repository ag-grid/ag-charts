...
**Result**: ⚠️ May transform but framework timing issues likely
...
| ------------------- | ----------------------- | ------- |
| Static chart        | Direct component props  | ✅      |
| Top-level options   | State/reactive          | ✅      |
| Chart instance      | Ref/component instance  | ✅      |
| Button onclick      | Framework event handler | ✅      |
| Select onchange     | Framework event handler | ✅      |
| chart.update()      | State update            | ✅      |
| chart.updateDelta() | State update            | ✅      |
| AgCharts.download() | Via chart ref           | ✅      |
| Complex DOM queries | N/A                     | ❌      |
| External libraries  | N/A                     | ❌      |
| Multiple charts     | N/A                     | ❌      |
| window assignments  | N/A                     | ❌      |
| Complex async       | Framework-specific      | ⚠️      |
