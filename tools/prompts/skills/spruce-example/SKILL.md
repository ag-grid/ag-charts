...
- Access to data-viz-designer agent for PREVis evaluation
...
3. Run PREVis evaluation via data-viz-designer agent (provide example name and screenshot)
...
3. **Visual verification:**
   ...
   - Run final PREVis evaluation via data-viz-designer agent
