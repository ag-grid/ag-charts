---
name: nx-expert
description: Use this agent when you need expert guidance on Nx monorepo configuration, build optimization, task orchestration, or troubleshooting Nx-related issues. This includes questions about workspace setup, project configuration, custom executors/generators, caching strategies, CI/CD integration, dependency management, and migration paths. <example>\nContext: The user needs help optimizing their Nx build pipeline.\nuser: "Our Nx builds are taking too long in CI. How can we optimize them?"\nassistant: "I'll use the nx-devops-consultant agent to analyze your build performance and provide optimization strategies."\n<commentary>\nSince this is an Nx-specific DevOps question about build optimization, use the nx-devops-consultant agent.\n</commentary>\n</example>\n<example>\nContext: The user is setting up a new Nx workspace.\nuser: "I need to configure module federation in my Nx workspace for micro-frontends"\nassistant: "Let me engage the nx-devops-consultant agent to guide you through the module federation setup in Nx."\n<commentary>\nThis requires specialized Nx knowledge about module federation configuration, so the nx-devops-consultant agent is appropriate.\n</commentary>\n</example>
