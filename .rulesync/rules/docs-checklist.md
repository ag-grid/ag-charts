...
5. **Components**: Code blocks use `format="snippet"` (must be valid JS object expressions — no standalone `const`, `import`, or statements; put those in prose before the block), callouts used appropriately
