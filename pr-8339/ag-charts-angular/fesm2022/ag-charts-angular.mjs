...
// noinspection AngularIncorrectTemplateDefinition
class AgVolumeProfileChart extends AgChartsBase {
    constructor(elementDef, ngZone) {
        super();
        this.ngZone = ngZone;
        this.chartReady = new EventEmitter();
        this.selector = 'ag-volume-profile-chart';
        this._nativeElement = elementDef.nativeElement;
    }
    createChart(options, params) {
        return AgCharts$1.createVolumeProfileChart(options, params);
    }
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "20.3.30", ngImport: i0, type: AgVolumeProfileChart, deps: [{ token: i0.ElementRef }, { token: i0.NgZone }], target: i0.ɵɵFactoryTarget.Component }); }
    static { this.ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "20.3.30", type: AgVolumeProfileChart, isStandalone: true, selector: "ag-volume-profile-chart", inputs: { options: "options", modules: "modules" }, outputs: { chartReady: "chartReady" }, usesInheritance: true, ngImport: i0, template: '', isInline: true, encapsulation: i0.ViewEncapsulation.None }); }
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "20.3.30", ngImport: i0, type: AgVolumeProfileChart, decorators: [{
            type: Component,
            args: [{
...
class AgChartsModule {
    ...
    static { this.ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "20.3.30", ngImport: i0, type: AgChartsModule, imports: [AgCharts, AgFinancialCharts, AgGauge, AgQuadrantChart, AgVolumeProfileChart], exports: [AgCharts, AgFinancialCharts, AgGauge, AgQuadrantChart, AgVolumeProfileChart] }); }
...
export { AgCharts, AgChartsModule, AgFinancialCharts, AgGauge, AgQuadrantChart, AgVolumeProfileChart };
