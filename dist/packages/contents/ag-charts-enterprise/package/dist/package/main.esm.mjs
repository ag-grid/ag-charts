...
var { ActionOnSet: ActionOnSet2 } = _ModuleSupport11;
var Background = class extends _ModuleSupport11.Background {
  constructor(ctx) {
    super(ctx);
  ...
  onImageLoad() {
    this.updateService.update(_ModuleSupport11.ChartUpdateType.SCENE_RENDER);
  }
};
__decorateClass([
  ActionOnSet2({
...
// packages/ag-charts-enterprise/src/features/context-menu/contextMenu.ts
var { BOOLEAN: BOOLEAN4, Validate: Validate10 } = _ModuleSupport12;
var TOOLTIP_ID = "context-menu";
var PAUSE_TYPE = "context-menu";
var _ContextMenu = class _ContextMenu extends _ModuleSupport12.BaseModuleInstance {
  constructor(ctx) {
    super();
    this.ctx = ctx;
    this.enabled = true;
...
import { _ModuleSupport as _ModuleSupport14, _Scene as _Scene8 } from "ag-charts-community";

// packages/ag-charts-enterprise/src/features/crosshair/crosshairLabel.ts
import { _ModuleSupport as _ModuleSupport13, _Scene as _Scene7 } from "ag-charts-community";
var { ActionOnSet: ActionOnSet3, Validate: Validate11, NUMBER: NUMBER3, BOOLEAN: BOOLEAN5, STRING: STRING2, FUNCTION } = _ModuleSupport13;
var { BBox } = _Scene7;
...
var { Validate: Validate12, POSITIVE_NUMBER: POSITIVE_NUMBER3, RATIO: RATIO4, BOOLEAN: BOOLEAN6, COLOR_STRING: COLOR_STRING2, LINE_DASH: LINE_DASH2, Layers: Layers3 } = _ModuleSupport14;
var Crosshair = class extends _ModuleSupport14.BaseModuleInstance {
  constructor(ctx) {
    var _a, _b;
    super();
    this.ctx = ctx;
...
var AXIS_CROSSHAIR_THEME = {
  crosshair: {
    enabled: true,
    snap: true,
    stroke: _Theme3.DEFAULT_MUTED_LABEL_COLOUR,
    strokeWidth: 1,
    strokeOpacity: 1,
    lineDash: [5, 6],
    lineDashOffset: 0,
...
import { AgErrorBarSupportedSeriesTypes, _ModuleSupport as _ModuleSupport17, _Scene as _Scene10 } from "ag-charts-community";

// packages/ag-charts-enterprise/src/features/error-bar/errorBarNode.ts
import { _ModuleSupport as _ModuleSupport15, _Scene as _Scene9 } from "ag-charts-community";
var { partialAssign, mergeDefaults } = _ModuleSupport15;
...
// packages/ag-charts-enterprise/src/features/error-bar/errorBar.ts
var { isDefined, fixNumericExtent, mergeDefaults: mergeDefaults2, valueProperty, ChartAxisDirection: ChartAxisDirection6 } = _ModuleSupport17;
...
var ErrorBars = class extends _ModuleSupport17.BaseModuleInstance {
  constructor(ctx) {
    super();
    ...
    this.groupNode = new ErrorBarGroup({
      ...
      zIndex: _ModuleSupport17.Layers.SERIES_LAYER_ZINDEX,
...
var ERROR_BARS_THEME = {
  errorBar: {
    visible: true,
    stroke: _Theme4.DEFAULT_LABEL_COLOUR,
    strokeWidth: 1,
    strokeOpacity: 1,
    cap: {
      length: void 0,
...
import { _ModuleSupport as _ModuleSupport18, _Scene as _Scene11 } from "ag-charts-community";
var { COLOR_STRING: COLOR_STRING4, RATIO: RATIO6, Validate: Validate14 } = _ModuleSupport18;
var ZoomRect = class extends _Scene11.Rect {
  constructor() {
    super(...arguments);
...
var ZoomAxisDragger = class {
  ...
  update(event, direction, anchor, bbox, zoom, axisZoom) {
    ...
    if (this.oldZoom == null) {
      if (direction === _ModuleSupport19.ChartAxisDirection.X) {
...
var ZoomPanner = class {
  ...
  translateZooms(bbox, currentZooms) {
    ...
    for (const [axisId, { direction, zoom: currentZoom }] of Object.entries(currentZooms)) {
      let zoom;
      if (direction === _ModuleSupport20.ChartAxisDirection.X) {
...
// packages/ag-charts-enterprise/src/features/zoom/zoom.ts
var { BOOLEAN: BOOLEAN8, NUMBER: NUMBER5, RATIO: RATIO7, UNION: UNION3, ActionOnSet: ActionOnSet4, ChartAxisDirection: ChartAxisDirection7, ChartUpdateType, Validate: Validate15 } = _ModuleSupport21;
...
var Zoom = class extends _ModuleSupport21.BaseModuleInstance {
  constructor(ctx) {
    var _a;
    super();
    this.ctx = ctx;
  ...
  onDrag(event) {
    ...
    if (this.enableAxisDragging && this.hoveredAxis) {
      ...
      const anchor = direction === _ModuleSupport21.ChartAxisDirection.X ? this.anchorPointX : this.anchorPointY;
  ...
  onWheel(event) {
    ...
    if (isAxisScrolling) {
      isScalingX = this.hoveredAxis.direction === _ModuleSupport21.ChartAxisDirection.X;
...
import {
  _ModuleSupport as _ModuleSupport22,
  _Scale as _Scale7,
  _Scene as _Scene12,
  _Util as _Util11
...
var { BBox: BBox4, Group: Group4, Rect, LinearGradientFill, Triangle } = _Scene12;
var { createId: createId2, Logger } = _Util11;
...
var GradientLegendAxisTick = class extends _ModuleSupport22.AxisTick {
  constructor() {
    super(...arguments);
    this.enabled = false;
    this.size = 0;
...
var GradientLegendAxis = class extends _ModuleSupport22.CartesianAxis {
  constructor(ctx) {
    super(ctx, new _Scale7.LinearScale());
    this.colorDomain = [];
    this.nice = false;
...
var GRADIENT_LEGEND_THEME = {
  ...
  scale: {
    padding: 8,
    label: {
      color: _Theme5.DEFAULT_LABEL_COLOUR,
      fontStyle: void 0,
      fontWeight: void 0,
      fontSize: 12,
      fontFamily: _Theme5.DEFAULT_FONT_FAMILY,
      formatter: void 0
    },
    interval: {
      minSpacing: 1,
...
var { injectStyle } = _ModuleSupport24;
var watermarkStyles = `
.ag-watermark {
    position: absolute;
    bottom: 20px;
...
import { _Theme as _Theme8, _Util as _Util13 } from "ag-charts-community";

// packages/ag-charts-enterprise/src/series/box-plot/boxPlotDefaults.ts
import { _Theme as _Theme6 } from "ag-charts-community";
var { CARTESIAN_AXIS_TYPES, CARTESIAN_AXIS_POSITIONS } = _Theme6;
...
import { _ModuleSupport as _ModuleSupport27, _Scale as _Scale8, _Scene as _Scene14, _Util as _Util12 } from "ag-charts-community";
...
import { _ModuleSupport as _ModuleSupport25, _Scene as _Scene13 } from "ag-charts-community";
var BoxPlotGroup = class extends _Scene13.Group {
  constructor() {
    super();
    this.append([
      new _Scene13.Rect({ tag: 0 /* Box */ }),
      new _Scene13.Rect({ tag: 0 /* Box */ }),
      new _Scene13.Rect({ tag: 2 /* Outline */ }),
      new _Scene13.Rect({ tag: 1 /* Median */ }),
      new _Scene13.Line({ tag: 3 /* Whisker */ }),
      new _Scene13.Line({ tag: 3 /* Whisker */ }),
      new _Scene13.Line({ tag: 4 /* Cap */ }),
      new _Scene13.Line({ tag: 4 /* Cap */ })
    ]);
  }
  updateDatumStyles(datum, activeStyles, isVertical, isReversedValueAxis) {
    ...
    const selection = _Scene13.Selection.select(this, _Scene13.Rect);
    ...
    if (isVertical) {
      _ModuleSupport25.invertShapeDirection(outline, median, ...boxes, ...caps, ...whiskers);
    }
...
var { motion } = _Scene14;
var BoxPlotSeriesNodeClickEvent = class extends _ModuleSupport27.SeriesNodeClickEvent {
...
var BoxPlotSeries = class _BoxPlotSeries extends _ModuleSupport27.AbstractBarSeries {
  constructor(moduleCtx) {
    super({
      moduleCtx,
  ...
  processData(dataController) {
    return __async(this, null, function* () {
      ...
      const isContinuousX = ((_a = this.getCategoryAxis()) == null ? void 0 : _a.scale) instanceof _Scale8.ContinuousScale;
      const extraProps = [];
  ...
  createNodeData() {
    return __async(this, null, function* () {
      ...
      if (xAxis instanceof _ModuleSupport27.CategoryAxis) {
  ...
  getTooltipHtml(nodeDatum) {
    ...
    if (!xAxis || !yAxis || !this.properties.isValid())
      return "";
    const title = _Util12.sanitizeHtml(yName);
    const contentData = [
      [xKey, xName, xAxis],
    ...
    const content = contentData.map(([key, name, axis]) => _Util12.sanitizeHtml(`${name != null ? name : key}: ${axis.formatDatum(datum[key])}`)).join(title ? "<br/>" : ", ");
...
var BOX_PLOT_SERIES_THEME = {
  __extends__: _Theme7.EXTENDS_SERIES_DEFAULTS,
  strokeWidth: 2
};
...
var BoxPlotModule = {
  ...
  paletteFactory: ({ takeColors, userPalette, themeTemplateParameters }) => {
    var _a;
    const themeBackgroundColor = themeTemplateParameters.properties.get(_Theme8.DEFAULT_BACKGROUND_COLOUR);
    ...
    return {
      fill: userPalette ? fill : _Util13.Color.interpolate(fill, backgroundFill)(0.7),
      stroke
    };
  },
...
import { _Theme as _Theme11, _Util as _Util15 } from "ag-charts-community";

// packages/ag-charts-enterprise/src/series/bullet/bulletDefaults.ts
import { _Theme as _Theme9 } from "ag-charts-community";
var { CARTESIAN_AXIS_TYPES: CARTESIAN_AXIS_TYPES2, CARTESIAN_AXIS_POSITIONS: CARTESIAN_AXIS_POSITIONS2 } = _Theme9;
var BULLET_DEFAULTS = {
  axes: [
    {
...
import { _ModuleSupport as _ModuleSupport29, _Scale as _Scale9, _Scene as _Scene15, _Util as _Util14 } from "ag-charts-community";
...
var { fromToMotion } = _Scene15.motion;
var { sanitizeHtml } = _Util14;
var STYLING_KEYS = [
  "fill",
  "fillOpacity",
  "stroke",
...
var BulletSeries = class _BulletSeries extends _ModuleSupport29.AbstractBarSeries {
  constructor(moduleCtx) {
    super({
      moduleCtx,
      pickModes: [_ModuleSupport29.SeriesNodePickMode.EXACT_SHAPE_MATCH],
      hasHighlightedLabels: true,
      animationResetFns: {
    ...
    this.colorRangesGroup = new _Scene15.Group({ name: `${this.id}-colorRanges` });
    this.colorRangesSelection = _Scene15.Selection.select(this.colorRangesGroup, _Scene15.Rect, false);
    this.rootGroup.append(this.colorRangesGroup);
    this.targetLinesSelection = _Scene15.Selection.select(this.annotationGroup, _Scene15.Line, false);
  }
  destroy() {
  ...
  processData(dataController) {
    return __async(this, null, function* () {
      ...
      const isContinuousX = _Scale9.ContinuousScale.is((_a = this.getCategoryAxis()) == null ? void 0 : _a.scale);
    ...
    return __async(this, null, function* () {
      ...
      for (const { datum, values } of processedData.data) {
        ...
        if (values[0][valueIndex] < 0) {
          _Util14.Logger.warnOnce("negative values are not supported, clipping to 0.");
        }
        ...
        const barAlongX = this.getBarDirection() === _ModuleSupport29.ChartAxisDirection.X;
        const rect = {
        ...
        if (values[0][targetIndex] < 0) {
          _Util14.Logger.warnOnce("negative targets are not supported, ignoring.");
        }
  ...
  updateColorRanges() {
    return __async(this, null, function* () {
      ...
      const computeRect = this.getBarDirection() === _ModuleSupport29.ChartAxisDirection.Y ? (rect, colorRange) => {
        rect.x = min;
...
// packages/ag-charts-enterprise/src/series/bullet/bulletModule.ts
var { CARTESIAN_AXIS_POSITIONS: CARTESIAN_AXIS_POSITIONS3 } = _Theme11;
var BulletModule = {
  type: "series",
  optionsKey: "series[]",
  packageType: "enterprise",
  ...
  paletteFactory: ({ takeColors, colorsCount, themeTemplateParameters }) => {
    ...
    const colorRangeColor = _Util15.Color.interpolate(fill, backgroundFill)(0.7);
    return {
      fill,
      stroke,
...
var { CARTESIAN_AXIS_TYPES: CARTESIAN_AXIS_TYPES3, CARTESIAN_AXIS_POSITIONS: CARTESIAN_AXIS_POSITIONS4 } = _Theme12;
...
import { _ModuleSupport as _ModuleSupport32, _Scale as _Scale10, _Scene as _Scene17, _Util as _Util17 } from "ag-charts-community";

// packages/ag-charts-enterprise/src/series/util/labelFormatter.ts
import { _ModuleSupport as _ModuleSupport30, _Scene as _Scene16, _Util as _Util16 } from "ag-charts-community";
var { Validate: Validate19, NUMBER: NUMBER6, TEXT_WRAP, OVERFLOW_STRATEGY } = _ModuleSupport30;
var { Logger: Logger2 } = _Util16;
var { Text: Text4, Label } = _Scene16;
...
// packages/ag-charts-enterprise/src/series/heatmap/heatmapSeries.ts
var { SeriesNodePickMode: SeriesNodePickMode2, valueProperty: valueProperty4, ChartAxisDirection: ChartAxisDirection9 } = _ModuleSupport32;
var { Rect: Rect2, PointerEvents } = _Scene17;
var { ColorScale } = _Scale10;
var { sanitizeHtml: sanitizeHtml2, Color, Logger: Logger3 } = _Util17;
var HeatmapSeriesNodeClickEvent = class extends _ModuleSupport32.CartesianSeriesNodeClickEvent {
  constructor(type, nativeEvent, datum, series) {
    super(type, nativeEvent, datum, series);
...
var _HeatmapSeries = class _HeatmapSeries extends _ModuleSupport32.CartesianSeries {
  constructor(moduleCtx) {
    super({
      moduleCtx,
...
var HEATMAP_SERIES_THEME = {
  __extends__: _Theme13.EXTENDS_SERIES_DEFAULTS,
  label: {
    __overrides__: _Theme13.OVERRIDE_SERIES_LABEL_DEFAULTS,
    enabled: false,
    color: _Theme13.DEFAULT_LABEL_COLOUR,
    fontStyle: void 0,
    fontSize: _Theme13.FONT_SIZE.SMALL,
    minimumFontSize: void 0,
    fontFamily: _Theme13.DEFAULT_FONT_FAMILY,
    wrapping: "on-space",
...
var HeatmapModule = {
  ...
  paletteFactory: ({ takeColors, colorsCount, userPalette, themeTemplateParameters }) => {
    var _a;
    const { properties } = themeTemplateParameters;
    const defaultColorRange = properties.get(_Theme14.DEFAULT_DIVERGING_SERIES_COLOUR_RANGE);
    const defaultBackgroundColor = properties.get(_Theme14.DEFAULT_BACKGROUND_COLOUR);
...
var { POLAR_AXIS_TYPES, CIRCLE } = _Theme15;
...
import { _ModuleSupport as _ModuleSupport33, _Scale as _Scale11, _Scene as _Scene18, _Util as _Util18 } from "ag-charts-community";
var {
...
var { motion: motion2 } = _Scene18;
var { isNumber, normalizeAngle360: normalizeAngle3605, sanitizeHtml: sanitizeHtml3 } = _Util18;
var RadialColumnSeriesNodeClickEvent = class extends _ModuleSupport33.SeriesNodeClickEvent {
  constructor(type, nativeEvent, datum, series) {
    super(type, nativeEvent, datum, series);
...
var RadialColumnSeriesBase = class extends _ModuleSupport33.PolarSeries {
  constructor(moduleCtx, {
    animationResetFns
  }) {
    super({
...
import { _ModuleSupport as _ModuleSupport34, _Scene as _Scene19 } from "ag-charts-community";
var { Label: Label2 } = _Scene19;
var {
...
import { _Scene as _Scene21 } from "ag-charts-community";
...
var NightingaleModule = {
  ...
  paletteFactory: ({ takeColors, userPalette }) => {
    ...
    return {
      fill,
      stroke: userPalette ? stroke : _Theme17.DEFAULT_POLAR_SERIES_STROKE
    };
  },
  stackable: true,
  groupable: true,
...
var { POLAR_AXIS_TYPES: POLAR_AXIS_TYPES2 } = _Theme18;
var POLAR_DEFAULTS = {
  axes: [
    {
...
import { _ModuleSupport as _ModuleSupport39, _Scene as _Scene26 } from "ag-charts-community";

// packages/ag-charts-enterprise/src/series/radar/radarSeries.ts
import { _ModuleSupport as _ModuleSupport37, _Scene as _Scene24, _Util as _Util19 } from "ag-charts-community";

// packages/ag-charts-enterprise/src/series/radar/radarSeriesProperties.ts
import { _ModuleSupport as _ModuleSupport36, _Scene as _Scene23 } from "ag-charts-community";
var { Label: Label3 } = _Scene23;
var {
  SeriesMarker,
...
var { BBox: BBox5, Group: Group5, Path: Path5, PointerEvents: PointerEvents2, Selection: Selection2, Text: Text5, getMarker } = _Scene24;
var { extent: extent2, isNumber: isNumber2, isNumberEqual: isNumberEqual8, sanitizeHtml: sanitizeHtml4, toFixed } = _Util19;
var RadarSeriesNodeClickEvent = class extends _ModuleSupport37.SeriesNodeClickEvent {
  constructor(type, nativeEvent, datum, series) {
    super(type, nativeEvent, datum, series);
    this.angleKey = series.properties.angleKey;
    this.radiusKey = series.properties.radiusKey;
...
var RadarSeries = class extends _ModuleSupport37.PolarSeries {
  constructor(moduleCtx) {
    super({
      moduleCtx,
      useLabelLayer: true,
...
var { RATIO: RATIO12, COLOR_STRING: COLOR_STRING10, Validate: Validate23 } = _ModuleSupport38;
...
// packages/ag-charts-enterprise/src/series/radar-area/radarAreaSeries.ts
var { Group: Group6, Path: Path6, PointerEvents: PointerEvents3, Selection: Selection3 } = _Scene26;
var { ChartAxisDirection: ChartAxisDirection12 } = _ModuleSupport39;
var RadarAreaSeries = class extends RadarSeries {
  ...
  getAreaPoints() {
    ...
    const getPolarAxis = (direction) => {
      ...
      return axis instanceof _ModuleSupport39.PolarAxis ? axis : void 0;
    };
...
var RADAR_SERIES_THEME = {
  ...
  label: {
    ...
    color: _Theme19.DEFAULT_LABEL_COLOUR,
...
// packages/ag-charts-enterprise/src/series/radar-area/radarAreaModule.ts
var { markerPaletteFactory } = _ModuleSupport40;
var RadarAreaModule = {
  type: "series",
  optionsKey: "series[]",
  packageType: "enterprise",
...
var { POLAR_AXIS_TYPES: POLAR_AXIS_TYPES3 } = _Theme20;
...
import { _ModuleSupport as _ModuleSupport43, _Scale as _Scale12, _Scene as _Scene29, _Util as _Util20 } from "ag-charts-community";

// packages/ag-charts-enterprise/src/series/radial-bar/radialBarSeriesProperties.ts
import { _ModuleSupport as _ModuleSupport41, _Scene as _Scene27 } from "ag-charts-community";
var { Label: Label4 } = _Scene27;
var {
...
import { _Scene as _Scene28 } from "ag-charts-community";
var { motion: motion5 } = _Scene28;
...
var { Sector: Sector4, motion: motion6 } = _Scene29;
var { angleBetween: angleBetween3, isNumber: isNumber3, sanitizeHtml: sanitizeHtml5 } = _Util20;
var RadialBarSeriesNodeClickEvent = class extends _ModuleSupport43.SeriesNodeClickEvent {
  constructor(type, nativeEvent, datum, series) {
    super(type, nativeEvent, datum, series);
    this.angleKey = series.properties.angleKey;
    this.radiusKey = series.properties.radiusKey;
...
var RadialBarSeries = class extends _ModuleSupport43.PolarSeries {
  constructor(moduleCtx) {
    super({
      moduleCtx,
      useLabelLayer: true,
...
var RADIAL_BAR_SERIES_THEME = {
  ...
  label: {
    ...
    color: _Theme21.DEFAULT_INVERTED_LABEL_COLOUR,
...
var { POLAR_AXIS_TYPES: POLAR_AXIS_TYPES4, CIRCLE: CIRCLE2 } = _Theme22;
...
var { Validate: Validate25, RATIO: RATIO14 } = _ModuleSupport44;
...
import { _Scene as _Scene30, _Util as _Util21 } from "ag-charts-community";
var { Path: Path7, Path2D, ScenePathChangeDetection } = _Scene30;
var { angleBetween: angleBetween4, isNumberEqual: isNumberEqual9, normalizeAngle360: normalizeAngle3606 } = _Util21;
...
// packages/ag-charts-enterprise/src/series/radial-column/radialColumnSeries.ts
var { ChartAxisDirection: ChartAxisDirection14, PolarAxis: PolarAxis4 } = _ModuleSupport45;
...
import { _ModuleSupport as _ModuleSupport47, _Scene as _Scene32, _Util as _Util22 } from "ag-charts-community";

// packages/ag-charts-enterprise/src/series/range-area/rangeAreaProperties.ts
import { _ModuleSupport as _ModuleSupport46, _Scene as _Scene31 } from "ag-charts-community";
var { DropShadow, Label: Label5 } = _Scene31;
var {
...
var { getMarker: getMarker2, PointerEvents: PointerEvents4 } = _Scene32;
var { sanitizeHtml: sanitizeHtml6, extent: extent3, isNumber: isNumber4 } = _Util22;
var DEFAULT_DIRECTION_KEYS = {
  [_ModuleSupport47.ChartAxisDirection.X]: ["xKey"],
  [_ModuleSupport47.ChartAxisDirection.Y]: ["yLowKey", "yHighKey"]
};
var DEFAULT_DIRECTION_NAMES = {
  [ChartAxisDirection15.X]: ["xName"],
  [ChartAxisDirection15.Y]: ["yLowName", "yHighName", "yName"]
};
var RangeAreaSeriesNodeClickEvent = class extends _ModuleSupport47.SeriesNodeClickEvent {
  constructor(type, nativeEvent, datum, series) {
    super(type, nativeEvent, datum, series);
    this.xKey = series.properties.xKey;
...
var _RangeAreaSeries = class _RangeAreaSeries extends _ModuleSupport47.CartesianSeries {
  constructor(moduleCtx) {
    super({
      moduleCtx,
      hasHighlightedLabels: true,
...
var { CARTESIAN_AXIS_TYPES: CARTESIAN_AXIS_TYPES4, CARTESIAN_AXIS_POSITIONS: CARTESIAN_AXIS_POSITIONS5 } = _Theme24;
...
var RANGE_AREA_SERIES_THEME = {
  ...
  label: {
    ...
    color: _Theme25.DEFAULT_LABEL_COLOUR,
    __overrides__: _Theme25.OVERRIDE_SERIES_LABEL_DEFAULTS
  }
};

// packages/ag-charts-enterprise/src/series/range-area/rangeAreaModule.ts
var { markerPaletteFactory: markerPaletteFactory2 } = _ModuleSupport48;
var RangeAreaModule = {
  type: "series",
  optionsKey: "series[]",
  packageType: "enterprise",
...
import { _ModuleSupport as _ModuleSupport50, _Scene as _Scene34, _Util as _Util23 } from "ag-charts-community";

// packages/ag-charts-enterprise/src/series/range-bar/rangeBarProperties.ts
import { _ModuleSupport as _ModuleSupport49, _Scene as _Scene33 } from "ag-charts-community";
var { DropShadow: DropShadow2, Label: Label6 } = _Scene33;
var {
...
var { ContinuousScale, BandScale: BandScale5, Rect: Rect3, PointerEvents: PointerEvents5, motion: motion7 } = _Scene34;
var { sanitizeHtml: sanitizeHtml7, isNumber: isNumber5, extent: extent4 } = _Util23;
var DEFAULT_DIRECTION_KEYS2 = {
  [_ModuleSupport50.ChartAxisDirection.X]: ["xKey"],
  [_ModuleSupport50.ChartAxisDirection.Y]: ["yLowKey", "yHighKey"]
};
var DEFAULT_DIRECTION_NAMES2 = {
  [ChartAxisDirection16.X]: ["xName"],
  [ChartAxisDirection16.Y]: ["yLowName", "yHighName", "yName"]
};
var RangeBarSeriesNodeClickEvent = class extends _ModuleSupport50.SeriesNodeClickEvent {
  constructor(type, nativeEvent, datum, series) {
    super(type, nativeEvent, datum, series);
    this.xKey = series.properties.xKey;
    this.yLowKey = series.properties.yLowKey;
...
var _RangeBarSeries = class _RangeBarSeries extends _ModuleSupport50.AbstractBarSeries {
  constructor(moduleCtx) {
    super({
      moduleCtx,
...
var { CARTESIAN_AXIS_TYPES: CARTESIAN_AXIS_TYPES5, CARTESIAN_AXIS_POSITIONS: CARTESIAN_AXIS_POSITIONS6 } = _Theme26;
...
var RANGE_BAR_SERIES_THEME = {
  ...
  label: {
    ...
    color: _Theme27.DEFAULT_INSIDE_SERIES_LABEL_COLOUR,
    formatter: void 0,
    placement: "inside",
    __overrides__: _Theme27.OVERRIDE_SERIES_LABEL_DEFAULTS
  }
};
...
import {
  _ModuleSupport as _ModuleSupport52,
  _Scene as _Scene35,
  _Util as _Util24
} from "ag-charts-community";
...
// packages/ag-charts-enterprise/src/series/sunburst/sunburstSeries.ts
var { fromToMotion: fromToMotion2 } = _ModuleSupport52;
var { Sector: Sector5, Group: Group7, Selection: Selection4, Text: Text6 } = _Scene35;
var { sanitizeHtml: sanitizeHtml8 } = _Util24;
...
var _SunburstSeries = class _SunburstSeries extends _ModuleSupport52.HierarchySeries {
  constructor() {
    super(...arguments);
...
// packages/ag-charts-enterprise/src/series/sunburst/sunburstSeriesModule.ts
var { EXTENDS_SERIES_DEFAULTS, DEFAULT_INSIDE_SERIES_LABEL_COLOUR } = _Theme28;
var SunburstSeriesModule = {
  ...
  paletteFactory: ({ takeColors, colorsCount, themeTemplateParameters }) => {
    const { properties } = themeTemplateParameters;
    const { fills, strokes } = takeColors(colorsCount);
    const defaultColorRange = properties.get(_Theme28.DEFAULT_DIVERGING_SERIES_COLOUR_RANGE);
...
import { _ModuleSupport as _ModuleSupport53, _Scene as _Scene36 } from "ag-charts-community";
var { Label: Label7 } = _Scene36;
var {
...
// packages/ag-charts-enterprise/src/series/treemap/treemapSeries.ts
var { Rect: Rect4, Group: Group8, BBox: BBox6, Selection: Selection5, Text: Text7 } = _Scene37;
var { Color: Color2, Logger: Logger4, isEqual, sanitizeHtml: sanitizeHtml9 } = _Util25;
...
var _TreemapSeries = class _TreemapSeries extends _ModuleSupport54.HierarchySeries {
  constructor() {
    super(...arguments);
...
var { CARTESIAN_AXIS_TYPES: CARTESIAN_AXIS_TYPES6, CARTESIAN_AXIS_POSITIONS: CARTESIAN_AXIS_POSITIONS7 } = _Theme30;
...
import { _ModuleSupport as _ModuleSupport56, _Scene as _Scene39, _Util as _Util26 } from "ag-charts-community";

// packages/ag-charts-enterprise/src/series/waterfall/waterfallSeriesProperties.ts
import { _ModuleSupport as _ModuleSupport55, _Scene as _Scene38 } from "ag-charts-community";
var { DropShadow: DropShadow3, Label: Label8 } = _Scene38;
var {
...
var { ContinuousScale: ContinuousScale2, Rect: Rect5, motion: motion8 } = _Scene39;
var { sanitizeHtml: sanitizeHtml10, isContinuous, isNumber: isNumber6 } = _Util26;
var _WaterfallSeries = class _WaterfallSeries extends _ModuleSupport56.AbstractBarSeries {
  constructor(moduleCtx) {
    super({
      moduleCtx,
    ...
    return __async(this, null, function* () {
      ...
      const { processedData } = yield this.requestDataModel(dataController, dataWithTotals, {
        props: [
          ...
          ...isContinuousX ? [_ModuleSupport56.SMALLEST_KEY_INTERVAL] : [],
          ...extraProps
        ],
        dataVisible: this.visible
      });
  ...
  getSeriesDomain(direction) {
    ...
    const {
      ...
      reduced: { [_ModuleSupport56.SMALLEST_KEY_INTERVAL.property]: smallestX } = {}
    } = processedData;
    const keyDef = dataModel.resolveProcessedDataDefById(this, `xValue`);
    if (direction === this.getCategoryDirection()) {
      if ((keyDef == null ? void 0 : keyDef.def.type) === "key" && (keyDef == null ? void 0 : keyDef.def.valueType) === "category") {
      ...
      const scalePadding = smallestX != null && isFinite(smallestX) ? smallestX : 0;
      const keysExtent = (_a = _ModuleSupport56.extent(keys)) != null ? _a : [NaN, NaN];
      const categoryAxis = this.getCategoryAxis();
      const isReversed = categoryAxis == null ? void 0 : categoryAxis.isReversed();
  ...
  animateConnectorLinesHorizontal(lineNode, pointData) {
    ...
    this.ctx.animationManager.animate({
      ...
      from: startX,
      to: endX,
      ease: _ModuleSupport56.Motion.easeOut,
      onUpdate(pointX) {
        linePath.clear({ trackChanges: true });
  ...
  updateLineNode(lineNode) {
    ...
    lineNode.setProperties({
      ...
      lineDashOffset,
      lineJoin: "round",
      pointerEvents: _Scene39.PointerEvents.None
    });
  }
  isLabelEnabled() {
...
var WATERFALL_SERIES_THEME = {
  __extends__: _Theme31.EXTENDS_SERIES_DEFAULTS,
  item: {
    positive: {
      strokeWidth: 0,
      label: {
  ...
  line: {
    stroke: _Theme31.DEFAULT_WATERFALL_SERIES_CONNECTOR_LINE_STROKE,
    strokeOpacity: 1,
    lineDash: [0],
    lineDashOffset: 0,
    strokeWidth: 2
...
var WaterfallModule = {
  ...
  paletteFactory: ({ takeColors, colorsCount, userPalette, themeTemplateParameters }) => {
    ...
    return userPalette ? {
      ...
      item: {
        positive: properties.get(_Theme32.DEFAULT_WATERFALL_SERIES_POSITIVE_COLOURS),
        negative: properties.get(_Theme32.DEFAULT_WATERFALL_SERIES_NEGATIVE_COLOURS),
        total: properties.get(_Theme32.DEFAULT_WATERFALL_SERIES_TOTAL_COLOURS)
      }
    };
  }
};
...
_ModuleSupport57.registerModule(AngleCategoryAxisModule);
_ModuleSupport57.registerModule(AngleNumberAxisModule);
_ModuleSupport57.registerModule(AnimationModule);
_ModuleSupport57.registerModule(BackgroundModule);
_ModuleSupport57.registerModule(BoxPlotModule);
_ModuleSupport57.registerModule(BulletModule);
_ModuleSupport57.registerModule(ContextMenuModule);
_ModuleSupport57.registerModule(CrosshairModule);
_ModuleSupport57.registerModule(ErrorBarsModule);
_ModuleSupport57.registerModule(GradientLegendModule);
_ModuleSupport57.registerModule(HeatmapModule);
_ModuleSupport57.registerModule(NightingaleModule);
_ModuleSupport57.registerModule(RadarAreaModule);
_ModuleSupport57.registerModule(RadarLineModule);
_ModuleSupport57.registerModule(RadialBarModule);
_ModuleSupport57.registerModule(RadialColumnModule);
_ModuleSupport57.registerModule(RadiusCategoryAxisModule);
_ModuleSupport57.registerModule(RadiusNumberAxisModule);
_ModuleSupport57.registerModule(RangeBarModule);
_ModuleSupport57.registerModule(RangeAreaModule);
_ModuleSupport57.registerModule(SunburstSeriesModule);
_ModuleSupport57.registerModule(TreemapSeriesModule);
_ModuleSupport57.registerModule(WaterfallModule);
_ModuleSupport57.registerModule(ZoomModule);
_ModuleSupport57.enterpriseModule.isEnterprise = true;
_ModuleSupport57.enterpriseModule.licenseManager = (options) => {
  var _a, _b;
...
_ModuleSupport57.enterpriseModule.injectWatermark = injectWatermark;
export {
  AgCharts,
  time
};
