...
import { _ModuleSupport as _ModuleSupport6, _Scene as _Scene4 } from "ag-charts-community";
var { OrdinalTimeScale } = _Scene4;
var { dateToNumber } = _ModuleSupport6;
...
var { ChartAxisDirection: ChartAxisDirection4, Validate: Validate5, DEGREE, validateCrossLineValues: validateCrossLineValues2 } = _ModuleSupport7;
...
// packages/ag-charts-enterprise/src/axes/radius/radiusAxis.ts
var { assignJsonApplyConstructedArray: assignJsonApplyConstructedArray2, ChartAxisDirection: ChartAxisDirection5, Default: Default2, Layers: Layers2, DEGREE: DEGREE2, MIN_SPACING: MIN_SPACING2, BOOLEAN: BOOLEAN2, Validate: Validate6 } = _ModuleSupport8;
...
// packages/ag-charts-enterprise/src/axes/radius-category/radiusCategoryAxis.ts
var { RATIO: RATIO3, ProxyPropertyOnWrite, Validate: Validate7 } = _ModuleSupport9;
...
var { AND: AND4, Default: Default3, GREATER_THAN: GREATER_THAN3, LESS_THAN: LESS_THAN2, NUMBER_OR_NAN: NUMBER_OR_NAN2, Validate: Validate8 } = _ModuleSupport10;
...
var { BOOLEAN: BOOLEAN3, POSITIVE_NUMBER: POSITIVE_NUMBER2, ObserveChanges, Validate: Validate9 } = _ModuleSupport11;
...
import { _ModuleSupport as _ModuleSupport12, _Scene as _Scene7 } from "ag-charts-community";
var { Image } = _Scene7;
var {
  BaseProperties,
...
// packages/ag-charts-enterprise/src/features/background/background.ts
var { ActionOnSet, OBJECT, Validate: Validate11 } = _ModuleSupport13;
var Background = class extends _ModuleSupport13.Background {
  constructor(ctx) {
    super(ctx);
    this.ctx = ctx;
  ...
  onImageLoad() {
    this.ctx.updateService.update(_ModuleSupport13.ChartUpdateType.SCENE_RENDER);
  }
};
__decorateClass([
...
import { _ModuleSupport as _ModuleSupport14, _Util as _Util11 } from "ag-charts-community";
...
// packages/ag-charts-enterprise/src/features/context-menu/contextMenu.ts
var { BOOLEAN: BOOLEAN4, Validate: Validate12, createElement: createElement2, getDocument, getWindow, injectStyle } = _ModuleSupport14;
var ContextMenu = class extends _ModuleSupport14.BaseModuleInstance {
  constructor(ctx) {
    super();
    this.ctx = ctx;
    this.enabled = true;
    ...
    const { Default: Default5, ContextMenu: ContextMenuState, All } = _ModuleSupport14.InteractionState;
  ...
  show() {
    this.interactionManager.pushState(_ModuleSupport14.InteractionState.ContextMenu);
  ...
  hide() {
    this.interactionManager.popState(_ModuleSupport14.InteractionState.ContextMenu);
    if (this.menuElement) {
...
var ContextMenuModule = {
  ...
  themeTemplate: {
    contextMenu: {
      enabled: true,
      darkTheme: _Theme4.IS_DARK_THEME
    }
  }
};

// packages/ag-charts-enterprise/src/features/crosshair/crosshair.ts
import { _ModuleSupport as _ModuleSupport16, _Scene as _Scene9, _Util as _Util13 } from "ag-charts-community";
...
var { ActionOnSet: ActionOnSet2, BaseProperties: BaseProperties2, BOOLEAN: BOOLEAN5, FUNCTION, NUMBER: NUMBER4, STRING: STRING2, Validate: Validate13, createElement: createElement3, injectStyle: injectStyle2 } = _ModuleSupport15;
var { BBox } = _Scene8;
...
`;
var CrosshairLabelProperties = class extends _Scene8.ChangeDetectableProperties {
  constructor() {
    super(...arguments);
    this.enabled = true;
    this.xOffset = 0;
...
var CrosshairLabel = class extends BaseProperties2 {
  ...
  computeBBox() {
    const { element } = this;
    return new _Scene8.BBox(element.clientLeft, element.clientTop, element.clientWidth, element.clientHeight);
  }
...
// packages/ag-charts-enterprise/src/features/crosshair/crosshair.ts
var { Group: Group3, Line, BBox: BBox2 } = _Scene9;
var { createId: createId2 } = _Util13;
var { POSITIVE_NUMBER: POSITIVE_NUMBER4, RATIO: RATIO5, BOOLEAN: BOOLEAN6, COLOR_STRING: COLOR_STRING2, LINE_DASH: LINE_DASH2, OBJECT: OBJECT2, Validate: Validate14, Layers: Layers3, getDocument: getDocument2 } = _ModuleSupport16;
var Crosshair = class extends _ModuleSupport16.BaseModuleInstance {
  constructor(ctx) {
    super();
    this.ctx = ctx;
    ...
    this.lineGroupSelection = _Scene9.Selection.select(this.lineGroup, Line, false);
...
var AXIS_CROSSHAIR_THEME = {
  crosshair: {
    enabled: true,
    snap: true,
    stroke: _Theme5.DEFAULT_MUTED_LABEL_COLOUR,
    strokeWidth: 1,
    strokeOpacity: 1,
    lineDash: [5, 6],
    lineDashOffset: 0,
...
var { BOOLEAN: BOOLEAN7, FUNCTION: FUNCTION2, ActionOnSet: ActionOnSet3, Validate: Validate15 } = _ModuleSupport17;
var DataSource = class extends _ModuleSupport17.BaseModuleInstance {
  constructor(ctx) {
    super();
    this.enabled = false;
...
import { AgErrorBarSupportedSeriesTypes, _ModuleSupport as _ModuleSupport20, _Scene as _Scene11, _Util as _Util14 } from "ag-charts-community";

// packages/ag-charts-enterprise/src/features/error-bar/errorBarNode.ts
import { _ModuleSupport as _ModuleSupport18, _Scene as _Scene10 } from "ag-charts-community";
var { partialAssign, mergeDefaults } = _ModuleSupport18;
var { BBox: BBox3 } = _Scene10;
...
var ErrorBarNode = class extends _Scene10.Group {
  constructor() {
    super();
    this.capLength = NaN;
    this._datum = void 0;
    this.whiskerPath = new _Scene10.Path();
    this.capsPath = new _Scene10.Path();
...
var ErrorBarGroup = class extends _Scene10.Group {
  get children() {
    return super.children;
  }
  nearestSquared(x, y) {
    const { nearest, distanceSquared } = _Scene10.nearestSquaredInContainer(x, y, this);
...
var ErrorBars = class _ErrorBars extends _ModuleSupport20.BaseModuleInstance {
  constructor(ctx) {
    super();
    ...
    this.groupNode = new ErrorBarGroup({
      ...
      zIndex: _ModuleSupport20.Layers.SERIES_LAYER_ZINDEX,
      zIndexSubOrder: series.getGroupZIndexSubOrder("annotation")
    });
    annotationGroup.appendChild(this.groupNode);
    this.selection = _Scene11.Selection.select(this.groupNode, () => this.errorBarFactory());
  ...
  static getDatumKey(datum, key, offset) {
    ...
    if (typeof value !== "number") {
      _Util14.Logger.warnOnce(`Found [${key}] error value of type ${typeof value}. Expected number type`);
      return;
    }
    return value + offset;
  }
...
var ERROR_BARS_THEME = {
  series: {
    errorBar: {
      visible: true,
      stroke: _Theme6.DEFAULT_LABEL_COLOUR,
      strokeWidth: 1,
      strokeOpacity: 1,
      cap: {
        length: void 0,
...
import { _ModuleSupport as _ModuleSupport23, _Theme as _Theme7 } from "ag-charts-community";
...
import { _ModuleSupport as _ModuleSupport21, _Scene as _Scene12, _Util as _Util15 } from "ag-charts-community";
var { Validate: Validate17, BOOLEAN: BOOLEAN9, POSITIVE_NUMBER: POSITIVE_NUMBER6, Layers: Layers4, ActionOnSet: ActionOnSet4, CategoryAxis, GroupedCategoryAxis } = _ModuleSupport21;
var { toRadians: toRadians4, Padding, Logger } = _Util15;
var { Text: Text4, Group: Group4, BBox: BBox4 } = _Scene12;
...
var MiniChart = class extends _ModuleSupport21.BaseModuleInstance {
  constructor(ctx) {
    super();
    this.ctx = ctx;
    this.enabled = false;
...
// packages/ag-charts-enterprise/src/features/navigator/navigator.ts
var { ObserveChanges: ObserveChanges3 } = _ModuleSupport22;
var _Navigator = class _Navigator extends _ModuleSupport22.Navigator {
  constructor(ctx) {
    super(ctx);
...
var NavigatorModule = {
  ...
  themeTemplate: __spreadProps(__spreadValues({}, _ModuleSupport23.NavigatorModule.themeTemplate), {
    navigator: __spreadProps(__spreadValues({}, (_a = _ModuleSupport23.NavigatorModule.themeTemplate) == null ? void 0 : _a.navigator), {
      miniChart: {
        enabled: false,
        label: {
...
var { BOOLEAN: BOOLEAN10, ActionOnSet: ActionOnSet5, Validate: Validate18 } = _ModuleSupport24;
var RangeButtons = class extends _ModuleSupport24.BaseModuleInstance {
  constructor(ctx) {
    super();
    this.ctx = ctx;
    this.enabled = false;
...
import { _ModuleSupport as _ModuleSupport25, _Util as _Util17 } from "ag-charts-community";
var {
  BOOLEAN: BOOLEAN11,
  STRING: STRING4,
  UNION: UNION3,
...
import { _ModuleSupport as _ModuleSupport33, _Util as _Util20 } from "ag-charts-community";
...
import { _ModuleSupport as _ModuleSupport26, _Scene as _Scene15 } from "ag-charts-community";
var { COLOR_STRING: COLOR_STRING4, RATIO: RATIO7, Validate: Validate20 } = _ModuleSupport26;
var ZoomRect = class extends _Scene15.Rect {
  constructor() {
    super(...arguments);
...
var ZoomAxisDragger = class {
  update(event, direction, anchor, bbox, zoom, axisZoom) {
    ...
    (_a2 = this.oldZoom) != null ? _a2 : this.oldZoom = definedZoomState(
      direction === _ModuleSupport28.ChartAxisDirection.X ? __spreadProps(__spreadValues({}, zoom), { x: axisZoom }) : __spreadProps(__spreadValues({}, zoom), { y: axisZoom })
    );
  ...
  updateZoom(direction, anchor, bbox) {
    ...
    if (!coords || !oldZoom) {
      if (direction === _ModuleSupport28.ChartAxisDirection.X)
        return newZoom.x;
      return newZoom.y;
    }
...
var ZoomPanner = class {
  ...
  translateZooms(bbox, currentZooms) {
    ...
    for (const [axisId, { direction, zoom: currentZoom }] of Object.entries(currentZooms)) {
      let zoom;
      if (direction === _ModuleSupport29.ChartAxisDirection.X) {
...
import { _ModuleSupport as _ModuleSupport30, _Util as _Util18 } from "ag-charts-community";
var { AND: AND5, DATE, NUMBER: NUMBER6, OR, ActionOnSet: ActionOnSet6, isFiniteNumber: isFiniteNumber2, isValidDate, Validate: Validate21 } = _ModuleSupport30;
var ZoomRange = class {
  ...
  updateAxis(axes) {
    ...
    const changed = domain == null || !_Util18.areArrayItemsStrictlyEqual(domain, validAxisDomain);
    if (changed) {
...
var { AND: AND6, GREATER_THAN: GREATER_THAN4, LESS_THAN: LESS_THAN3, RATIO: RATIO8, ActionOnSet: ActionOnSet7, Validate: Validate22 } = _ModuleSupport31;
var ZoomRatio = class {
  constructor(onChange) {
    this.onChange = onChange;
  }
...
var ZoomScrollPanner = class {
  ...
  translateZooms(bbox, currentZooms, deltaX) {
    ...
    for (const [axisId, { direction, zoom: currentZoom }] of Object.entries(currentZooms)) {
      if (direction !== _ModuleSupport32.ChartAxisDirection.X)
        continue;
...
var Zoom = class extends _ModuleSupport33.BaseModuleInstance {
  constructor(ctx) {
    super();
    this.ctx = ctx;
    this.enabled = false;
    ...
    const { Default: Default5, ZoomDrag, Animation: Animation2 } = _ModuleSupport33.InteractionState;
  ...
  onDrag(event) {
    if (!this.enabled || !this.paddedRect || !this.seriesRect)
      return;
    this.ctx.interactionManager.pushState(_ModuleSupport33.InteractionState.ZoomDrag);
    const zoom = definedZoomState(this.zoomManager.getZoom());
    switch (this.dragState) {
      case 1 /* Axis */:
        ...
        const anchor = direction === _ModuleSupport33.ChartAxisDirection.X ? this.anchorPointX : this.anchorPointY;
  ...
  onDragEnd() {
    this.ctx.interactionManager.popState(_ModuleSupport33.InteractionState.ZoomDrag);
  ...
  onWheel(event) {
    ...
    if (isAxisScrolling) {
      isScalingX = this.hoveredAxis.direction === _ModuleSupport33.ChartAxisDirection.X;
  ...
  onLayoutComplete(event) {
    ...
    if (!axes)
      return;
    const [axesX, axesY] = _Util20.bifurcate((axis) => axis.direction === ChartAxisDirection7.X, axes);
...
import {
  _ModuleSupport as _ModuleSupport34,
  _Scale as _Scale8,
  _Scene as _Scene17,
  _Util as _Util21
...
var { BBox: BBox5, Group: Group5, Rect, LinearGradientFill, Triangle } = _Scene17;
var { createId: createId3, Logger: Logger3 } = _Util21;
...
var GradientLegendAxisTick = class extends _ModuleSupport34.AxisTick {
  constructor() {
    super(...arguments);
    this.enabled = false;
    this.size = 0;
...
var GradientLegendAxis = class extends _ModuleSupport34.CartesianAxis {
  constructor(ctx) {
...
_LicenseManager.RELEASE_INFORMATION = "MTcxMTU0NzQ1NzgwNA==";
...
var { createElement: createElement4, injectStyle: injectStyle3 } = _ModuleSupport35;
var watermarkStyles = `
.ag-watermark {
    position: absolute;
    bottom: 20px;
...
import { _Theme as _Theme10, _Util as _Util23 } from "ag-charts-community";

// packages/ag-charts-enterprise/src/series/box-plot/boxPlotSeries.ts
import { _ModuleSupport as _ModuleSupport38, _Scale as _Scale9, _Scene as _Scene19, _Util as _Util22 } from "ag-charts-community";
...
import { _ModuleSupport as _ModuleSupport36, _Scene as _Scene18 } from "ag-charts-community";
var { Group: Group6, Rect: Rect2, Line: Line2, BBox: BBox6, Selection: Selection2 } = _Scene18;
var BoxPlotGroup = class extends Group6 {
  ...
  updateDatumStyles(datum, activeStyles, isVertical, isReversedValueAxis, cornerRadius) {
    ...
    if (isVertical) {
      _ModuleSupport36.invertShapeDirection(outline, median, ...boxes, ...caps, ...whiskers);
    }
...
var { motion } = _Scene19;
var BoxPlotSeriesNodeEvent = class extends _ModuleSupport38.SeriesNodeEvent {
...
var _BoxPlotSeries = class _BoxPlotSeries extends _ModuleSupport38.AbstractBarSeries {
  constructor(moduleCtx) {
    super({
      moduleCtx,
  ...
  processData(dataController) {
    return __async(this, null, function* () {
      ...
      const isContinuousX = ((_a2 = this.getCategoryAxis()) == null ? void 0 : _a2.scale) instanceof _Scale9.ContinuousScale;
      const extraProps = [];
  ...
  getTooltipHtml(nodeDatum) {
    ...
    if (!xAxis || !yAxis || !this.properties.isValid())
      return "";
    const title = _Util22.sanitizeHtml(yName);
    const contentData = [
      [xKey, xName, xAxis],
    ...
    const content = contentData.map(([key, name, axis]) => _Util22.sanitizeHtml(`${name != null ? name : key}: ${axis.formatDatum(datum[key])}`)).join(title ? "<br/>" : ", ");
...
var BOX_PLOT_SERIES_THEME = {
  series: {
    __extends__: _Theme9.EXTENDS_SERIES_DEFAULTS,
    direction: "vertical",
    strokeWidth: 2
  },
  axes: {
...
var BoxPlotModule = {
  ...
  paletteFactory: ({ takeColors, userPalette, themeTemplateParameters }) => {
    var _a2;
    const themeBackgroundColor = themeTemplateParameters.properties.get(_Theme10.DEFAULT_BACKGROUND_COLOUR);
    ...
    return {
      fill: userPalette ? fill : _Util23.Color.interpolate(fill, backgroundFill)(0.7),
      stroke
    };
  },
...
import { _ModuleSupport as _ModuleSupport40, _Scale as _Scale10, _Scene as _Scene20, _Util as _Util24 } from "ag-charts-community";
...
var { fromToMotion } = _Scene20.motion;
var { ContinuousScale, OrdinalTimeScale: OrdinalTimeScale2 } = _Scale10;
var { sanitizeHtml } = _Util24;
var STYLING_KEYS = [
  "fill",
  "fillOpacity",
  "stroke",
...
var BulletSeries = class _BulletSeries extends _ModuleSupport40.AbstractBarSeries {
  constructor(moduleCtx) {
    super({
      moduleCtx,
      directionKeys: { y: ["targetKey", "valueKey"] },
      directionNames: { y: ["targetName", "valueName"] },
      pickModes: [_ModuleSupport40.SeriesNodePickMode.EXACT_SHAPE_MATCH],
      hasHighlightedLabels: true,
      animationResetFns: {
    ...
    this.colorRangesGroup = new _Scene20.Group({ name: `${this.id}-colorRanges` });
    this.colorRangesSelection = _Scene20.Selection.select(this.colorRangesGroup, _Scene20.Rect, false);
    this.rootGroup.append(this.colorRangesGroup);
    this.targetLinesSelection = _Scene20.Selection.select(this.annotationGroup, _Scene20.Line, false);
  }
  destroy() {
    ...
    return __async(this, null, function* () {
      ...
      for (const { datum, values } of processedData.data) {
        ...
        if (values[0][valueIndex] < 0) {
          _Util24.Logger.warnOnce("negative values are not supported, clipping to 0.");
        }
        ...
        const barAlongX = this.getBarDirection() === _ModuleSupport40.ChartAxisDirection.X;
        const rect = {
        ...
        if (values[0][targetIndex] < 0) {
          _Util24.Logger.warnOnce("negative targets are not supported, ignoring.");
        }
  ...
  getColorRanges() {
    ...
    defaultColorRange.color = _Util24.Color.interpolate(fill, backgroundFill)(0.7);
  ...
  updateColorRanges() {
    return __async(this, null, function* () {
      ...
      const computeRect = this.getBarDirection() === _ModuleSupport40.ChartAxisDirection.Y ? (rect, colorRange) => {
        rect.x = min;
...
var BulletModule = {
  ...
  paletteFactory: ({ takeColors, colorsCount, themeTemplateParameters }) => {
    ...
    const themeBackgroundColor = themeTemplateParameters.properties.get(_Theme12.DEFAULT_BACKGROUND_COLOUR);
    const backgroundFill = (_a2 = Array.isArray(themeBackgroundColor) ? themeBackgroundColor[0] : themeBackgroundColor) != null ? _a2 : "white";
    const targetStroke = properties.get(_Theme12.DEFAULT_CROSS_LINES_COLOUR);
    return {
      fill,
      stroke,
...
import { _ModuleSupport as _ModuleSupport44, _Scale as _Scale11, _Scene as _Scene23, _Util as _Util26 } from "ag-charts-community";
...
var CandlestickGroup = class extends _Scene21.Group {
  constructor() {
    super();
    this.append([
      new _Scene21.Rect({ tag: 0 /* Rect */ }),
      new _Scene21.Line({ tag: 2 /* Wick */ }),
      new _Scene21.Line({ tag: 2 /* Wick */ })
    ]);
  }
  updateDatumStyles(datum, activeStyles) {
    ...
    const selection = _Scene21.Selection.select(this, _Scene21.Rect);
...
var { motion: motion2 } = _Scene23;
var { sanitizeHtml: sanitizeHtml2, Logger: Logger4 } = _Util26;
var { ContinuousScale: ContinuousScale2, OrdinalTimeScale: OrdinalTimeScale3 } = _Scale11;
var CandlestickSeriesNodeEvent = class extends _ModuleSupport44.SeriesNodeEvent {
  constructor(type, nativeEvent, datum, series) {
    super(type, nativeEvent, datum, series);
    this.xKey = series.properties.xKey;
...
var _CandlestickSeries = class _CandlestickSeries extends _ModuleSupport44.AbstractBarSeries {
  constructor(moduleCtx) {
    super({
      moduleCtx,
...
import { _ModuleSupport as _ModuleSupport47, _Scale as _Scale12, _Scene as _Scene25, _Util as _Util28 } from "ag-charts-community";

// packages/ag-charts-enterprise/src/series/util/labelFormatter.ts
import { _ModuleSupport as _ModuleSupport45, _Scene as _Scene24, _Util as _Util27 } from "ag-charts-community";
var { Validate: Validate28, NUMBER: NUMBER8, TEXT_WRAP, OVERFLOW_STRATEGY } = _ModuleSupport45;
var { Logger: Logger5 } = _Util27;
var { Text: Text5, Label } = _Scene24;
...
var { Rect: Rect3, PointerEvents } = _Scene25;
var { ColorScale } = _Scale12;
var { sanitizeHtml: sanitizeHtml3, Color, Logger: Logger6 } = _Util28;
var HeatmapSeriesNodeEvent = class extends _ModuleSupport47.CartesianSeriesNodeEvent {
  constructor(type, nativeEvent, datum, series) {
    super(type, nativeEvent, datum, series);
...
var _HeatmapSeries = class _HeatmapSeries extends _ModuleSupport47.CartesianSeries {
  constructor(moduleCtx) {
    super({
      moduleCtx,
...
var HEATMAP_SERIES_THEME = {
  series: {
    __extends__: _Theme15.EXTENDS_SERIES_DEFAULTS,
    label: {
      __overrides__: _Theme15.OVERRIDE_SERIES_LABEL_DEFAULTS,
      enabled: false,
...
var HeatmapModule = {
  ...
  paletteFactory: ({ takeColors, colorsCount, userPalette, themeTemplateParameters }) => {
    var _a2;
    const { properties } = themeTemplateParameters;
    const defaultColorRange = properties.get(_Theme16.DEFAULT_DIVERGING_SERIES_COLOUR_RANGE);
    const defaultBackgroundColor = properties.get(_Theme16.DEFAULT_BACKGROUND_COLOUR);
...
import { _ModuleSupport as _ModuleSupport52, _Scene as _Scene27, _Util as _Util29 } from "ag-charts-community";
...
var { LonLatBBox } = _ModuleSupport48;
...
// packages/ag-charts-enterprise/src/series/map-util/geoGeometry.ts
var { Path: Path5, Path2D, BBox: BBox7, ScenePathChangeDetection } = _Scene26;
...
function isValidCoordinate(v) {
  return Array.isArray(v) && v.length >= 2 && v.every(_ModuleSupport50.isFiniteNumber);
}
...
var GEOJSON_OBJECT = _ModuleSupport50.predicateWithMessage(isValidFeatureCollection, "a GeoJSON object");
...
var { COLOR_STRING: COLOR_STRING9, LINE_DASH: LINE_DASH7, OBJECT: OBJECT8, POSITIVE_NUMBER: POSITIVE_NUMBER12, RATIO: RATIO14, Validate: Validate30, SeriesProperties, SeriesTooltip: SeriesTooltip5 } = _ModuleSupport51;
...
// packages/ag-charts-enterprise/src/series/map-line-background/mapLineBackgroundSeries.ts
var { createDatumId: createDatumId2, DataModelSeries, SeriesNodePickMode: SeriesNodePickMode4, Validate: Validate31 } = _ModuleSupport52;
var { Group: Group7, Selection: Selection3, PointerEvents: PointerEvents2 } = _Scene27;
var { Logger: Logger7 } = _Util29;
...
// packages/ag-charts-enterprise/src/series/map-line-background/mapLineBackgroundModule.ts
var { EXTENDS_SERIES_DEFAULTS, DEFAULT_HIERARCHY_STROKES } = _Theme17;
...
import {
  _ModuleSupport as _ModuleSupport55,
  _Scale as _Scale13,
  _Scene as _Scene29,
  _Util as _Util31
} from "ag-charts-community";
...
import { _ModuleSupport as _ModuleSupport54, _Scene as _Scene28 } from "ag-charts-community";
var {
  AND: AND8,
  ARRAY: ARRAY4,
...
// packages/ag-charts-enterprise/src/series/map-line/mapLineSeries.ts
var { getMissCount: getMissCount2, createDatumId: createDatumId3, DataModelSeries: DataModelSeries2, SeriesNodePickMode: SeriesNodePickMode5, valueProperty: valueProperty6, Validate: Validate33 } = _ModuleSupport55;
var { ColorScale: ColorScale2, LinearScale: LinearScale3 } = _Scale13;
var { Group: Group8, Selection: Selection4, Text: Text6 } = _Scene29;
var { sanitizeHtml: sanitizeHtml4, Logger: Logger8 } = _Util31;
...
import { _ModuleSupport as _ModuleSupport57, _Scene as _Scene30, _Util as _Util32 } from "ag-charts-community";
var {
  AND: AND9,
  ARRAY: ARRAY5,
...
var { Label: Label3, Circle } = _Scene30;
var { Logger: Logger9 } = _Util32;
...
var { Group: Group9, Selection: Selection5, Text: Text7, getMarker } = _Scene31;
var { sanitizeHtml: sanitizeHtml5, Logger: Logger10 } = _Util33;
...
import { _ModuleSupport as _ModuleSupport61, _Scene as _Scene32, _Util as _Util34 } from "ag-charts-community";
...
var { COLOR_STRING: COLOR_STRING12, LINE_DASH: LINE_DASH9, OBJECT: OBJECT11, POSITIVE_NUMBER: POSITIVE_NUMBER15, RATIO: RATIO17, Validate: Validate36, SeriesProperties: SeriesProperties4, SeriesTooltip: SeriesTooltip8 } = _ModuleSupport60;
...
// packages/ag-charts-enterprise/src/series/map-shape-background/mapShapeBackgroundSeries.ts
var { createDatumId: createDatumId5, Series, SeriesNodePickMode: SeriesNodePickMode7, Validate: Validate37 } = _ModuleSupport61;
var { Selection: Selection6, Group: Group10, PointerEvents: PointerEvents3 } = _Scene32;
var { Logger: Logger11 } = _Util34;
...
// packages/ag-charts-enterprise/src/series/map-shape/mapShapeSeries.ts
var { getMissCount: getMissCount4, createDatumId: createDatumId6, DataModelSeries: DataModelSeries4, SeriesNodePickMode: SeriesNodePickMode8, valueProperty: valueProperty8, Validate: Validate39 } = _ModuleSupport64;
var { ColorScale: ColorScale4 } = _Scale16;
var { Group: Group11, Selection: Selection7, Text: Text8, PointerEvents: PointerEvents4 } = _Scene34;
var { sanitizeHtml: sanitizeHtml6, Logger: Logger12 } = _Util36;
var fixedScale = _ModuleSupport64.MercatorScale.fixedScale();
...
import { _ModuleSupport as _ModuleSupport66, _Scale as _Scale17, _Scene as _Scene35, _Util as _Util37 } from "ag-charts-community";
var {
...
var { motion: motion3 } = _Scene35;
var { isNumber, normalizeAngle360: normalizeAngle3605, sanitizeHtml: sanitizeHtml7 } = _Util37;
var RadialColumnSeriesNodeEvent = class extends _ModuleSupport66.SeriesNodeEvent {
  constructor(type, nativeEvent, datum, series) {
    super(type, nativeEvent, datum, series);
...
var RadialColumnSeriesBase = class extends _ModuleSupport66.PolarSeries {
  constructor(moduleCtx, {
    animationResetFns
  }) {
    super({
...
import { _ModuleSupport as _ModuleSupport67, _Scene as _Scene36 } from "ag-charts-community";
var { Label: Label4 } = _Scene36;
var {
...
import { _Scene as _Scene37 } from "ag-charts-community";
var { motion: motion4 } = _Scene37;
...
var NIGHTINGALE_SERIES_THEME = {
  series: {
    __extends__: _Theme22.EXTENDS_SERIES_DEFAULTS,
    strokeWidth: 1,
    label: {
      enabled: false,
      fontSize: 12,
      ...
      __overrides__: _Theme22.OVERRIDE_SERIES_LABEL_DEFAULTS
    }
  },
  axes: {
...
var NightingaleModule = {
  ...
  paletteFactory({ takeColors, userPalette }) {
    ...
    return {
      fill,
      stroke: userPalette ? stroke : _Theme23.DEFAULT_POLAR_SERIES_STROKE
    };
  },
  stackable: true,
  groupable: true,
...
import { _ModuleSupport as _ModuleSupport74, _Theme as _Theme25 } from "ag-charts-community";

// packages/ag-charts-enterprise/src/series/radar/radarThemes.ts
import { _ModuleSupport as _ModuleSupport69, _Theme as _Theme24 } from "ag-charts-community";
var BASE_RADAR_SERIES_THEME = {
  series: {
    __extends__: _Theme24.EXTENDS_SERIES_DEFAULTS,
    label: {
      enabled: false,
      fontSize: 12,
      fontFamily: _Theme24.DEFAULT_FONT_FAMILY,
      color: _Theme24.DEFAULT_LABEL_COLOUR,
      __overrides__: _Theme24.OVERRIDE_SERIES_LABEL_DEFAULTS
    },
    marker: {
      enabled: true,
      fillOpacity: 1,
...
var RADAR_LINE_SERIES_THEME = _ModuleSupport69.mergeDefaults(
  {
    series: {
      strokeWidth: 2
    }
...
var RADAR_AREA_SERIES_THEME = _ModuleSupport69.mergeDefaults(
  {
    series: {
      fillOpacity: 0.8,
      strokeWidth: 2,
...
import { _ModuleSupport as _ModuleSupport73, _Scene as _Scene42 } from "ag-charts-community";

// packages/ag-charts-enterprise/src/series/radar/radarSeries.ts
import { _ModuleSupport as _ModuleSupport71, _Scene as _Scene41, _Util as _Util38 } from "ag-charts-community";

// packages/ag-charts-enterprise/src/series/radar/radarSeriesProperties.ts
import { _ModuleSupport as _ModuleSupport70, _Scene as _Scene40 } from "ag-charts-community";
var { Label: Label5 } = _Scene40;
var {
  SeriesMarker,
...
var { BBox: BBox8, Group: Group12, Path: Path6, PointerEvents: PointerEvents5, Selection: Selection8, Text: Text9, getMarker: getMarker2 } = _Scene41;
var { extent: extent3, isNumber: isNumber2, isNumberEqual: isNumberEqual8, sanitizeHtml: sanitizeHtml8, toFixed } = _Util38;
var RadarSeriesNodeEvent = class extends _ModuleSupport71.SeriesNodeEvent {
  constructor(type, nativeEvent, datum, series) {
    super(type, nativeEvent, datum, series);
    this.angleKey = series.properties.angleKey;
    this.radiusKey = series.properties.radiusKey;
...
var RadarSeries = class extends _ModuleSupport71.PolarSeries {
  constructor(moduleCtx) {
    super({
      moduleCtx,
      useLabelLayer: true,
...
var { RATIO: RATIO21, COLOR_STRING: COLOR_STRING16, Validate: Validate42 } = _ModuleSupport72;
...
// packages/ag-charts-enterprise/src/series/radar-area/radarAreaSeries.ts
var { Group: Group13, Path: Path7, PointerEvents: PointerEvents6, Selection: Selection9 } = _Scene42;
var { ChartAxisDirection: ChartAxisDirection13 } = _ModuleSupport73;
var RadarAreaSeries = class extends RadarSeries {
  ...
  getAreaPoints() {
    ...
    const getPolarAxis = (direction) => {
      ...
      return axis instanceof _ModuleSupport73.PolarAxis ? axis : void 0;
    };
...
// packages/ag-charts-enterprise/src/series/radar-area/radarAreaModule.ts
var { markerPaletteFactory } = _ModuleSupport74;
var RadarAreaModule = {
  type: "series",
  optionsKey: "series[]",
  packageType: "enterprise",
...
import { _ModuleSupport as _ModuleSupport76, _Scale as _Scale18, _Scene as _Scene45, _Util as _Util39 } from "ag-charts-community";

// packages/ag-charts-enterprise/src/series/radial-bar/radialBarSeriesProperties.ts
import { _ModuleSupport as _ModuleSupport75, _Scene as _Scene43 } from "ag-charts-community";
var { Label: Label6 } = _Scene43;
var {
...
var { Sector: Sector4, motion: motion7 } = _Scene45;
var { angleBetween: angleBetween3, isNumber: isNumber3, sanitizeHtml: sanitizeHtml9 } = _Util39;
var RadialBarSeriesNodeEvent = class extends _ModuleSupport76.SeriesNodeEvent {
  constructor(type, nativeEvent, datum, series) {
    super(type, nativeEvent, datum, series);
    this.angleKey = series.properties.angleKey;
    this.radiusKey = series.properties.radiusKey;
...
var RadialBarSeries = class extends _ModuleSupport76.PolarSeries {
  constructor(moduleCtx) {
    super({
      moduleCtx,
      useLabelLayer: true,
...
var RADIAL_BAR_SERIES_THEME = {
  series: {
    ...
    label: {
      ...
      color: _Theme27.DEFAULT_INVERTED_LABEL_COLOUR,
      __overrides__: _Theme27.OVERRIDE_SERIES_LABEL_DEFAULTS
    }
  },
  axes: {
    [_Theme27.POLAR_AXIS_TYPE.RADIUS_CATEGORY]: {
...
var RadialBarModule = {
  ...
  defaultAxes: [
    {
      type: _Theme28.POLAR_AXIS_TYPE.ANGLE_NUMBER
    },
    {
      type: _Theme28.POLAR_AXIS_TYPE.RADIUS_CATEGORY
    }
  ],
...
import { _ModuleSupport as _ModuleSupport78, _Scene as _Scene46 } from "ag-charts-community";
...
var { Validate: Validate44, RATIO: RATIO23 } = _ModuleSupport77;
...
// packages/ag-charts-enterprise/src/series/radial-column/radialColumnSeries.ts
var { ChartAxisDirection: ChartAxisDirection15, PolarAxis: PolarAxis4 } = _ModuleSupport78;
var { RadialColumnShape, getRadialColumnWidth } = _Scene46;
...
var RADIAL_COLUMN_SERIES_THEME = {
  series: {
    ...
    label: {
      ...
      color: _Theme29.DEFAULT_LABEL_COLOUR,
      __overrides__: _Theme29.OVERRIDE_SERIES_LABEL_DEFAULTS
    }
  },
  axes: {
    [_Theme29.POLAR_AXIS_TYPE.ANGLE_CATEGORY]: {
      shape: _Theme29.POLAR_AXIS_SHAPE.CIRCLE,
      groupPaddingInner: 0,
      paddingInner: 0,
      label: {
        padding: 10
    ...
    [_Theme29.POLAR_AXIS_TYPE.RADIUS_NUMBER]: {
      shape: _Theme29.POLAR_AXIS_SHAPE.CIRCLE,
...
var RadialColumnModule = {
  ...
  defaultAxes: [
    {
      type: _Theme30.POLAR_AXIS_TYPE.ANGLE_CATEGORY
    },
    {
      type: _Theme30.POLAR_AXIS_TYPE.RADIUS_NUMBER
    }
  ],
...
import { _ModuleSupport as _ModuleSupport81, _Theme as _Theme32 } from "ag-charts-community";

// packages/ag-charts-enterprise/src/series/range-area/rangeArea.ts
import { _ModuleSupport as _ModuleSupport80, _Scene as _Scene48, _Util as _Util40 } from "ag-charts-community";

// packages/ag-charts-enterprise/src/series/range-area/rangeAreaProperties.ts
import { _ModuleSupport as _ModuleSupport79, _Scene as _Scene47 } from "ag-charts-community";
var { DropShadow, Label: Label7 } = _Scene47;
var {
...
var { getMarker: getMarker3, PointerEvents: PointerEvents7 } = _Scene48;
var { sanitizeHtml: sanitizeHtml10, extent: extent4, isNumber: isNumber4 } = _Util40;
var RangeAreaSeriesNodeEvent = class extends _ModuleSupport80.SeriesNodeEvent {
  constructor(type, nativeEvent, datum, series) {
    super(type, nativeEvent, datum, series);
    this.xKey = series.properties.xKey;
...
var _RangeAreaSeries = class _RangeAreaSeries extends _ModuleSupport80.CartesianSeries {
  constructor(moduleCtx) {
    super({
      moduleCtx,
      hasMarkers: true,
...
var RANGE_AREA_SERIES_THEME = {
  series: {
    ...
    marker: {
      __extends__: _Theme31.EXTENDS_CARTESIAN_MARKER_DEFAULTS,
      enabled: false,
      fillOpacity: 1,
      strokeWidth: 2,
      size: 6
    ...
    label: {
      ...
      __overrides__: _Theme31.OVERRIDE_SERIES_LABEL_DEFAULTS
    }
  },
  axes: {
    [_Theme31.CARTESIAN_AXIS_TYPE.NUMBER]: {
      crosshair: {
        enabled: true,
        snap: false
      }
...
// packages/ag-charts-enterprise/src/series/range-area/rangeAreaModule.ts
var { markerPaletteFactory: markerPaletteFactory2 } = _ModuleSupport81;
var RangeAreaModule = {
  type: "series",
  optionsKey: "series[]",
  packageType: "enterprise",
  ...
  defaultAxes: [
    {
      type: _Theme32.CARTESIAN_AXIS_TYPE.NUMBER,
      position: _Theme32.POSITION.LEFT
    },
    {
      type: _Theme32.CARTESIAN_AXIS_TYPE.CATEGORY,
      position: _Theme32.POSITION.BOTTOM
    }
  ],
...
import { _ModuleSupport as _ModuleSupport83, _Scale as _Scale19, _Scene as _Scene50, _Util as _Util41 } from "ag-charts-community";

// packages/ag-charts-enterprise/src/series/range-bar/rangeBarProperties.ts
import { _ModuleSupport as _ModuleSupport82, _Scene as _Scene49 } from "ag-charts-community";
var { DropShadow: DropShadow2, Label: Label8 } = _Scene49;
var {
...
var { Rect: Rect4, PointerEvents: PointerEvents8, motion: motion8 } = _Scene50;
var { sanitizeHtml: sanitizeHtml11, isNumber: isNumber5, extent: extent5 } = _Util41;
var { ContinuousScale: ContinuousScale3, OrdinalTimeScale: OrdinalTimeScale4 } = _Scale19;
var RangeBarSeriesNodeEvent = class extends _ModuleSupport83.SeriesNodeEvent {
  constructor(type, nativeEvent, datum, series) {
    super(type, nativeEvent, datum, series);
    this.xKey = series.properties.xKey;
    this.yLowKey = series.properties.yLowKey;
...
var _RangeBarSeries = class _RangeBarSeries extends _ModuleSupport83.AbstractBarSeries {
  constructor(moduleCtx) {
    super({
      moduleCtx,
...
var RANGE_BAR_SERIES_THEME = {
  series: {
    __extends__: _Theme33.EXTENDS_SERIES_DEFAULTS,
    direction: "vertical",
    strokeWidth: 0,
    label: {
      enabled: false,
      ...
      color: _Theme33.DEFAULT_INSIDE_SERIES_LABEL_COLOUR,
      placement: "inside",
      __overrides__: _Theme33.OVERRIDE_SERIES_LABEL_DEFAULTS
    }
  },
  axes: {
...
// packages/ag-charts-enterprise/src/series/sunburst/sunburstSeries.ts
var { fromToMotion: fromToMotion3 } = _ModuleSupport85;
var { Sector: Sector5, Group: Group14, Selection: Selection10, Text: Text10 } = _Scene51;
var { sanitizeHtml: sanitizeHtml12 } = _Util42;
...
var _SunburstSeries = class _SunburstSeries extends _ModuleSupport85.HierarchySeries {
  constructor() {
    super(...arguments);
...
// packages/ag-charts-enterprise/src/series/sunburst/sunburstModule.ts
var { EXTENDS_SERIES_DEFAULTS: EXTENDS_SERIES_DEFAULTS5, DEFAULT_INSIDE_SERIES_LABEL_COLOUR } = _Theme35;
var SunburstModule = {
  type: "series",
  optionsKey: "series[]",
  packageType: "enterprise",
  ...
  paletteFactory: ({ takeColors, colorsCount, themeTemplateParameters }) => {
    const { properties } = themeTemplateParameters;
    const { fills, strokes } = takeColors(colorsCount);
    const defaultColorRange = properties.get(_Theme35.DEFAULT_DIVERGING_SERIES_COLOUR_RANGE);
...
import {
  _ModuleSupport as _ModuleSupport87,
  _Scene as _Scene53,
  _Util as _Util43
} from "ag-charts-community";

// packages/ag-charts-enterprise/src/series/treemap/treemapSeriesProperties.ts
import { _ModuleSupport as _ModuleSupport86, _Scene as _Scene52 } from "ag-charts-community";
var { Label: Label9 } = _Scene52;
var {
...
// packages/ag-charts-enterprise/src/series/treemap/treemapSeries.ts
var { Rect: Rect5, Group: Group15, BBox: BBox9, Selection: Selection11, Text: Text11 } = _Scene53;
var { Color: Color2, Logger: Logger13, isEqual, sanitizeHtml: sanitizeHtml13 } = _Util43;
...
var _TreemapSeries = class _TreemapSeries extends _ModuleSupport87.HierarchySeries {
  constructor() {
    super(...arguments);
...
import { _ModuleSupport as _ModuleSupport89, _Scale as _Scale20, _Scene as _Scene55, _Util as _Util44 } from "ag-charts-community";

// packages/ag-charts-enterprise/src/series/waterfall/waterfallSeriesProperties.ts
import { _ModuleSupport as _ModuleSupport88, _Scene as _Scene54 } from "ag-charts-community";
var { DropShadow: DropShadow3, Label: Label10 } = _Scene54;
var {
...
var { Rect: Rect6, motion: motion9 } = _Scene55;
var { sanitizeHtml: sanitizeHtml14, isContinuous, isNumber: isNumber6 } = _Util44;
var { ContinuousScale: ContinuousScale4, OrdinalTimeScale: OrdinalTimeScale5 } = _Scale20;
var _WaterfallSeries = class _WaterfallSeries extends _ModuleSupport89.AbstractBarSeries {
  constructor(moduleCtx) {
    super({
      moduleCtx,
    ...
    return __async(this, null, function* () {
      ...
      const { processedData } = yield this.requestDataModel(dataController, dataWithTotals, {
        props: [
          ...
          ...isContinuousX ? [_ModuleSupport89.SMALLEST_KEY_INTERVAL] : [],
          ...extraProps
        ],
        dataVisible: this.visible
      });
  ...
  getSeriesDomain(direction) {
    ...
    const {
      ...
      reduced: { [_ModuleSupport89.SMALLEST_KEY_INTERVAL.property]: smallestX } = {}
    } = processedData;
    const keyDef = dataModel.resolveProcessedDataDefById(this, `xValue`);
    if (direction === this.getCategoryDirection()) {
      if ((keyDef == null ? void 0 : keyDef.def.type) === "key" && (keyDef == null ? void 0 : keyDef.def.valueType) === "category") {
      ...
      const scalePadding = smallestX != null && isFinite(smallestX) ? smallestX : 0;
      const keysExtent = (_a2 = _ModuleSupport89.extent(keys)) != null ? _a2 : [NaN, NaN];
      const categoryAxis = this.getCategoryAxis();
  ...
  animateConnectorLinesHorizontal(lineNode, pointData) {
    ...
    this.ctx.animationManager.animate({
      ...
      from: startX,
      to: endX,
      ease: _ModuleSupport89.Motion.easeOut,
      collapsable: false,
      onUpdate(pointX) {
        linePath.clear({ trackChanges: true });
  ...
  updateLineNode(lineNode) {
    ...
    lineNode.setProperties({
      ...
      lineDashOffset,
      lineJoin: "round",
      pointerEvents: _Scene55.PointerEvents.None
    });
  }
  isLabelEnabled() {
...
var itemTheme = {
  ...
  label: {
    enabled: false,
    fontStyle: void 0,
    fontWeight: _Theme37.FONT_WEIGHT.NORMAL,
    fontSize: 12,
    fontFamily: _Theme37.DEFAULT_FONT_FAMILY,
    color: _Theme37.DEFAULT_LABEL_COLOUR,
    formatter: void 0,
    placement: "inside"
  }
};
var WATERFALL_SERIES_THEME = {
  series: {
    __extends__: _Theme37.EXTENDS_SERIES_DEFAULTS,
    item: {
      positive: itemTheme,
      negative: itemTheme,
      total: itemTheme
    ...
    line: {
      stroke: _Theme37.DEFAULT_WATERFALL_SERIES_CONNECTOR_LINE_STROKE,
      strokeOpacity: 1,
      lineDash: [0],
      lineDashOffset: 0,
      strokeWidth: 2
...
var WaterfallModule = {
  ...
  paletteFactory: ({ takeColors, colorsCount, userPalette, themeTemplateParameters }) => {
    ...
    return userPalette ? {
      ...
      item: {
        positive: properties.get(_Theme38.DEFAULT_WATERFALL_SERIES_POSITIVE_COLOURS),
        negative: properties.get(_Theme38.DEFAULT_WATERFALL_SERIES_NEGATIVE_COLOURS),
        total: properties.get(_Theme38.DEFAULT_WATERFALL_SERIES_TOTAL_COLOURS)
      }
    };
  }
};
...
function setupEnterpriseModules() {
  _ModuleSupport90.moduleRegistry.register(
  ...
  _ModuleSupport90.enterpriseModule.isEnterprise = true;
  _ModuleSupport90.enterpriseModule.licenseManager = (options) => {
    var _a2, _b;
    return new LicenseManager(
      (_b = (_a2 = options.container) == null ? void 0 : _a2.ownerDocument) != null ? _b : typeof document === "undefined" ? void 0 : document
    );
  };
  _ModuleSupport90.enterpriseModule.injectWatermark = injectWatermark;
}
