...
// packages/ag-charts-enterprise/src/axes/angle-category/angleCategoryAxis.ts
var { RATIO: RATIO2, OBJECT, Validate: Validate4 } = _ModuleSupport5;
...
// packages/ag-charts-enterprise/src/axes/angle-number/angleNumberAxis.ts
var { AND: AND3, Default, GREATER_THAN: GREATER_THAN2, LESS_THAN, NUMBER_OR_NAN, OBJECT: OBJECT2, Validate: Validate5 } = _ModuleSupport6;
...
// packages/ag-charts-enterprise/src/axes/radius/radiusAxis.ts
var { assignJsonApplyConstructedArray: assignJsonApplyConstructedArray2, ChartAxisDirection: ChartAxisDirection5, Default: Default2, Layers: Layers2, DEGREE: DEGREE2, BOOLEAN: BOOLEAN2, Validate: Validate7 } = _ModuleSupport9;
...
import { _ModuleSupport as _ModuleSupport30, _Scene as _Scene18, _Util as _Util25 } from "ag-charts-community";
...
import { _Util as _Util12 } from "ag-charts-community";
var { Logger } = _Util12;
...
var { BaseModuleInstance, InteractionState, Validate: Validate11, BOOLEAN: BOOLEAN4, createElement: createElement2, REGIONS, ChartAxisDirection: ChartAxisDirection7 } = _ModuleSupport17;
...
var AxisButton = class extends BaseModuleInstance {
  ...
  updateButtonElement() {
    const { button } = this;
    button.onclick = _ModuleSupport17.makeAccessibleClickListener(button, () => this.onButtonClick(this.coords));
...
// packages/ag-charts-enterprise/src/features/annotations/cross-line/crossLineProperties.ts
var { STRING: STRING3, BaseProperties: BaseProperties2, Validate: Validate13, isObject } = _ModuleSupport19;
...
import { _ModuleSupport as _ModuleSupport22, _Util as _Util15 } from "ag-charts-community";

// packages/ag-charts-enterprise/src/features/annotations/scenes/annotation.ts
import { _ModuleSupport as _ModuleSupport20, _Scene as _Scene12 } from "ag-charts-community";
...
var _Handle = class _Handle extends _Scene11.Group {
  constructor() {
    super(...arguments);
    this.active = false;
    this.locked = false;
...
var _InvariantHandle = class _InvariantHandle extends Handle {
  constructor() {
    super();
    this.handle = new _Scene11.Circle();
    this.glow = new _Scene11.Circle();
...
var _UnivariantHandle = class _UnivariantHandle extends Handle {
  constructor() {
    super();
    this.handle = new _Scene11.Rect();
    this.glow = new _Scene11.Rect();
...
// packages/ag-charts-enterprise/src/features/annotations/scenes/annotation.ts
var { isObject: isObject2 } = _ModuleSupport20;
var Annotation2 = class extends _Scene12.Group {
  constructor() {
    super(...arguments);
    this.locked = false;
  }
  ...
  getCachedBBoxWithoutHandles() {
    return this.cachedBBoxWithoutHandles ?? _Scene12.BBox.zero;
  }
  computeBBoxWithoutHandles() {
    this.computeTransformMatrix();
    return _Scene12.Group.computeBBox(this.children.filter((node) => !(node instanceof Handle)));
  }
  render(renderCtx) {
...
import { _ModuleSupport as _ModuleSupport21, _Scene as _Scene13 } from "ag-charts-community";
var { calculateLabelTranslation, ChartAxisDirection: ChartAxisDirection8 } = _ModuleSupport21;
var AxisLabel = class extends _Scene13.Group {
  constructor() {
    super({ name: "AnnotationAxisLabelGroup" });
    this.label = new _Scene13.Text({ zIndex: 1 });
    this.rect = new _Scene13.Rect();
    const { label } = this;
    label.fontSize = 12;
...
import { _Scene as _Scene14, _Util as _Util14 } from "ag-charts-community";
var { Vec2 } = _Util14;
var CollidableLine = class extends _Scene14.Line {
  constructor() {
    super(...arguments);
  ...
  updateCollisionBBox() {
    ...
    this.collisionBBox = new _Scene14.BBox(topLeft.x, topLeft.y, width, height);
  }
...
// packages/ag-charts-enterprise/src/features/annotations/cross-line/crossLineScene.ts
var { Vec2: Vec22 } = _Util15;
var { ChartAxisDirection: ChartAxisDirection9 } = _ModuleSupport22;
...
import { _ModuleSupport as _ModuleSupport23, _Util as _Util16 } from "ag-charts-community";
var CrossLineStateMachine = class extends _ModuleSupport23.StateMachine {
  constructor(direction, appendDatum, onExit) {
    ...
    this.debug = _Util16.Debug.create(true, "annotations");
  }
};

// packages/ag-charts-enterprise/src/features/annotations/disjoint-channel/disjointChannelProperties.ts
import { _ModuleSupport as _ModuleSupport24, _Util as _Util17 } from "ag-charts-community";
var { NUMBER: NUMBER4, STRING: STRING4, BaseProperties: BaseProperties3, Validate: Validate14, isObject: isObject3 } = _ModuleSupport24;
var DisjointChannelAnnotation = class extends Annotation(
  ...
  get bottom() {
    ...
    if (typeof bottom.start.y === "number" && typeof bottom.end.y === "number") {
      ...
      _Util17.Logger.warnOnce(`Annotation [${this.type}] can only be used with a numeric y-axis.`);
    }
    return bottom;
  }
  isValidWithContext(context, warningPrefix) {
...
import { _Util as _Util18 } from "ag-charts-community";
var { Vec2: Vec23 } = _Util18;
...
var ChannelScene = class extends LinearScene {
  constructor() {
    ...
    this.background = new _Scene15.Path({ zIndex: -1 });
  }
  update(datum, context) {
...
var DisjointChannelStateMachine = class extends _ModuleSupport25.StateMachine {
  constructor(appendDatum, validateDatumPoint2) {
    ...
    this.debug = _Util20.Debug.create(true, "annotations");
  }
};
...
var { STRING: STRING5, BaseProperties: BaseProperties4, Validate: Validate15, isObject: isObject4 } = _ModuleSupport26;
...
import { _ModuleSupport as _ModuleSupport27, _Util as _Util21 } from "ag-charts-community";
var LineStateMachine = class extends _ModuleSupport27.StateMachine {
  constructor(appendDatum) {
    ...
    this.debug = _Util21.Debug.create(true, "annotations");
  }
};

// packages/ag-charts-enterprise/src/features/annotations/parallel-channel/parallelChannelProperties.ts
import { _ModuleSupport as _ModuleSupport28, _Util as _Util22 } from "ag-charts-community";
var { NUMBER: NUMBER5, STRING: STRING6, OBJECT: OBJECT4, BaseProperties: BaseProperties5, Validate: Validate16, isObject: isObject5 } = _ModuleSupport28;
...
import { _Scene as _Scene17, _Util as _Util23 } from "ag-charts-community";
var { Vec2: Vec25 } = _Util23;
var ParallelChannel = class extends ChannelScene {
  constructor() {
    ...
    this.middleLine = new _Scene17.Line();
...
var ParallelChannelStateMachine = class extends _ModuleSupport29.StateMachine {
  constructor(appendDatum, validateDatumPoint2) {
    const onStartClick = ({ point }) => {
...
var AnnotationsStateMachine = class extends StateMachine {
  constructor(onEnterIdle, appendDatum, onExitCrossLine, validateChildStateDatumPoint) {
    ...
    this.debug = _Util25.Debug.create(true, "annotations");
  }
};
...
var Annotations = class extends _ModuleSupport30.BaseModuleInstance {
  constructor(ctx) {
    super();
    this.ctx = ctx;
    ...
    this.container = new _Scene18.Group({ name: "static-annotations" });
    this.annotations = new _Scene18.Selection(
      this.container,
  ...
  onToolbarButtonPress(event) {
    ...
    if (!annotation) {
      _Util25.Logger.errorOnce(`Can not create unknown annotation type [${event.value}], ignoring.`);
      this.update();
      return;
    }
    if (!state.is("idle")) {
  ...
  onLayoutComplete(event) {
    ...
    for (const axisLayout of event.axes ?? []) {
      if (axisLayout.direction === _ModuleSupport30.ChartAxisDirection.X) {
  ...
  getAxis(axisLayout, seriesRect, button) {
    ...
    const bounds = buildBounds(new _Scene18.BBox(0, 0, seriesRect.width, seriesRect.height), axisPosition, padding);
...
__decorateClass([
  _ModuleSupport30.ObserveChanges((target, enabled) => {
    const {
...
import { _ModuleSupport as _ModuleSupport31, _Scene as _Scene19 } from "ag-charts-community";
var { Image } = _Scene19;
var {
...
// packages/ag-charts-enterprise/src/features/background/background.ts
var { ActionOnSet, OBJECT: OBJECT5, Validate: Validate19 } = _ModuleSupport32;
var Background = class extends _ModuleSupport32.Background {
  constructor(ctx) {
    super(ctx);
    this.ctx = ctx;
  ...
  onImageLoad() {
    this.ctx.updateService.update(_ModuleSupport32.ChartUpdateType.SCENE_RENDER);
  }
};
__decorateClass([
...
import { _ModuleSupport as _ModuleSupport33, _Util as _Util26 } from "ag-charts-community";
...
// packages/ag-charts-enterprise/src/features/context-menu/contextMenu.ts
var { BOOLEAN: BOOLEAN7, Validate: Validate20, createElement: createElement4, initMenuKeyNav, makeAccessibleClickListener, ContextMenuRegistry } = _ModuleSupport33;
...
var ContextMenu = class extends _ModuleSupport33.BaseModuleInstance {
  constructor(ctx) {
    super();
    this.ctx = ctx;
    this.enabled = true;
    ...
    const { All } = _ModuleSupport33.InteractionState;
  ...
  show() {
    this.interactionManager.pushState(_ModuleSupport33.InteractionState.ContextMenu);
  ...
  hide() {
    this.interactionManager.popState(_ModuleSupport33.InteractionState.ContextMenu);
    if (this.menuElement) {
    ...
    if (ContextMenuRegistry.checkCallback("legend", type, callback)) {
      ...
      return () => {
        ...
        if (event) {
          ...
          _Util26.Logger.error("series node not found");
        }
        this.hide();
      };
    }
  ...
  reposition() {
    ...
    x = _ModuleSupport33.clamp(0, x, canvasRect.width - width);
    y = _ModuleSupport33.clamp(0, y, canvasRect.height - height);
...
var ContextMenuModule = {
  ...
  themeTemplate: {
    contextMenu: {
      enabled: true,
      darkTheme: _Theme2.IS_DARK_THEME
    }
  }
};

// packages/ag-charts-enterprise/src/features/crosshair/crosshair.ts
import { _ModuleSupport as _ModuleSupport35, _Scene as _Scene21, _Util as _Util28 } from "ag-charts-community";

// packages/ag-charts-enterprise/src/features/crosshair/crosshairLabel.ts
import { _ModuleSupport as _ModuleSupport34, _Scene as _Scene20, _Util as _Util27 } from "ag-charts-community";
...
// packages/ag-charts-enterprise/src/features/crosshair/crosshairLabel.ts
var { ActionOnSet: ActionOnSet2, BaseProperties: BaseProperties7, BOOLEAN: BOOLEAN8, FUNCTION: FUNCTION2, NUMBER: NUMBER7, STRING: STRING7, Validate: Validate21 } = _ModuleSupport34;
var { setAttribute } = _Util27;
var DEFAULT_LABEL_CLASS = "ag-crosshair-label";
var CrosshairLabelProperties = class extends _Scene20.ChangeDetectableProperties {
  constructor() {
    super(...arguments);
    this.enabled = true;
    this.xOffset = 0;
...
var CrosshairLabel = class extends BaseProperties7 {
  ...
  computeBBox() {
    const { element } = this;
    return new _Scene20.BBox(element.clientLeft, element.clientTop, element.clientWidth, element.clientHeight);
  }
  toggle(visible) {
...
// packages/ag-charts-enterprise/src/features/crosshair/crosshair.ts
var { Group: Group3, Line: Line2, BBox } = _Scene21;
var { createId: createId2 } = _Util28;
var { POSITIVE_NUMBER: POSITIVE_NUMBER6, RATIO: RATIO6, BOOLEAN: BOOLEAN9, COLOR_STRING: COLOR_STRING3, LINE_DASH: LINE_DASH3, OBJECT: OBJECT6, InteractionState: InteractionState3, Validate: Validate22, Layers: Layers3 } = _ModuleSupport35;
var Crosshair = class extends _ModuleSupport35.BaseModuleInstance {
  constructor(ctx) {
    super();
    this.ctx = ctx;
    ...
    this.lineGroupSelection = _Scene21.Selection.select(this.lineGroup, Line2, false);
...
var { BOOLEAN: BOOLEAN10, FUNCTION: FUNCTION3, ActionOnSet: ActionOnSet3, Validate: Validate23 } = _ModuleSupport36;
var DataSource = class extends _ModuleSupport36.BaseModuleInstance {
  constructor(ctx) {
    super();
    this.enabled = false;
...
import { AgErrorBarSupportedSeriesTypes, _ModuleSupport as _ModuleSupport39, _Scene as _Scene23, _Util as _Util29 } from "ag-charts-community";

// packages/ag-charts-enterprise/src/features/error-bar/errorBarNode.ts
import { _ModuleSupport as _ModuleSupport37, _Scene as _Scene22 } from "ag-charts-community";
var { nearestSquaredInContainer, partialAssign, mergeDefaults } = _ModuleSupport37;
var { BBox: BBox2 } = _Scene22;
...
var ErrorBarNode = class extends _Scene22.Group {
  constructor() {
    super();
    this.capLength = NaN;
    this._datum = void 0;
    this.whiskerPath = new _Scene22.Path();
    this.capsPath = new _Scene22.Path();
...
var ErrorBarGroup = class extends _Scene22.Group {
  get children() {
...
import {
  _ModuleSupport as _ModuleSupport38
} from "ag-charts-community";
var {
...
var ErrorBars = class _ErrorBars extends _ModuleSupport39.BaseModuleInstance {
  constructor(ctx) {
    super();
    ...
    this.groupNode = new ErrorBarGroup({
      ...
      zIndex: _ModuleSupport39.Layers.SERIES_LAYER_ZINDEX,
      zIndexSubOrder: series.getGroupZIndexSubOrder("annotation")
    });
    annotationGroup.appendChild(this.groupNode);
    this.selection = _Scene23.Selection.select(this.groupNode, () => this.errorBarFactory());
  ...
  static getDatumKey(datum, key, offset) {
    ...
    if (typeof value !== "number") {
      _Util29.Logger.warnOnce(`Found [${key}] error value of type ${typeof value}. Expected number type`);
      return;
    }
    return value + offset;
  }
...
import { _ModuleSupport as _ModuleSupport42, _Theme as _Theme5 } from "ag-charts-community";
...
import { _ModuleSupport as _ModuleSupport40, _Scene as _Scene24, _Util as _Util30 } from "ag-charts-community";
var { Validate: Validate25, BOOLEAN: BOOLEAN12, POSITIVE_NUMBER: POSITIVE_NUMBER8, Layers: Layers4, ActionOnSet: ActionOnSet4, CategoryAxis, GroupedCategoryAxis } = _ModuleSupport40;
var { Padding, Logger: Logger2 } = _Util30;
var { Text: Text4, Group: Group4, BBox: BBox3 } = _Scene24;
...
var MiniChart = class extends _ModuleSupport40.BaseModuleInstance {
  constructor(ctx) {
    super();
    this.ctx = ctx;
    this.enabled = false;
...
// packages/ag-charts-enterprise/src/features/navigator/navigator.ts
var { ObserveChanges: ObserveChanges3 } = _ModuleSupport41;
var Navigator = class extends _ModuleSupport41.Navigator {
  constructor(ctx) {
    super(ctx);
...
var NavigatorModule = {
  ...
  themeTemplate: {
    ..._ModuleSupport42.NavigatorModule.themeTemplate,
    navigator: {
      ..._ModuleSupport42.NavigatorModule.themeTemplate?.navigator,
      miniChart: {
        enabled: false,
        label: {
...
import { _ModuleSupport as _ModuleSupport43, _Scene as _Scene26 } from "ag-charts-community";
var { Validate: Validate26, OBJECT: OBJECT8, BOOLEAN: BOOLEAN13, STRING: STRING9, valueProperty: valueProperty2 } = _ModuleSupport43;
var { Label: Label2, Text: Text5, Group: Group5 } = _Scene26;
var StatusBarLabel = class extends Label2 {
};
var StatusBar = class extends _ModuleSupport43.BaseModuleInstance {
  constructor(ctx) {
    super();
    this.enabled = false;
    this.openKey = void 0;
...
var StatusBarModule = {
  ...
  themeTemplate: {
    statusBar: {
      ...
      closeKey: void 0,
      volumeKey: void 0,
      layoutStyle: _Theme6.DEFAULT_CAPTION_LAYOUT_STYLE,
      title: {
        color: _Theme6.DEFAULT_LABEL_COLOUR
      },
      positive: {
        color: _Theme6.PALETTE_UP_STROKE
      },
      negative: {
        color: _Theme6.PALETTE_DOWN_STROKE
      }
    }
  }
};
...
import { _ModuleSupport as _ModuleSupport55, _Util as _Util35 } from "ag-charts-community";

// packages/ag-charts-enterprise/src/features/zoom/scenes/zoomRect.ts
import { _ModuleSupport as _ModuleSupport46, _Scene as _Scene27 } from "ag-charts-community";
var { COLOR_STRING: COLOR_STRING5, RATIO: RATIO8, Validate: Validate28 } = _ModuleSupport46;
var ZoomRect = class extends _Scene27.Rect {
  constructor() {
    super(...arguments);
...
var { clamp: clamp2, isEqual, round } = _ModuleSupport47;
...
var ZoomAxisDragger = class {
  update(event, direction, anchor, bbox, zoom, axisZoom) {
    this.oldZoom ?? (this.oldZoom = definedZoomState(
      direction === _ModuleSupport48.ChartAxisDirection.X ? { ...zoom, x: axisZoom } : { ...zoom, y: axisZoom }
    ));
  ...
  updateZoom(direction, anchor, bbox) {
    ...
    if (!coords || !oldZoom) {
      if (direction === _ModuleSupport48.ChartAxisDirection.X)
        return newZoom.x;
      return newZoom.y;
    }
...
var ZoomPanner = class {
  ...
  translateZooms(bbox, currentZooms, deltaX, deltaY) {
    ...
    for (const [axisId, { direction, zoom: currentZoom }] of Object.entries(currentZooms)) {
      let zoom;
      if (direction === _ModuleSupport49.ChartAxisDirection.X) {
...
import { _ModuleSupport as _ModuleSupport50, _Util as _Util33 } from "ag-charts-community";
var { AND: AND5, DATE: DATE2, NUMBER: NUMBER9, OR: OR3, ActionOnSet: ActionOnSet5, isFiniteNumber: isFiniteNumber2, isValidDate, Validate: Validate29 } = _ModuleSupport50;
var ZoomRange = class {
  ...
  updateAxis(axes) {
    ...
    const changed = this.domain == null || !_Util33.areArrayItemsStrictlyEqual(this.domain, validAxisDomain);
    if (changed) {
...
var { AND: AND6, GREATER_THAN: GREATER_THAN4, LESS_THAN: LESS_THAN3, RATIO: RATIO9, ActionOnSet: ActionOnSet6, Validate: Validate30 } = _ModuleSupport51;
var ZoomRatio = class {
  constructor(onChange) {
    this.onChange = onChange;
  }
...
var ZoomScrollPanner = class {
  ...
  translateZooms(bbox, currentZooms, deltaX) {
    ...
    for (const [axisId, { direction, zoom: currentZoom }] of Object.entries(currentZooms)) {
      if (direction !== _ModuleSupport52.ChartAxisDirection.X)
        continue;
...
var ZoomScroller = class {
  updateAxes(event, props, bbox, zooms) {
    ...
    for (const [axisId, { direction, zoom }] of Object.entries(zooms)) {
      ...
      if (direction === _ModuleSupport53.ChartAxisDirection.X && isScalingX) {
        newZoom.max += delta3;
        newZoom = scaleZoomAxisWithAnchor(newZoom, zoom, anchorPointX, origin.x);
      } else if (direction === _ModuleSupport53.ChartAxisDirection.Y && isScalingY) {
        newZoom.max += delta3;
...
var { ChartAxisDirection: ChartAxisDirection12, ToolbarManager: ToolbarManager2 } = _ModuleSupport54;
...
var ZoomButtonsProperties = class extends _ModuleSupport55.BaseProperties {
  constructor(onChange) {
    super();
    this.onChange = onChange;
    this.enabled = false;
...
__decorateClass([
  _ModuleSupport55.ObserveChanges((target) => {
    target.onChange();
  }),
...
var Zoom = class extends _ModuleSupport55.BaseModuleInstance {
  constructor(ctx) {
    super();
    this.ctx = ctx;
    this.enabled = false;
    ...
    const { Default: Default4, ZoomDrag, Animation: Animation2 } = _ModuleSupport55.InteractionState;
  ...
  onDrag(event) {
    ...
    if (!enabled || !paddedRect || !seriesRect)
      return;
    interactionManager.pushState(_ModuleSupport55.InteractionState.ZoomDrag);
    const zoom = this.getZoom();
    switch (dragState) {
      case 1 /* Axis */:
        if (!hoveredAxis)
        ...
        const anchor = direction === _ModuleSupport55.ChartAxisDirection.X ? anchorPointX : anchorPointY;
  ...
  onDragEnd(_event) {
    ...
    interactionManager.popState(_ModuleSupport55.InteractionState.ZoomDrag);
  ...
  onWheelScrolling(event) {
    ...
    if (isAxisScrolling) {
      isScalingX = hoveredAxis.direction === _ModuleSupport55.ChartAxisDirection.X;
  ...
  onLayoutComplete(event) {
    ...
    if (!axes)
      return;
    const [axesX, axesY] = _Util35.bifurcate((axis) => axis.direction === ChartAxisDirection13.X, axes);
...
import {
  _ModuleSupport as _ModuleSupport56,
  _Scale as _Scale8,
  _Scene as _Scene30,
  _Util as _Util36
} from "ag-charts-community";
var { BOOLEAN: BOOLEAN16, OBJECT: OBJECT9, Layers: Layers5, POSITION, Validate: Validate32, POSITIVE_NUMBER: POSITIVE_NUMBER9, ProxyProperty: ProxyProperty3 } = _ModuleSupport56;
var { BBox: BBox4, Group: Group6, Rect, LinearGradientFill, Triangle } = _Scene30;
var { createId: createId3 } = _Util36;
...
var GradientLegendAxis = class extends _ModuleSupport56.CartesianAxis {
  constructor(ctx) {
...
// packages/ag-charts-enterprise/src/license/watermark.ts
var { createElement: createElement5 } = _ModuleSupport57;
...
import { _Theme as _Theme9, _Util as _Util39 } from "ag-charts-community";

// packages/ag-charts-enterprise/src/series/box-plot/boxPlotSeries.ts
import { _ModuleSupport as _ModuleSupport60, _Scale as _Scale9, _Scene as _Scene32, _Util as _Util38 } from "ag-charts-community";
...
import { _ModuleSupport as _ModuleSupport58, _Scene as _Scene31, _Util as _Util37 } from "ag-charts-community";
var { Group: Group7, Rect: Rect2, Line: Line3, BBox: BBox5, Selection: Selection2 } = _Scene31;
var { Logger: Logger4 } = _Util37;
var BoxPlotGroup = class extends Group7 {
  ...
  distanceSquared(x, y) {
    ...
    return _ModuleSupport58.nearestSquared(x, y, nodes).distanceSquared;
  }
  get midPoint() {
...
var { Color: Color2 } = _Util38;
var BoxPlotSeriesNodeEvent = class extends _ModuleSupport60.SeriesNodeEvent {
...
var BoxPlotSeries = class extends _ModuleSupport60.AbstractBarSeries {
  constructor(moduleCtx) {
    super({
      moduleCtx,
  ...
  getTooltipHtml(nodeDatum) {
    ...
    const title = _Util38.sanitizeHtml(yName);
    const contentData = [
      [xKey, xName, xAxis],
    ...
    const content = contentData.map(([key, name, axis]) => _Util38.sanitizeHtml(`${name ?? key}: ${axis.formatDatum(datum[key])}`)).join(title ? "<br/>" : ", ");
...
var BoxPlotModule = {
  ...
  paletteFactory: ({ takeColors, themeTemplateParameters }) => {
    const themeBackgroundColor = themeTemplateParameters.get(_Theme9.DEFAULT_BACKGROUND_COLOUR);
...
import { _ModuleSupport as _ModuleSupport62, _Scene as _Scene33, _Util as _Util40 } from "ag-charts-community";
...
var { fromToMotion } = _Scene33.motion;
var { sanitizeHtml, Color: Color4 } = _Util40;
var STYLING_KEYS = [
  "fill",
  "fillOpacity",
  "stroke",
...
var BulletSeries = class extends _ModuleSupport62.AbstractBarSeries {
  constructor(moduleCtx) {
    super({
      moduleCtx,
      ...
      pickModes: [
        _ModuleSupport62.SeriesNodePickMode.NEAREST_NODE,
        _ModuleSupport62.SeriesNodePickMode.EXACT_SHAPE_MATCH
      ],
      hasHighlightedLabels: true,
      animationResetFns: {
    ...
    this.colorRangesGroup = new _Scene33.Group({ name: `${this.id}-colorRanges` });
    this.colorRangesSelection = _Scene33.Selection.select(this.colorRangesGroup, _Scene33.Rect, false);
    this.rootGroup.append(this.colorRangesGroup);
    this.targetLinesSelection = _Scene33.Selection.select(this.annotationGroup, _Scene33.Line, false);
  }
  destroy() {
  ...
  async createNodeData() {
    ...
    for (const { datum, values } of processedData.data) {
      ...
      if (values[0][valueIndex] < 0) {
        _Util40.Logger.warnOnce("negative values are not supported, clipping to 0.");
      }
      ...
      const barAlongX = this.getBarDirection() === _ModuleSupport62.ChartAxisDirection.X;
      const rect = {
      ...
      if (values[0][targetIndex] < 0) {
        _Util40.Logger.warnOnce("negative targets are not supported, ignoring.");
      }
  ...
  getTooltipHtml(nodeDatum) {
    ...
    if (valueKey === void 0 || valueValue === void 0 || axis === void 0) {
      return _ModuleSupport62.EMPTY_TOOLTIP_CONTENT;
    }
  ...
  async updateColorRanges() {
    ...
    const computeRect = this.getBarDirection() === _ModuleSupport62.ChartAxisDirection.Y ? (rect, colorRange) => {
      rect.x = min;
...
var BulletModule = {
  ...
  paletteFactory: ({ takeColors, colorsCount, themeTemplateParameters }) => {
    ...
    const themeBackgroundColor = themeTemplateParameters.get(_Theme11.DEFAULT_BACKGROUND_COLOUR);
    const backgroundFill = (Array.isArray(themeBackgroundColor) ? themeBackgroundColor[0] : themeBackgroundColor) ?? "white";
    const targetStroke = themeTemplateParameters.get(_Theme11.DEFAULT_CROSS_LINES_COLOUR);
    return {
      fill,
      stroke,
...
import {
  _ModuleSupport as _ModuleSupport65,
  _Scale as _Scale11,
  _Scene as _Scene34,
  _Util as _Util41
} from "ag-charts-community";
...
var { computeBarFocusBounds: computeBarFocusBounds3, NODE_UPDATE_STATE_TO_PHASE_MAPPING } = _ModuleSupport64;
...
var { sanitizeHtml: sanitizeHtml2, Logger: Logger5 } = _Util41;
var { ContinuousScale: ContinuousScale2 } = _Scale11;
var CandlestickSeriesNodeEvent = class extends _ModuleSupport65.SeriesNodeEvent {
  constructor(type, nativeEvent, datum, series) {
    super(type, nativeEvent, datum, series);
    this.xKey = series.properties.xKey;
...
var OhlcSeriesBase = class extends _ModuleSupport65.AbstractBarSeries {
  ...
  getTooltipHtml(nodeDatum) {
    ...
    const yAxis = this.getValueAxis();
    if (!xAxis || !yAxis || !this.properties.isValid())
      return _ModuleSupport65.EMPTY_TOOLTIP_CONTENT;
...
import { _ModuleSupport as _ModuleSupport66, _Scene as _Scene35, _Util as _Util42 } from "ag-charts-community";
var { SceneChangeDetection, BBox: BBox6, RedrawType } = _Scene35;
var CandlestickBaseGroup = class extends _Scene35.Group {
  constructor() {
    super(...arguments);
    this.x = 0;
    this.y = 0;
  ...
  distanceSquared(x, y) {
    const nodes = _Scene35.Selection.selectByClass(this, _Scene35.Rect, _Scene35.Line);
    return _ModuleSupport66.nearestSquared(x, y, nodes).distanceSquared;
  }
  get midPoint() {
    const datum = this.datum;
    if (datum.midPoint === void 0) {
      _Util42.Logger.error("CandlestickBaseGroup.datum.midPoint is undefined");
      return { x: NaN, y: NaN };
    }
    return datum.midPoint;
  }
...
var CandlestickGroup = class extends CandlestickBaseGroup {
  constructor() {
    super();
    this.append([
      new _Scene35.Rect({ tag: 0 /* Body */ }),
      new _Scene35.Line({ tag: 1 /* LowWick */ }),
      new _Scene35.Line({ tag: 2 /* HighWick */ })
    ]);
  }
  updateCoordinates() {
    const { x, y, yBottom, yHigh, yLow, width, height } = this;
    const selection = _Scene35.Selection.select(this, _Scene35.Rect);
...
// packages/ag-charts-enterprise/src/series/candlestick/candlestickSeries.ts
var { extractDecoratedProperties: extractDecoratedProperties2, mergeDefaults: mergeDefaults5 } = _ModuleSupport68;
...
var CANDLESTICK_SERIES_THEME = {
  ...
  axes: {
    ...
    [_Theme12.CARTESIAN_AXIS_TYPE.ORDINAL_TIME]: {
      groupPaddingInner: 0,
      crosshair: {
        enabled: true
      }
...
var CandlestickModule = {
  ...
  defaultAxes: [
    ...
    {
      type: _Theme13.CARTESIAN_AXIS_TYPE.ORDINAL_TIME,
...
import { _ModuleSupport as _ModuleSupport69, _Scene as _Scene37 } from "ag-charts-community";
...
// packages/ag-charts-enterprise/src/series/flow-proportion/flowProportionSeries.ts
var { DataModelSeries, DataController, Validate: Validate36, ARRAY: ARRAY4, keyProperty: keyProperty4, valueProperty: valueProperty6 } = _ModuleSupport69;
var { Selection: Selection3, Group: Group8, Text: Text6 } = _Scene37;
...
import { _Scene as _Scene38 } from "ag-charts-community";
var { Path: Path5, ScenePathChangeDetection } = _Scene38;
...
import {
  _ModuleSupport as _ModuleSupport70,
  _Scene as _Scene39
} from "ag-charts-community";
var {
...
// packages/ag-charts-enterprise/src/series/chord/chordSeries.ts
var { SeriesNodePickMode: SeriesNodePickMode3, createDatumId: createDatumId2, EMPTY_TOOLTIP_CONTENT } = _ModuleSupport71;
var { angleBetween: angleBetween3, normalizeAngle360: normalizeAngle3605, isBetweenAngles, sanitizeHtml: sanitizeHtml3, Logger: Logger7 } = _Util45;
var { Sector: Sector3, Text: Text7 } = _Scene40;
...
// packages/ag-charts-enterprise/src/series/chord/chordModule.ts
var { DEFAULT_FONT_FAMILY, DEFAULT_LABEL_COLOUR } = _Theme14;
var ChordModule = {
  type: "series",
  optionsKey: "series[]",
  packageType: "enterprise",
...
import { _ModuleSupport as _ModuleSupport75, _Scale as _Scale12, _Scene as _Scene42, _Util as _Util47 } from "ag-charts-community";

// packages/ag-charts-enterprise/src/series/util/labelFormatter.ts
import { _ModuleSupport as _ModuleSupport73, _Scene as _Scene41, _Util as _Util46 } from "ag-charts-community";
var { Validate: Validate38, NUMBER: NUMBER11, TEXT_WRAP, OVERFLOW_STRATEGY } = _ModuleSupport73;
var { Logger: Logger8 } = _Util46;
var { Text: Text8, Label: Label4 } = _Scene41;
...
var { Rect: Rect3, PointerEvents } = _Scene42;
var { ColorScale } = _Scale12;
var { sanitizeHtml: sanitizeHtml4, Logger: Logger9 } = _Util47;
var HeatmapSeriesNodeEvent = class extends _ModuleSupport75.CartesianSeriesNodeEvent {
  constructor(type, nativeEvent, datum, series) {
    super(type, nativeEvent, datum, series);
...
var HeatmapSeries = class extends _ModuleSupport75.CartesianSeries {
  constructor(moduleCtx) {
    super({
      moduleCtx,
  ...
  getTooltipHtml(nodeDatum) {
    ...
    if (!this.properties.isValid() || !xAxis || !yAxis) {
      return _ModuleSupport75.EMPTY_TOOLTIP_CONTENT;
    }
    const {
      xKey,
      yKey,
...
var HEATMAP_SERIES_THEME = {
  series: {
    label: {
      enabled: false,
      color: _Theme15.DEFAULT_LABEL_COLOUR,
      fontSize: _Theme15.FONT_SIZE.SMALL,
      fontFamily: _Theme15.DEFAULT_FONT_FAMILY,
      wrapping: "on-space",
...
var HeatmapModule = {
  ...
  defaultAxes: [
    {
      type: _Theme16.CARTESIAN_AXIS_TYPE.CATEGORY,
      position: _Theme16.POSITION.LEFT
    },
    {
      type: _Theme16.CARTESIAN_AXIS_TYPE.CATEGORY,
      position: _Theme16.POSITION.BOTTOM
    }
  ],
  themeTemplate: HEATMAP_SERIES_THEME,
  paletteFactory: ({ takeColors, colorsCount, userPalette, themeTemplateParameters }) => {
    const defaultColorRange = themeTemplateParameters.get(_Theme16.DEFAULT_DIVERGING_SERIES_COLOUR_RANGE);
    const defaultBackgroundColor = themeTemplateParameters.get(_Theme16.DEFAULT_BACKGROUND_COLOUR);
...
import { _ModuleSupport as _ModuleSupport80, _Scene as _Scene44, _Util as _Util48 } from "ag-charts-community";
...
var { LonLatBBox } = _ModuleSupport76;
...
// packages/ag-charts-enterprise/src/series/map-util/geoGeometry.ts
var { Path: Path6, ExtendedPath2D, BBox: BBox7, ScenePathChangeDetection: ScenePathChangeDetection2 } = _Scene43;
...
function isValidCoordinate(v) {
  return Array.isArray(v) && v.length >= 2 && v.every(_ModuleSupport78.isFiniteNumber);
}
...
var GEOJSON_OBJECT = _ModuleSupport78.predicateWithMessage(isValidFeatureCollection, "a GeoJSON object");
...
var { COLOR_STRING: COLOR_STRING11, LINE_DASH: LINE_DASH9, OBJECT: OBJECT15, POSITIVE_NUMBER: POSITIVE_NUMBER15, RATIO: RATIO16, Validate: Validate40, SeriesProperties: SeriesProperties2, SeriesTooltip: SeriesTooltip6 } = _ModuleSupport79;
...
// packages/ag-charts-enterprise/src/series/map-line-background/mapLineBackgroundSeries.ts
var { createDatumId: createDatumId3, DataModelSeries: DataModelSeries2, SeriesNodePickMode: SeriesNodePickMode5, Validate: Validate41 } = _ModuleSupport80;
var { Group: Group9, Selection: Selection4, PointerEvents: PointerEvents2 } = _Scene44;
var { Logger: Logger10 } = _Util48;
...
// packages/ag-charts-enterprise/src/series/map-line-background/mapLineBackgroundModule.ts
var { DEFAULT_HIERARCHY_STROKES } = _Theme17;
...
import { _ModuleSupport as _ModuleSupport83, _Scale as _Scale13, _Scene as _Scene46, _Util as _Util50 } from "ag-charts-community";
...
import { _ModuleSupport as _ModuleSupport82, _Scene as _Scene45 } from "ag-charts-community";
var {
  AND: AND8,
  ARRAY: ARRAY7,
...
// packages/ag-charts-enterprise/src/series/map-line/mapLineSeries.ts
var { getMissCount: getMissCount2, createDatumId: createDatumId4, DataModelSeries: DataModelSeries3, SeriesNodePickMode: SeriesNodePickMode6, valueProperty: valueProperty8, Validate: Validate43 } = _ModuleSupport83;
var { ColorScale: ColorScale2, LinearScale: LinearScale3 } = _Scale13;
var { Selection: Selection5, Text: Text9 } = _Scene46;
var { sanitizeHtml: sanitizeHtml5, Logger: Logger11 } = _Util50;
...
// packages/ag-charts-enterprise/src/series/map-line/mapLineModule.ts
var { DEFAULT_DIVERGING_SERIES_COLOUR_RANGE, DEFAULT_FONT_FAMILY: DEFAULT_FONT_FAMILY2, DEFAULT_LABEL_COLOUR: DEFAULT_LABEL_COLOUR2, singleSeriesPaletteFactory } = _Theme18;
var MapLineModule = {
  type: "series",
  optionsKey: "series[]",
  packageType: "enterprise",
...
import { _ModuleSupport as _ModuleSupport86, _Scale as _Scale14, _Scene as _Scene48, _Util as _Util52 } from "ag-charts-community";
...
import { _ModuleSupport as _ModuleSupport85, _Scene as _Scene47, _Util as _Util51 } from "ag-charts-community";
var {
  AND: AND9,
  ARRAY: ARRAY8,
...
var { Label: Label6, Circle } = _Scene47;
var { Logger: Logger12 } = _Util51;
...
var { Group: Group10, Selection: Selection6, Text: Text10, getMarker } = _Scene48;
var { sanitizeHtml: sanitizeHtml6, Logger: Logger13 } = _Util52;
...
// packages/ag-charts-enterprise/src/series/map-marker/mapMarkerModule.ts
var { DEFAULT_LABEL_COLOUR: DEFAULT_LABEL_COLOUR3, DEFAULT_DIVERGING_SERIES_COLOUR_RANGE: DEFAULT_DIVERGING_SERIES_COLOUR_RANGE2, singleSeriesPaletteFactory: singleSeriesPaletteFactory2 } = _Theme19;
var MapMarkerModule = {
  type: "series",
  optionsKey: "series[]",
  packageType: "enterprise",
...
import { _ModuleSupport as _ModuleSupport89, _Scene as _Scene49, _Util as _Util53 } from "ag-charts-community";
...
var { COLOR_STRING: COLOR_STRING14, LINE_DASH: LINE_DASH11, OBJECT: OBJECT18, POSITIVE_NUMBER: POSITIVE_NUMBER18, RATIO: RATIO19, Validate: Validate46, SeriesProperties: SeriesProperties5, SeriesTooltip: SeriesTooltip9 } = _ModuleSupport88;
...
// packages/ag-charts-enterprise/src/series/map-shape-background/mapShapeBackgroundSeries.ts
var { createDatumId: createDatumId6, Series, SeriesNodePickMode: SeriesNodePickMode8, Validate: Validate47 } = _ModuleSupport89;
var { Selection: Selection7, Group: Group11, PointerEvents: PointerEvents3 } = _Scene49;
var { Logger: Logger14 } = _Util53;
...
// packages/ag-charts-enterprise/src/series/map-shape-background/mapShapeBackgroundModule.ts
var { DEFAULT_BACKGROUND_COLOUR, DEFAULT_HIERARCHY_FILLS } = _Theme20;
...
// packages/ag-charts-enterprise/src/series/map-shape/mapShapeSeries.ts
var { getMissCount: getMissCount4, createDatumId: createDatumId7, DataModelSeries: DataModelSeries5, SeriesNodePickMode: SeriesNodePickMode9, valueProperty: valueProperty10, Validate: Validate49 } = _ModuleSupport92;
var { ColorScale: ColorScale4 } = _Scale16;
var { Group: Group12, Selection: Selection8, Text: Text11, PointerEvents: PointerEvents4 } = _Scene51;
var { sanitizeHtml: sanitizeHtml7, Logger: Logger15 } = _Util55;
var fixedScale = _ModuleSupport92.MercatorScale.fixedScale();
...
import { _Scene as _Scene56 } from "ag-charts-community";

// packages/ag-charts-enterprise/src/series/radial-column/radialColumnSeriesBase.ts
import { _ModuleSupport as _ModuleSupport94, _Scale as _Scale17, _Scene as _Scene52, _Util as _Util56 } from "ag-charts-community";
var {
...
var { motion: motion3 } = _Scene52;
var { isNumber, normalizeAngle360: normalizeAngle3606, sanitizeHtml: sanitizeHtml8 } = _Util56;
var RadialColumnSeriesNodeEvent = class extends _ModuleSupport94.SeriesNodeEvent {
  constructor(type, nativeEvent, datum, series) {
    super(type, nativeEvent, datum, series);
...
var RadialColumnSeriesBase = class extends _ModuleSupport94.PolarSeries {
  constructor(moduleCtx, {
    animationResetFns
  }) {
    super({
...
import { _ModuleSupport as _ModuleSupport95, _Scene as _Scene53 } from "ag-charts-community";
var { Label: Label7 } = _Scene53;
var {
...
import { _Scene as _Scene55 } from "ag-charts-community";
...
// packages/ag-charts-enterprise/src/series/nightingale/nightingaleUtil.ts
var { SectorBox, motion: motion5 } = _Scene55;
...
// packages/ag-charts-enterprise/src/series/nightingale/nightingaleSeries.ts
var { Sector: Sector4, SectorBox: SectorBox2 } = _Scene56;
...
var NIGHTINGALE_SERIES_THEME = {
  series: {
    ...
    label: {
      enabled: false,
      fontSize: 12,
      fontFamily: _Theme22.DEFAULT_FONT_FAMILY,
      color: _Theme22.DEFAULT_LABEL_COLOUR
    }
  },
  axes: {
    [_Theme22.POLAR_AXIS_TYPE.ANGLE_CATEGORY]: {
      shape: _Theme22.POLAR_AXIS_SHAPE.CIRCLE,
      groupPaddingInner: 0,
      paddingInner: 0,
      label: {
        padding: 10
    ...
    [_Theme22.POLAR_AXIS_TYPE.RADIUS_NUMBER]: {
      shape: _Theme22.POLAR_AXIS_SHAPE.CIRCLE
    }
  }
};
...
var NightingaleModule = {
  ...
  defaultAxes: [
    {
      type: _Theme23.POLAR_AXIS_TYPE.ANGLE_CATEGORY
    },
    {
      type: _Theme23.POLAR_AXIS_TYPE.RADIUS_NUMBER
    }
  ],
  ...
  paletteFactory({ takeColors, userPalette }) {
    ...
    return {
      fill,
      stroke: userPalette !== "inbuilt" ? stroke : _Theme23.DEFAULT_POLAR_SERIES_STROKE
    };
  },
  stackable: true,
  groupable: true,
...
import { _Scene as _Scene57 } from "ag-charts-community";
var OhlcGroup = class extends CandlestickBaseGroup {
  constructor() {
    super();
    this.append([
      new _Scene57.Line({ tag: 0 /* Body */ }),
      new _Scene57.Line({ tag: 1 /* Open */ }),
      new _Scene57.Line({ tag: 2 /* Close */ })
    ]);
  }
  updateCoordinates() {
    const {
    ...
    const selection = _Scene57.Selection.select(this, _Scene57.Rect);
    const [body] = selection.selectByTag(0 /* Body */);
...
var { BaseProperties: BaseProperties14, Validate: Validate51, COLOR_STRING: COLOR_STRING17, FUNCTION: FUNCTION13, LINE_DASH: LINE_DASH14, OBJECT: OBJECT21, POSITIVE_NUMBER: POSITIVE_NUMBER21, RATIO: RATIO22 } = _ModuleSupport98;
...
// packages/ag-charts-enterprise/src/series/ohlc/ohlcSeries.ts
var { mergeDefaults: mergeDefaults7 } = _ModuleSupport99;
...
var OhlcModule = {
  ...
  defaultAxes: [
    ...
    {
      type: _Theme24.CARTESIAN_AXIS_TYPE.ORDINAL_TIME,
  ...
  themeTemplate: {
    animation: { enabled: false },
    axes: {
      [_Theme24.CARTESIAN_AXIS_TYPE.NUMBER]: {
        crosshair: {
          snap: false
        }
      },
      [_Theme24.CARTESIAN_AXIS_TYPE.ORDINAL_TIME]: {
        groupPaddingInner: 0,
        crosshair: {
          enabled: true
        }
...
import { _ModuleSupport as _ModuleSupport105, _Theme as _Theme26 } from "ag-charts-community";

// packages/ag-charts-enterprise/src/series/radar/radarThemes.ts
import { _ModuleSupport as _ModuleSupport100, _Theme as _Theme25 } from "ag-charts-community";
var BASE_RADAR_SERIES_THEME = {
  ...
  axes: {
    [_Theme25.POLAR_AXIS_TYPE.ANGLE_CATEGORY]: {
      label: {
        padding: 10
      }
    }
...
var RADAR_LINE_SERIES_THEME = _ModuleSupport100.mergeDefaults(
  {
    series: {
      strokeWidth: 2
    }
...
var RADAR_AREA_SERIES_THEME = _ModuleSupport100.mergeDefaults(
  {
    series: {
      fillOpacity: 0.8,
      strokeWidth: 2,
...
import { _ModuleSupport as _ModuleSupport102, _Scene as _Scene60, _Util as _Util58 } from "ag-charts-community";

// packages/ag-charts-enterprise/src/series/radar/radarSeriesProperties.ts
import { _ModuleSupport as _ModuleSupport101, _Scene as _Scene59 } from "ag-charts-community";
var { Label: Label8 } = _Scene59;
var {
  SeriesMarker,
...
var { BBox: BBox8, Group: Group13, Path: Path7, PointerEvents: PointerEvents5, Selection: Selection9, Text: Text12, getMarker: getMarker2 } = _Scene60;
var { extent: extent3, isNumberEqual: isNumberEqual8, sanitizeHtml: sanitizeHtml9, toFixed } = _Util58;
var RadarSeriesNodeEvent = class extends _ModuleSupport102.SeriesNodeEvent {
  constructor(type, nativeEvent, datum, series) {
    super(type, nativeEvent, datum, series);
    this.angleKey = series.properties.angleKey;
    this.radiusKey = series.properties.radiusKey;
...
var RadarSeries = class extends _ModuleSupport102.PolarSeries {
  constructor(moduleCtx) {
    super({
      moduleCtx,
      useLabelLayer: true,
  ...
  async createNodeData() {
    ...
    const nodeData = processedData.data.map((group) => {
      ...
      return {
        ...
        angleValue: angleDatum,
        radiusValue: radiusDatum,
        missing: !_Util58.isNumber(angle) || !_Util58.isNumber(radius)
      };
    });
    return { itemId: radiusKey, nodeData, labelData: nodeData };
  }
...
var { RATIO: RATIO24, COLOR_STRING: COLOR_STRING19, Validate: Validate53 } = _ModuleSupport103;
...
// packages/ag-charts-enterprise/src/series/radar-area/radarAreaSeries.ts
var { Group: Group14, Path: Path8, PointerEvents: PointerEvents6, Selection: Selection10 } = _Scene61;
var { ChartAxisDirection: ChartAxisDirection17 } = _ModuleSupport104;
var RadarAreaSeries = class extends RadarSeries {
  ...
  getAreaPoints() {
    ...
    const getPolarAxis = (direction) => {
      ...
      return axis instanceof _ModuleSupport104.PolarAxis ? axis : void 0;
    };
...
// packages/ag-charts-enterprise/src/series/radar-area/radarAreaModule.ts
var { markerPaletteFactory } = _ModuleSupport105;
var RadarAreaModule = {
  type: "series",
  optionsKey: "series[]",
  packageType: "enterprise",
  ...
  defaultAxes: [
    {
      type: _Theme26.POLAR_AXIS_TYPE.ANGLE_CATEGORY
    },
    {
      type: _Theme26.POLAR_AXIS_TYPE.RADIUS_NUMBER
    }
  ],
...
import { _ModuleSupport as _ModuleSupport107, _Scale as _Scale18, _Scene as _Scene64, _Util as _Util59 } from "ag-charts-community";

// packages/ag-charts-enterprise/src/series/radial-bar/radialBarSeriesProperties.ts
import { _ModuleSupport as _ModuleSupport106, _Scene as _Scene62 } from "ag-charts-community";
var { Label: Label9 } = _Scene62;
var {
...
import { _Scene as _Scene63 } from "ag-charts-community";
var { SectorBox: SectorBox3, motion: motion6 } = _Scene63;
...
var { Sector: Sector5, SectorBox: SectorBox4, motion: motion7 } = _Scene64;
var { angleBetween: angleBetween4, isNumber: isNumber2, sanitizeHtml: sanitizeHtml10 } = _Util59;
var RadialBarSeriesNodeEvent = class extends _ModuleSupport107.SeriesNodeEvent {
  constructor(type, nativeEvent, datum, series) {
    super(type, nativeEvent, datum, series);
    this.angleKey = series.properties.angleKey;
    this.radiusKey = series.properties.radiusKey;
...
var RadialBarSeries = class extends _ModuleSupport107.PolarSeries {
  constructor(moduleCtx) {
    super({
      moduleCtx,
      useLabelLayer: true,
  ...
  getTooltipHtml(nodeDatum) {
    ...
    if (!this.properties.isValid() || !(xAxis && yAxis && isNumber2(angleValue)) || !dataModel) {
      return _ModuleSupport107.EMPTY_TOOLTIP_CONTENT;
    }
    const angleString = xAxis.formatDatum(angleValue);
    const radiusString = yAxis.formatDatum(radiusValue);
...
var RADIAL_BAR_SERIES_THEME = {
  series: {
    ...
    label: {
      enabled: false,
      fontSize: 12,
      fontFamily: _Theme28.DEFAULT_FONT_FAMILY,
      color: _Theme28.DEFAULT_INVERTED_LABEL_COLOUR
    }
  },
  axes: {
    [_Theme28.POLAR_AXIS_TYPE.RADIUS_CATEGORY]: {
...
var RadialBarModule = {
  ...
  defaultAxes: [
    {
      type: _Theme29.POLAR_AXIS_TYPE.ANGLE_NUMBER
    },
    {
      type: _Theme29.POLAR_AXIS_TYPE.RADIUS_CATEGORY
    }
  ],
...
import { _ModuleSupport as _ModuleSupport109, _Scene as _Scene65 } from "ag-charts-community";
...
var { Validate: Validate55, RATIO: RATIO26 } = _ModuleSupport108;
...
// packages/ag-charts-enterprise/src/series/radial-column/radialColumnSeries.ts
var { ChartAxisDirection: ChartAxisDirection19, PolarAxis: PolarAxis4 } = _ModuleSupport109;
var { RadialColumnShape, getRadialColumnWidth } = _Scene65;
...
var RADIAL_COLUMN_SERIES_THEME = {
  series: {
    ...
    label: {
      ...
      color: _Theme30.DEFAULT_LABEL_COLOUR
    }
  },
  axes: {
    [_Theme30.POLAR_AXIS_TYPE.ANGLE_CATEGORY]: {
      shape: _Theme30.POLAR_AXIS_SHAPE.CIRCLE,
      groupPaddingInner: 0,
      paddingInner: 0,
      label: {
        padding: 10
    ...
    [_Theme30.POLAR_AXIS_TYPE.RADIUS_NUMBER]: {
      shape: _Theme30.POLAR_AXIS_SHAPE.CIRCLE,
...
var RadialColumnModule = {
  ...
  defaultAxes: [
    {
      type: _Theme31.POLAR_AXIS_TYPE.ANGLE_CATEGORY
    },
    {
      type: _Theme31.POLAR_AXIS_TYPE.RADIUS_NUMBER
    }
  ],
...
import { _ModuleSupport as _ModuleSupport112, _Theme as _Theme33 } from "ag-charts-community";

// packages/ag-charts-enterprise/src/series/range-area/rangeArea.ts
import { _ModuleSupport as _ModuleSupport111, _Scene as _Scene67, _Util as _Util60 } from "ag-charts-community";

// packages/ag-charts-enterprise/src/series/range-area/rangeAreaProperties.ts
import { _ModuleSupport as _ModuleSupport110, _Scene as _Scene66 } from "ag-charts-community";
var { DropShadow, Label: Label10 } = _Scene66;
var {
...
var { getMarker: getMarker3, PointerEvents: PointerEvents7 } = _Scene67;
var { sanitizeHtml: sanitizeHtml11, extent: extent4 } = _Util60;
var RangeAreaSeriesNodeEvent = class extends _ModuleSupport111.SeriesNodeEvent {
  constructor(type, nativeEvent, datum, series) {
    super(type, nativeEvent, datum, series);
    this.xKey = series.properties.xKey;
...
var RangeAreaSeries = class extends _ModuleSupport111.CartesianSeries {
  constructor(moduleCtx) {
    super({
      moduleCtx,
      hasMarkers: true,
  ...
  computeFocusBounds(opts) {
    ...
    if (hiBox && loBox) {
      return _Scene67.BBox.merge([hiBox, loBox]);
    }
    return void 0;
  }
};
...
var RANGE_AREA_SERIES_THEME = {
  ...
  axes: {
    [_Theme32.CARTESIAN_AXIS_TYPE.NUMBER]: {
...
// packages/ag-charts-enterprise/src/series/range-area/rangeAreaModule.ts
var { markerPaletteFactory: markerPaletteFactory2 } = _ModuleSupport112;
var RangeAreaModule = {
  type: "series",
  optionsKey: "series[]",
  packageType: "enterprise",
  ...
  defaultAxes: [
    {
      type: _Theme33.CARTESIAN_AXIS_TYPE.NUMBER,
      position: _Theme33.POSITION.LEFT
    },
    {
      type: _Theme33.CARTESIAN_AXIS_TYPE.CATEGORY,
      position: _Theme33.POSITION.BOTTOM
    }
  ],
...
import { _ModuleSupport as _ModuleSupport114, _Scale as _Scale19, _Scene as _Scene69, _Util as _Util61 } from "ag-charts-community";

// packages/ag-charts-enterprise/src/series/range-bar/rangeBarProperties.ts
import { _ModuleSupport as _ModuleSupport113, _Scene as _Scene68 } from "ag-charts-community";
var { DropShadow: DropShadow2, Label: Label11 } = _Scene68;
var {
...
var { Rect: Rect4, PointerEvents: PointerEvents8, motion: motion8 } = _Scene69;
var { sanitizeHtml: sanitizeHtml12, isNumber: isNumber3, extent: extent5 } = _Util61;
var { ContinuousScale: ContinuousScale3 } = _Scale19;
var RangeBarSeriesNodeEvent = class extends _ModuleSupport114.SeriesNodeEvent {
  constructor(type, nativeEvent, datum, series) {
    super(type, nativeEvent, datum, series);
    this.xKey = series.properties.xKey;
    this.yLowKey = series.properties.yLowKey;
...
var RangeBarSeries = class extends _ModuleSupport114.AbstractBarSeries {
  constructor(moduleCtx) {
    super({
      moduleCtx,
  ...
  async createNodeData() {
    ...
    processedData?.data.forEach(({ keys, datum, values }, dataIndex) => {
      values.forEach((value, valueIndex) => {
        ...
        if (!_Util61.isNumber(rawHighValue) || !_Util61.isNumber(rawLowValue)) {
          return;
        }
...
var RANGE_BAR_SERIES_THEME = {
  series: {
    ...
    label: {
      ...
      color: _Theme34.DEFAULT_INSIDE_SERIES_LABEL_COLOUR,
      placement: "inside"
    }
  },
  axes: {
...
var { BBox: BBox9, Path: Path9, ScenePathChangeDetection: ScenePathChangeDetection3 } = _Scene70;
...
import {
  _ModuleSupport as _ModuleSupport115,
  _Scene as _Scene71
} from "ag-charts-community";
var {
...
// packages/ag-charts-enterprise/src/series/sankey/sankeySeries.ts
var { SeriesNodePickMode: SeriesNodePickMode13, createDatumId: createDatumId9, EMPTY_TOOLTIP_CONTENT: EMPTY_TOOLTIP_CONTENT2 } = _ModuleSupport116;
var { sanitizeHtml: sanitizeHtml13 } = _Util63;
var { Rect: Rect5, Text: Text13, BBox: BBox10 } = _Scene72;
...
// packages/ag-charts-enterprise/src/series/sankey/sankeyModule.ts
var { DEFAULT_FONT_FAMILY: DEFAULT_FONT_FAMILY3, DEFAULT_LABEL_COLOUR: DEFAULT_LABEL_COLOUR4 } = _Theme36;
var SankeyModule = {
  type: "series",
  optionsKey: "series[]",
  packageType: "enterprise",
...
import {
  _ModuleSupport as _ModuleSupport118,
  _Scene as _Scene73,
  _Util as _Util64
} from "ag-charts-community";
...
// packages/ag-charts-enterprise/src/series/sunburst/sunburstSeries.ts
var { fromToMotion: fromToMotion3 } = _ModuleSupport118;
var { Sector: Sector6, Group: Group15, Selection: Selection11, Text: Text14 } = _Scene73;
var { sanitizeHtml: sanitizeHtml14 } = _Util64;
...
var SunburstSeries = class extends _ModuleSupport118.HierarchySeries {
  constructor() {
    super(...arguments);
  ...
  async updateNodes() {
    ...
    const labelMeta = Array.from(this.rootNode, (node, index) => {
      ...
      const sizeFittingHeight = (labelHeight2) => {
        ...
        } else if (_Util64.normalizeAngle360(deltaInnerAngle) < maxPerpendicularAngle) {
  ...
  getTooltipHtml(node) {
    ...
    if (datum == null || depth == null) {
      return _ModuleSupport118.EMPTY_TOOLTIP_CONTENT;
    }
  ...
  computeFocusBounds(nodeDatum) {
    ...
    for (const { node, datum } of this.groupSelection) {
      if (datum === nodeDatum) {
        match = _Scene73.Selection.selectByClass(node, _Scene73.Sector)[0];
      }
    }
    return match;
  }
...
// packages/ag-charts-enterprise/src/series/sunburst/sunburstModule.ts
var { DEFAULT_INSIDE_SERIES_LABEL_COLOUR } = _Theme37;
var SunburstModule = {
  type: "series",
  optionsKey: "series[]",
  packageType: "enterprise",
  ...
  paletteFactory: ({ takeColors, colorsCount, themeTemplateParameters }) => {
    const { fills, strokes } = takeColors(colorsCount);
    const defaultColorRange = themeTemplateParameters.get(_Theme37.DEFAULT_DIVERGING_SERIES_COLOUR_RANGE);
...
import {
  _ModuleSupport as _ModuleSupport120,
  _Scene as _Scene75,
  _Util as _Util65
} from "ag-charts-community";

// packages/ag-charts-enterprise/src/series/treemap/treemapSeriesProperties.ts
import { _ModuleSupport as _ModuleSupport119, _Scene as _Scene74 } from "ag-charts-community";
var { Label: Label13 } = _Scene74;
var {
...
// packages/ag-charts-enterprise/src/series/treemap/treemapSeries.ts
var { Rect: Rect6, Group: Group16, BBox: BBox11, Selection: Selection12, Text: Text15 } = _Scene75;
var { Color: Color5, Logger: Logger16, clamp: clamp3, isEqual: isEqual2, sanitizeHtml: sanitizeHtml15 } = _Util65;
...
var DistantGroup = class extends _Scene75.Group {
  distanceSquared(x, y) {
    return this.computeBBox().distanceSquared(x, y);
  }
};
var TreemapSeries = class extends _ModuleSupport120.HierarchySeries {
  constructor() {
    super(...arguments);
  ...
  getTooltipHtml(node) {
    ...
    if (datum == null || depth == null || !interactive) {
      return _ModuleSupport120.EMPTY_TOOLTIP_CONTENT;
    }
    const title = labelKey != null ? datum[labelKey] : void 0;
...
import { _ModuleSupport as _ModuleSupport122, _Scale as _Scale20, _Scene as _Scene77, _Util as _Util66 } from "ag-charts-community";

// packages/ag-charts-enterprise/src/series/waterfall/waterfallSeriesProperties.ts
import { _ModuleSupport as _ModuleSupport121, _Scene as _Scene76 } from "ag-charts-community";
var { DropShadow: DropShadow3, Label: Label14 } = _Scene76;
var {
...
var { Rect: Rect7, motion: motion9 } = _Scene77;
var { sanitizeHtml: sanitizeHtml16, isContinuous } = _Util66;
var { ContinuousScale: ContinuousScale4 } = _Scale20;
var WaterfallSeries = class extends _ModuleSupport122.AbstractBarSeries {
  constructor(moduleCtx) {
    super({
      moduleCtx,
  ...
  async processData(dataController) {
    ...
    const { processedData } = await this.requestDataModel(dataController, dataWithTotals, {
      props: [
        ...
        ...isContinuousX ? [_ModuleSupport122.SMALLEST_KEY_INTERVAL, _ModuleSupport122.LARGEST_KEY_INTERVAL] : [],
        ...extraProps
      ]
    });
    this.smallestDataInterval = processedData.reduced?.smallestKeyInterval;
  ...
  getSeriesDomain(direction) {
    ...
    if (direction === this.getCategoryDirection()) {
      ...
      const keysExtent = _ModuleSupport122.extent(keys) ?? [NaN, NaN];
      const categoryAxis = this.getCategoryAxis();
  ...
  animateConnectorLinesHorizontal(lineNode, pointData) {
    ...
    this.ctx.animationManager.animate({
      ...
      from: startX,
      to: endX,
      ease: _ModuleSupport122.Motion.easeOut,
      collapsable: false,
      onUpdate(pointX) {
        linePath.clear(true);
  ...
  updateLineNode(lineNode) {
    ...
    lineNode.setProperties({
      ...
      lineDashOffset,
      lineJoin: "round",
      pointerEvents: _Scene77.PointerEvents.None
    });
  }
  isLabelEnabled() {
...
var itemTheme = {
  ...
  label: {
    enabled: false,
    fontStyle: void 0,
    fontWeight: _Theme39.FONT_WEIGHT.NORMAL,
    fontSize: 12,
    fontFamily: _Theme39.DEFAULT_FONT_FAMILY,
    color: _Theme39.DEFAULT_LABEL_COLOUR,
    formatter: void 0,
    placement: "end"
  }
};
var WATERFALL_SERIES_THEME = {
  series: {
    ...
    line: {
      stroke: _Theme39.PALETTE_NEUTRAL_STROKE,
      strokeOpacity: 1,
      lineDash: [0],
      lineDashOffset: 0,
      strokeWidth: 2
...
var WaterfallModule = {
  ...
  defaultAxes: [
    {
      type: _Theme40.CARTESIAN_AXIS_TYPE.CATEGORY,
      position: _Theme40.POSITION.BOTTOM
    },
    {
      type: _Theme40.CARTESIAN_AXIS_TYPE.NUMBER,
      position: _Theme40.POSITION.LEFT
    }
  ],
...
function setupEnterpriseModules() {
  _ModuleSupport123.moduleRegistry.register(
  ...
  _ModuleSupport123.enterpriseModule.isEnterprise = true;
  _ModuleSupport123.enterpriseModule.licenseManager = (options) => new LicenseManager(
    options.container?.ownerDocument ?? (typeof document === "undefined" ? void 0 : document)
  );
  _ModuleSupport123.enterpriseModule.injectWatermark = injectWatermark;
}
