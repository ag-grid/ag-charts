...
// packages/ag-charts-enterprise/src/axes/angle-category/angleCategoryAxis.ts
var { RATIO: RATIO2, OR, POSITIVE_NUMBER: POSITIVE_NUMBER2, NAN, Validate: Validate3 } = import_ag_charts_community5._ModuleSupport;
...
// packages/ag-charts-enterprise/src/axes/angle-number/angleNumberAxis.ts
var { AND: AND3, Default, GREATER_THAN: GREATER_THAN2, LESS_THAN, OR: OR2, POSITIVE_NUMBER: POSITIVE_NUMBER3, NAN: NAN2, NUMBER_OR_NAN, MIN_SPACING, Validate: Validate4 } = import_ag_charts_community7._ModuleSupport;
...
var { dateToNumber, Validate: Validate5, Default: Default2, MAX_SPACING, MIN_SPACING: MIN_SPACING2 } = import_ag_charts_community8._ModuleSupport;
...
var { ChartAxisDirection: ChartAxisDirection4, Validate: Validate6, DEGREE, validateCrossLineValues: validateCrossLineValues2 } = import_ag_charts_community11._ModuleSupport;
...
// packages/ag-charts-enterprise/src/axes/radius-category/radiusCategoryAxis.ts
var { RATIO: RATIO3, ProxyPropertyOnWrite, Validate: Validate8 } = import_ag_charts_community13._ModuleSupport;
...
var { AND: AND4, Default: Default4, GREATER_THAN: GREATER_THAN3, LESS_THAN: LESS_THAN2, NUMBER_OR_NAN: NUMBER_OR_NAN2, Validate: Validate9 } = import_ag_charts_community14._ModuleSupport;
...
var { BOOLEAN: BOOLEAN3, POSITIVE_NUMBER: POSITIVE_NUMBER4, ObserveChanges, Validate: Validate10 } = import_ag_charts_community15._ModuleSupport;
...
var { BOOLEAN: BOOLEAN4, COLOR_STRING: COLOR_STRING2, DATE, LINE_DASH: LINE_DASH2, NUMBER: NUMBER3, RATIO: RATIO4, STRING: STRING2, OBJECT, OR: OR3, UNION: UNION3, BaseProperties, Validate: Validate11 } = import_ag_charts_community16._ModuleSupport;
...
// packages/ag-charts-enterprise/src/features/annotations/annotations.ts
var { BOOLEAN: BOOLEAN5, OBJECT_ARRAY, InteractionState, PropertiesArray, Validate: Validate12 } = import_ag_charts_community21._ModuleSupport;
var Annotations = class extends import_ag_charts_community21._ModuleSupport.BaseModuleInstance {
  ...
  validateDatumPointDirection(domain, scale, value) {
    if (import_ag_charts_community21._Scene.ContinuousScale.is(scale)) {
...
var { Image } = import_ag_charts_community23._Scene;
var {
...
// packages/ag-charts-enterprise/src/features/background/background.ts
var { ActionOnSet, OBJECT: OBJECT2, Validate: Validate14 } = import_ag_charts_community24._ModuleSupport;
var Background = class extends import_ag_charts_community24._ModuleSupport.Background {
  constructor(ctx) {
    super(ctx);
    this.ctx = ctx;
...
// packages/ag-charts-enterprise/src/features/context-menu/contextMenu.ts
var { BOOLEAN: BOOLEAN6, Validate: Validate15, createElement: createElement2, getDocument, getWindow, injectStyle } = import_ag_charts_community25._ModuleSupport;
...
var { ActionOnSet: ActionOnSet2, BaseProperties: BaseProperties3, BOOLEAN: BOOLEAN7, FUNCTION, NUMBER: NUMBER5, STRING: STRING3, Validate: Validate16, createElement: createElement3, injectStyle: injectStyle2 } = import_ag_charts_community27._ModuleSupport;
var { setAttribute } = import_ag_charts_community27._Util;
var { BBox } = import_ag_charts_community27._Scene;
...
var CrosshairLabel = class extends BaseProperties3 {
  ...
  computeBBox() {
    const { element } = this;
    return new import_ag_charts_community27._Scene.BBox(element.clientLeft, element.clientTop, element.clientWidth, element.clientHeight);
  }
...
// packages/ag-charts-enterprise/src/features/crosshair/crosshair.ts
var { Group: Group3, Line: Line2, BBox: BBox2 } = import_ag_charts_community28._Scene;
var { createId: createId2 } = import_ag_charts_community28._Util;
var { POSITIVE_NUMBER: POSITIVE_NUMBER6, RATIO: RATIO6, BOOLEAN: BOOLEAN8, COLOR_STRING: COLOR_STRING3, LINE_DASH: LINE_DASH3, OBJECT: OBJECT3, Validate: Validate17, Layers: Layers3, getDocument: getDocument2 } = import_ag_charts_community28._ModuleSupport;
var Crosshair = class extends import_ag_charts_community28._ModuleSupport.BaseModuleInstance {
  constructor(ctx) {
    ...
    this.lineGroupSelection = import_ag_charts_community28._Scene.Selection.select(this.lineGroup, Line2, false);
...
var { BOOLEAN: BOOLEAN9, FUNCTION: FUNCTION2, ActionOnSet: ActionOnSet3, Validate: Validate18 } = import_ag_charts_community30._ModuleSupport;
...
var { partialAssign, mergeDefaults } = import_ag_charts_community31._ModuleSupport;
...
var ErrorBarGroup = class extends import_ag_charts_community31._Scene.Group {
  ...
  nearestSquared(x, y) {
    const { nearest, distanceSquared } = import_ag_charts_community31._Scene.nearestSquaredInContainer(x, y, this);
...
var { Validate: Validate20, BOOLEAN: BOOLEAN11, POSITIVE_NUMBER: POSITIVE_NUMBER8, Layers: Layers4, ActionOnSet: ActionOnSet4, CategoryAxis, GroupedCategoryAxis } = import_ag_charts_community36._ModuleSupport;
var { toRadians: toRadians4, Padding, Logger } = import_ag_charts_community36._Util;
...
var _Navigator = class _Navigator extends import_ag_charts_community37._ModuleSupport.Navigator {
  constructor(ctx) {
    super(ctx);
...
var NavigatorModule = {
  ...
  themeTemplate: __spreadProps(__spreadValues({}, import_ag_charts_community38._ModuleSupport.NavigatorModule.themeTemplate), {
    navigator: __spreadProps(__spreadValues({}, (_a = import_ag_charts_community38._ModuleSupport.NavigatorModule.themeTemplate) == null ? void 0 : _a.navigator), {
      miniChart: {
        enabled: false,
        label: {
...
var { Logger: Logger2 } = import_ag_charts_community39._Util;
...
var { COLOR_STRING: COLOR_STRING5, RATIO: RATIO8, Validate: Validate22 } = import_ag_charts_community40._ModuleSupport;
...
var { clamp, isEqual, round } = import_ag_charts_community41._ModuleSupport;
...
var ZoomAxisDragger = class {
  update(event, direction, anchor, bbox, zoom, axisZoom) {
    ...
    (_a2 = this.oldZoom) != null ? _a2 : this.oldZoom = definedZoomState(
      direction === import_ag_charts_community42._ModuleSupport.ChartAxisDirection.X ? __spreadProps(__spreadValues({}, zoom), { x: axisZoom }) : __spreadProps(__spreadValues({}, zoom), { y: axisZoom })
    );
...
var { AND: AND5, DATE: DATE2, NUMBER: NUMBER7, OR: OR4, ActionOnSet: ActionOnSet5, isFiniteNumber: isFiniteNumber2, isValidDate, Validate: Validate23 } = import_ag_charts_community44._ModuleSupport;
var ZoomRange = class {
...
var { ToolbarManager } = import_ag_charts_community47._ModuleSupport;
...
var Zoom = class extends import_ag_charts_community48._ModuleSupport.BaseModuleInstance {
  constructor(ctx) {
    ...
    const { Default: Default6, ZoomDrag, Animation: Animation2 } = import_ag_charts_community48._ModuleSupport.InteractionState;
...
var { BBox: BBox5, Group: Group5, Rect, LinearGradientFill, Triangle } = import_ag_charts_community49._Scene;
...
var { Group: Group6, Rect: Rect2, Line: Line3, BBox: BBox6, Selection: Selection2 } = import_ag_charts_community52._Scene;
...
var { motion } = import_ag_charts_community54._Scene;
var { ContinuousScale } = import_ag_charts_community54._Scale;
...
var { fromToMotion } = import_ag_charts_community58._Scene.motion;
var { sanitizeHtml } = import_ag_charts_community58._Util;
var STYLING_KEYS = [
  "fill",
  "fillOpacity",
  "stroke",
...
var { SceneChangeDetection, BBox: BBox7, RedrawType } = import_ag_charts_community61._Scene;
...
var CandlestickGroup = class extends CandlestickBaseGroup {
  constructor() {
    super();
    this.append([
      new import_ag_charts_community61._Scene.Rect({ tag: 0 /* Body */ }),
      new import_ag_charts_community61._Scene.Line({ tag: 1 /* LowWick */ }),
      new import_ag_charts_community61._Scene.Line({ tag: 2 /* HighWick */ })
    ]);
  }
  updateCoordinates() {
...
var { computeBarFocusBounds: computeBarFocusBounds3, NODE_UPDATE_STATE_TO_PHASE_MAPPING } = import_ag_charts_community62._ModuleSupport;
...
// packages/ag-charts-enterprise/src/series/candlestick/candlestickSeriesBase.ts
var { motion: motion2 } = import_ag_charts_community63._Scene;
var {
  extent: extent2,
...
var { sanitizeHtml: sanitizeHtml2, Logger: Logger4 } = import_ag_charts_community63._Util;
var { ContinuousScale: ContinuousScale2 } = import_ag_charts_community63._Scale;
...
// packages/ag-charts-enterprise/src/series/candlestick/candlestickSeries.ts
var { extractDecoratedProperties: extractDecoratedProperties2, mergeDefaults: mergeDefaults6 } = import_ag_charts_community65._ModuleSupport;
...
var { Validate: Validate30, NUMBER: NUMBER9, TEXT_WRAP, OVERFLOW_STRATEGY } = import_ag_charts_community68._ModuleSupport;
var { Logger: Logger5 } = import_ag_charts_community68._Util;
var { Text: Text5, Label } = import_ag_charts_community68._Scene;
...
var { Rect: Rect3, PointerEvents } = import_ag_charts_community70._Scene;
var { ColorScale } = import_ag_charts_community70._Scale;
var { sanitizeHtml: sanitizeHtml3, Color, Logger: Logger6 } = import_ag_charts_community70._Util;
...
var { LonLatBBox } = import_ag_charts_community73._ModuleSupport;
...
// packages/ag-charts-enterprise/src/series/map-util/geoGeometry.ts
var { Path: Path5, ExtendedPath2D, BBox: BBox8, ScenePathChangeDetection } = import_ag_charts_community74._Scene;
...
var { COLOR_STRING: COLOR_STRING10, LINE_DASH: LINE_DASH8, OBJECT: OBJECT9, POSITIVE_NUMBER: POSITIVE_NUMBER14, RATIO: RATIO15, Validate: Validate32, SeriesProperties, SeriesTooltip: SeriesTooltip5 } = import_ag_charts_community76._ModuleSupport;
...
// packages/ag-charts-enterprise/src/series/map-line-background/mapLineBackgroundSeries.ts
var { createDatumId: createDatumId2, DataModelSeries, SeriesNodePickMode: SeriesNodePickMode4, Validate: Validate33 } = import_ag_charts_community77._ModuleSupport;
var { Group: Group7, Selection: Selection3, PointerEvents: PointerEvents2 } = import_ag_charts_community77._Scene;
...
// packages/ag-charts-enterprise/src/series/map-line-background/mapLineBackgroundModule.ts
var { EXTENDS_SERIES_DEFAULTS, DEFAULT_HIERARCHY_STROKES } = import_ag_charts_community78._Theme;
...
var { Label: Label2 } = import_ag_charts_community79._Scene;
...
// packages/ag-charts-enterprise/src/series/map-line/mapLineSeries.ts
var { getMissCount: getMissCount2, createDatumId: createDatumId3, DataModelSeries: DataModelSeries2, SeriesNodePickMode: SeriesNodePickMode5, valueProperty: valueProperty6, Validate: Validate35 } = import_ag_charts_community80._ModuleSupport;
var { ColorScale: ColorScale2, LinearScale: LinearScale3 } = import_ag_charts_community80._Scale;
...
var { Label: Label3, Circle } = import_ag_charts_community82._Scene;
...
var { Group: Group8, Selection: Selection5, Text: Text7, getMarker } = import_ag_charts_community83._Scene;
...
var MapMarkerSeries = class extends DataModelSeries3 {
  ...
  getFormattedMarkerStyle(markerDatum) {
    ...
    const { size = markerDatum.point.size } = style != null ? style : { size: void 0 };
    return { size };
  }
  computeFocusBounds(opts) {
...
// packages/ag-charts-enterprise/src/series/map-shape-background/mapShapeBackgroundSeries.ts
var { createDatumId: createDatumId5, Series, SeriesNodePickMode: SeriesNodePickMode7, Validate: Validate39 } = import_ag_charts_community86._ModuleSupport;
...
// packages/ag-charts-enterprise/src/series/map-shape-background/mapShapeBackgroundModule.ts
var { DEFAULT_BACKGROUND_COLOUR, DEFAULT_HIERARCHY_FILLS } = import_ag_charts_community87._Theme;
...
var { isNumber, normalizeAngle360: normalizeAngle3605, sanitizeHtml: sanitizeHtml7 } = import_ag_charts_community91._Util;
...
// packages/ag-charts-enterprise/src/series/nightingale/nightingaleUtil.ts
var { SectorBox, motion: motion5 } = import_ag_charts_community95._Scene;
...
// packages/ag-charts-enterprise/src/series/nightingale/nightingaleSeries.ts
var { Sector: Sector3, SectorBox: SectorBox2 } = import_ag_charts_community96._Scene;
...
var OhlcGroup = class extends CandlestickBaseGroup {
  constructor() {
    super();
    this.append([
      new import_ag_charts_community99._Scene.Line({ tag: 0 /* Body */ }),
      new import_ag_charts_community99._Scene.Line({ tag: 1 /* Open */ }),
      new import_ag_charts_community99._Scene.Line({ tag: 2 /* Close */ })
    ]);
  }
  updateCoordinates() {
    const {
...
var { BBox: BBox9, Group: Group11, Path: Path6, PointerEvents: PointerEvents5, Selection: Selection8, Text: Text9, getMarker: getMarker2 } = import_ag_charts_community106._Scene;
var { extent: extent3, isNumberEqual: isNumberEqual8, sanitizeHtml: sanitizeHtml8, toFixed } = import_ag_charts_community106._Util;
...
// packages/ag-charts-enterprise/src/series/radar-area/radarAreaModule.ts
var { markerPaletteFactory } = import_ag_charts_community109._ModuleSupport;
var RadarAreaModule = {
  type: "series",
  optionsKey: "series[]",
  packageType: "enterprise",
...
var { angleBetween: angleBetween3, isNumber: isNumber2, sanitizeHtml: sanitizeHtml9 } = import_ag_charts_community113._Util;
...
var { RadialColumnShape, getRadialColumnWidth } = import_ag_charts_community117._Scene;
...
var { DropShadow, Label: Label7 } = import_ag_charts_community120._Scene;
var {
...
// packages/ag-charts-enterprise/src/series/range-area/rangeAreaModule.ts
var { markerPaletteFactory: markerPaletteFactory2 } = import_ag_charts_community123._ModuleSupport;
var RangeAreaModule = {
  type: "series",
  optionsKey: "series[]",
  packageType: "enterprise",
...
var { DropShadow: DropShadow2, Label: Label8 } = import_ag_charts_community124._Scene;
var {
...
var _SunburstSeries = class _SunburstSeries extends import_ag_charts_community129._ModuleSupport.HierarchySeries {
  constructor() {
    super(...arguments);
...
// packages/ag-charts-enterprise/src/series/sunburst/sunburstModule.ts
var { EXTENDS_SERIES_DEFAULTS: EXTENDS_SERIES_DEFAULTS5, DEFAULT_INSIDE_SERIES_LABEL_COLOUR } = import_ag_charts_community130._Theme;
var SunburstModule = {
  type: "series",
  optionsKey: "series[]",
  packageType: "enterprise",
...
var { Color: Color2, Logger: Logger13, isEqual: isEqual2, sanitizeHtml: sanitizeHtml13 } = import_ag_charts_community132._Util;
...
var _TreemapSeries = class _TreemapSeries extends import_ag_charts_community132._ModuleSupport.HierarchySeries {
  constructor() {
    super(...arguments);
...
var { sanitizeHtml: sanitizeHtml14, isContinuous } = import_ag_charts_community135._Util;
