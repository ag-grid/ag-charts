...
__export(main_exports, {
  AgCharts: () => import_ag_charts_community95.AgCharts,
  time: () => import_ag_charts_community95.time
});
...
var _PolarCrossLine = class _PolarCrossLine {
  ...
  setSectorNodeProps(node) {
    var _a, _b, _c;
    node.fill = this.fill;
    node.fillOpacity = (_a = this.fillOpacity) != null ? _a : 1;
...
var _AngleCrossLine = class _AngleCrossLine extends PolarCrossLine {
  ...
  updateLineNode(visible) {
    ...
    line.strokeOpacity = (_a = this.strokeOpacity) != null ? _a : 1;
  ...
  updatePolygonNode(visible) {
    ...
    let ticks;
    if (!visible || type !== "range" || shape !== "polygon" || !scale || !range2 || !(ticks = (_a = scale.ticks) == null ? void 0 : _a.call(scale))) {
  ...
  updateSectorNode(visible) {
    ...
    const step = (_a = scale.step) != null ? _a : 0;
  ...
  updateLabelNode(visible) {
    ...
    if (type === "line") {
      ...
      let distance;
      const ticks = (_b = (_a = scale.ticks) == null ? void 0 : _a.call(scale)) != null ? _b : [];
...
var AngleAxis = class extends import_ag_charts_community4._ModuleSupport.PolarAxis {
  ...
  getAxisLinePoints() {
    ...
    if (shape === "circle") {
      ...
      const angles = (((_a = scale.ticks) == null ? void 0 : _a.call(scale)) || []).map((value) => scale.convert(value));
      if (angles.length > 2) {
  ...
  createLabelNodeData(ticks, options, seriesRect) {
    ...
    const labelData = ticks.map((datum, index) => {
      ...
      if (label.formatter) {
        ...
        text = (_a = callbackCache.call(label.formatter, { value, index })) != null ? _a : "";
      }
      tempText2.text = text;
      tempText2.x = x;
      tempText2.y = y;
  ...
  getLabelRotation(tickAngle) {
    var _a;
    let rotation = toRadians((_a = this.label.rotation) != null ? _a : 0);
...
var AngleCategoryAxis = class extends AngleAxis {
  ...
  generateAngleTicks() {
    ...
    const ticks = (_b = (_a = tick.values) != null ? _a : scale.ticks()) != null ? _b : [];
...
var { isNumberEqual: isNumberEqual4, range } = import_ag_charts_community6._Util;
...
var AngleNumberAxis = class extends AngleAxis {
  ...
  generateAngleTicks() {
    ...
    const ticks = (_a = tick.values) != null ? _a : scale.ticks();
    return ticks.map((value) => {
      return { value, visible: true };
    });
  }
...
var RADIUS_AXIS_THEME = {
  __extends__: import_ag_charts_community8._Theme.EXTENDS_AXES_DEFAULTS,
  line: {
    enabled: false,
    __extends__: import_ag_charts_community8._Theme.EXTENDS_AXES_LINE_DEFAULTS
  },
  tick: {
    enabled: false,
    __extends__: import_ag_charts_community8._Theme.EXTENDS_AXES_TICK_DEFAULTS
  }
};
...
var { ChartAxisDirection: ChartAxisDirection4, Validate: Validate5, DEGREE, validateCrossLineValues: validateCrossLineValues2 } = import_ag_charts_community9._ModuleSupport;
...
var _RadiusCrossLine = class _RadiusCrossLine extends PolarCrossLine {
  ...
  updateRadii() {
    ...
    if (type === "line") {
      ...
      const bandwidth = Math.abs((_a = scale == null ? void 0 : scale.bandwidth) != null ? _a : 0);
  ...
  updateLabelNode(visible) {
    ...
    const angle = normalizeAngle3603(toRadians2(((_a = label.positionAngle) != null ? _a : 0) - 90));
  ...
  getPadding() {
    ...
    if (!scale)
      return 0;
    const bandwidth = Math.abs((_a = scale.bandwidth) != null ? _a : 0);
...
// packages/ag-charts-enterprise/src/axes/radius/radiusAxis.ts
var { assignJsonApplyConstructedArray: assignJsonApplyConstructedArray2, ChartAxisDirection: ChartAxisDirection5, Default: Default2, Layers: Layers2, DEGREE: DEGREE2, MIN_SPACING: MIN_SPACING2, BOOLEAN: BOOLEAN2, Validate: Validate6 } = import_ag_charts_community10._ModuleSupport;
...
var RadiusAxisTick = class extends import_ag_charts_community10._ModuleSupport.AxisTick {
  constructor() {
    super(...arguments);
    this.maxSpacing = NaN;
  }
...
var RadiusAxis = class extends import_ag_charts_community10._ModuleSupport.PolarAxis {
  ...
  updateSelections(lineData, data, params) {
    ...
    const [startAngle, endAngle] = (_a = this.gridRange) != null ? _a : [0, 2 * Math.PI];
  ...
  updateTitle() {
    ...
    const { formatter = identityFormatter } = (_a = this.title) != null ? _a : {};
    if (!title) {
...
// packages/ag-charts-enterprise/src/axes/radius-category/radiusCategoryAxis.ts
var { RATIO: RATIO3, ProxyPropertyOnWrite, Validate: Validate7 } = import_ag_charts_community11._ModuleSupport;
...
var { AND: AND4, Default: Default3, GREATER_THAN: GREATER_THAN3, LESS_THAN: LESS_THAN2, NUMBER_OR_NAN: NUMBER_OR_NAN2, Validate: Validate8 } = import_ag_charts_community12._ModuleSupport;
...
var RadiusNumberAxis = class extends RadiusAxis {
  ...
  prepareTickData(data) {
    var _a;
    const { scale } = this;
    const domainTop = (_a = scale.getDomain) == null ? void 0 : _a.call(scale)[1];
...
var { BOOLEAN: BOOLEAN3, POSITIVE_NUMBER: POSITIVE_NUMBER2, ActionOnSet, Validate: Validate9 } = import_ag_charts_community13._ModuleSupport;
...
var { ActionOnSet: ActionOnSet2 } = import_ag_charts_community14._ModuleSupport;
var Background = class extends import_ag_charts_community14._ModuleSupport.Background {
  constructor(ctx) {
    super(ctx);
  ...
  onImageLoad() {
    this.updateService.update(import_ag_charts_community14._ModuleSupport.ChartUpdateType.SCENE_RENDER);
  }
};
__decorateClass([
  ActionOnSet2({
...
var { Image } = import_ag_charts_community15._Scene;
...
// packages/ag-charts-enterprise/src/features/context-menu/contextMenu.ts
var { BOOLEAN: BOOLEAN4, Validate: Validate10 } = import_ag_charts_community16._ModuleSupport;
var TOOLTIP_ID = "context-menu";
var PAUSE_TYPE = "context-menu";
var _ContextMenu = class _ContextMenu extends import_ag_charts_community16._ModuleSupport.BaseModuleInstance {
  constructor(ctx) {
    super();
    this.ctx = ctx;
    this.enabled = true;
    ...
    this.destroyFns.push(() => {
      var _a;
      return (_a = this.element.parentNode) == null ? void 0 : _a.removeChild(this.element);
    });
    ...
    _ContextMenu.registerDefaultAction({
      id: "download",
      label: "Download",
      action: () => {
  ...
  onContextMenu(event) {
    ...
    this.x = event.pageX;
    this.y = event.pageY;
    this.groups.default = [..._ContextMenu.defaultActions];
    this.pickedNode = this.highlightManager.getActivePicked();
    if (this.pickedNode) {
      this.groups.node = [..._ContextMenu.nodeActions];
    }
  ...
  show() {
    ...
    this.coverElement.style.left = `${(_a = this.canvasElement.parentElement) == null ? void 0 : _a.offsetLeft}px`;
    this.coverElement.style.top = `${(_b = this.canvasElement.parentElement) == null ? void 0 : _b.offsetTop}px`;
  ...
  createActionElement({ id, label, action }) {
    if (id && _ContextMenu.disabledActions.has(id)) {
  ...
  createButtonElement(label, callback) {
    ...
    el.onclick = () => {
      ...
      const params = {
        ...
        datum: (_a = this.pickedNode) == null ? void 0 : _a.datum,
  ...
  destroy() {
    var _a, _b;
    super.destroy();
    (_a = this.intersectionObserver) == null ? void 0 : _a.unobserve(this.canvasElement);
    (_b = this.mutationObserver) == null ? void 0 : _b.disconnect();
  }
};
// Global shared state
_ContextMenu.contextMenuDocuments = [];
_ContextMenu.defaultActions = [];
_ContextMenu.nodeActions = [];
_ContextMenu.disabledActions = /* @__PURE__ */ new Set();
__decorateClass([
  Validate10(BOOLEAN4)
...
var { ActionOnSet: ActionOnSet3, Validate: Validate11, NUMBER: NUMBER3, BOOLEAN: BOOLEAN5, STRING: STRING2, FUNCTION } = import_ag_charts_community17._ModuleSupport;
var { BBox } = import_ag_charts_community17._Scene;
...
`;
var _CrosshairLabel = class _CrosshairLabel {
  ...
  computeBBox() {
    const { element } = this;
    return new import_ag_charts_community17._Scene.BBox(element.clientLeft, element.clientTop, element.clientWidth, element.clientHeight);
  }
...
__decorateClass([
  Validate11(STRING2, { optional: true }),
  ActionOnSet3({
...
// packages/ag-charts-enterprise/src/features/crosshair/crosshair.ts
var { Group: Group3, Line, BBox: BBox2 } = import_ag_charts_community18._Scene;
var { Validate: Validate12, POSITIVE_NUMBER: POSITIVE_NUMBER3, RATIO: RATIO4, BOOLEAN: BOOLEAN6, COLOR_STRING: COLOR_STRING2, LINE_DASH: LINE_DASH2, Layers: Layers3 } = import_ag_charts_community18._ModuleSupport;
var Crosshair = class extends import_ag_charts_community18._ModuleSupport.BaseModuleInstance {
  constructor(ctx) {
    var _a, _b;
    super();
    this.ctx = ctx;
    ...
    (_a = ctx.scene.root) == null ? void 0 : _a.appendChild(this.crosshairGroup);
    ...
    this.destroyFns.push(
      ...
      () => {
        var _a2;
        return (_a2 = ctx.scene.root) == null ? void 0 : _a2.removeChild(this.crosshairGroup);
      },
      () => this.label.destroy()
    );
  }
  layout({ series: { rect, paddedRect, visible }, axes }) {
    ...
    this.updateLine();
    const format = (_a = this.label.format) != null ? _a : axisLayout.label.format;
  ...
  formatValue(val) {
    ...
    const fractionDigits = ((_a = axisLayout == null ? void 0 : axisLayout.label.fractionDigits) != null ? _a : 0) + (isInteger ? 0 : 1);
  ...
  onHighlightChange(event) {
    ...
    const hasCrosshair = (currentHighlight == null ? void 0 : currentHighlight.datum) && (((_a = currentHighlight.series.axes.x) == null ? void 0 : _a.id) === axisCtx.axisId || ((_b = currentHighlight.series.axes.y) == null ? void 0 : _b.id) === axisCtx.axisId);
    if (!hasCrosshair) {
      this.activeHighlight = void 0;
    } else {
  ...
  getActiveHighlight(activeHighlight) {
    ...
    if (aggregatedValue !== void 0 && ((_a = series.axes.y) == null ? void 0 : _a.id) === axisCtx.axisId) {
...
var AXIS_CROSSHAIR_THEME = {
  crosshair: {
    enabled: true,
    snap: true,
    stroke: import_ag_charts_community19._Theme.DEFAULT_MUTED_LABEL_COLOUR,
    strokeWidth: 1,
    strokeOpacity: 1,
    lineDash: [5, 6],
    lineDashOffset: 0,
...
var { partialAssign, mergeDefaults } = import_ag_charts_community20._ModuleSupport;
var { BBox: BBox3 } = import_ag_charts_community20._Scene;
...
var ErrorBarNode = class extends import_ag_charts_community20._Scene.Group {
  constructor() {
    super();
    this.capLength = NaN;
    this._datum = void 0;
    this.whiskerPath = new import_ag_charts_community20._Scene.Path();
    this.capsPath = new import_ag_charts_community20._Scene.Path();
  ...
  formatStyles(style, formatters, highlighted) {
    let _a = style, { cap: capsStyle } = _a, whiskerStyle = __objRest(_a, ["cap"]);
  ...
  updateBBoxes() {
    ...
    const { yBar, xBar } = (_a = this.datum) != null ? _a : {};
...
var ErrorBarGroup = class extends import_ag_charts_community20._Scene.Group {
  get children() {
    return super.children;
  }
  nearestSquared(point) {
    const { nearest, distanceSquared } = import_ag_charts_community20._Scene.nearestSquaredInContainer(point, this);
...
var {
  ...
  RATIO: RATIO5,
  STRING: STRING3
} = import_ag_charts_community21._ModuleSupport;
var ErrorBarCap = class extends BaseProperties {
};
__decorateClass([
  Validate13(BOOLEAN7, { optional: true })
], ErrorBarCap.prototype, "visible", 2);
__decorateClass([
  Validate13(COLOR_STRING3, { optional: true })
], ErrorBarCap.prototype, "stroke", 2);
__decorateClass([
  Validate13(POSITIVE_NUMBER4, { optional: true })
], ErrorBarCap.prototype, "strokeWidth", 2);
__decorateClass([
  Validate13(RATIO5, { optional: true })
], ErrorBarCap.prototype, "strokeOpacity", 2);
__decorateClass([
  Validate13(LINE_DASH3, { optional: true })
...
__decorateClass([
  Validate13(FUNCTION2, { optional: true })
...
__decorateClass([
  Validate13(STRING3, { optional: true })
...
// packages/ag-charts-enterprise/src/features/error-bar/errorBar.ts
var { isDefined, fixNumericExtent, mergeDefaults: mergeDefaults2, valueProperty, ChartAxisDirection: ChartAxisDirection6 } = import_ag_charts_community22._ModuleSupport;
function toErrorBoundCartesianSeries(ctx) {
  for (const supportedType of import_ag_charts_community22.AgErrorBarSupportedSeriesTypes) {
    if (supportedType == ctx.series.type) {
      return ctx.series;
    }
  }
  throw new Error(
    `AG Charts - unsupported series type '${ctx.series.type}', error bars supported series types: ${import_ag_charts_community22.AgErrorBarSupportedSeriesTypes.join(", ")}`
  );
}
var ErrorBars = class extends import_ag_charts_community22._ModuleSupport.BaseModuleInstance {
  constructor(ctx) {
    super();
    ...
    this.groupNode = new ErrorBarGroup({
      ...
      zIndex: import_ag_charts_community22._ModuleSupport.Layers.SERIES_LAYER_ZINDEX,
      zIndexSubOrder: series.getGroupZIndexSubOrder("annotation")
    });
    annotationGroup.appendChild(this.groupNode);
    this.selection = import_ag_charts_community22._Scene.Selection.select(this.groupNode, () => this.errorBarFactory());
  ...
  createNodeData() {
    ...
    const xScale = (_a = this.cartesianSeries.axes[ChartAxisDirection6.X]) == null ? void 0 : _a.scale;
  ...
  getDatum(nodeData, datumIndex) {
    ...
    return {
      ...
      xLower: datum.datum[xLowerKey != null ? xLowerKey : ""],
      xUpper: datum.datum[xUpperKey != null ? xUpperKey : ""],
      yLower: datum.datum[yLowerKey != null ? yLowerKey : ""],
      yUpper: datum.datum[yUpperKey != null ? yUpperKey : ""]
    };
  }
  convert(scale, value) {
    var _a;
    const offset = ((_a = scale.bandwidth) != null ? _a : 0) / 2;
...
var ERROR_BARS_THEME = {
  errorBar: {
    visible: true,
    stroke: import_ag_charts_community23._Theme.DEFAULT_LABEL_COLOUR,
    strokeWidth: 1,
    strokeOpacity: 1,
    cap: {
      length: void 0,
...
var ErrorBarsModule = {
  ...
  packageType: "enterprise",
  chartTypes: ["cartesian"],
  seriesTypes: import_ag_charts_community24.AgErrorBarSupportedSeriesTypes,
...
var { COLOR_STRING: COLOR_STRING4, RATIO: RATIO6, Validate: Validate14 } = import_ag_charts_community25._ModuleSupport;
var ZoomRect = class extends import_ag_charts_community25._Scene.Rect {
  constructor() {
    super(...arguments);
...
var constrain = (value, min = 0, max = 1) => Math.max(min, Math.min(max, value));
...
function definedZoomState(zoom) {
  ...
  return {
    x: { min: (_b = (_a = zoom == null ? void 0 : zoom.x) == null ? void 0 : _a.min) != null ? _b : UNIT.min, max: (_d = (_c = zoom == null ? void 0 : zoom.x) == null ? void 0 : _c.max) != null ? _d : UNIT.max },
...
function scaleZoomAxisWithAnchor(newState, oldState, anchor, origin) {
  ...
  if (anchor === "start") {
    max = oldState.min + diff7;
  } else if (anchor === "end") {
    min = oldState.max - diff7;
  } else if (anchor === "middle") {
    min = center - diff7 / 2;
    max = center + diff7 / 2;
  } else if (anchor === "pointer") {
    const point = scaleZoomAxisWithPoint(newState, oldState, origin != null ? origin : center);
    min = point.min;
    max = point.max;
  }
  return { min, max };
...
var ZoomAxisDragger = class {
  ...
  update(event, direction, anchor, bbox, zoom, axisZoom) {
    ...
    if (this.oldZoom == null) {
      if (direction === import_ag_charts_community26._ModuleSupport.ChartAxisDirection.X) {
        this.oldZoom = definedZoomState(__spreadProps(__spreadValues({}, zoom), { x: axisZoom }));
      } else {
        this.oldZoom = definedZoomState(__spreadProps(__spreadValues({}, zoom), { y: axisZoom }));
      }
    }
...
var ZoomPanner = class {
  ...
  translateZooms(bbox, currentZooms) {
    var _a;
    const { x1 = 0, y1 = 0, x2 = 0, y2 = 0 } = (_a = this.coords) != null ? _a : {};
    ...
    for (const [axisId, { direction, zoom: currentZoom }] of Object.entries(currentZooms)) {
      let zoom;
      if (direction === import_ag_charts_community27._ModuleSupport.ChartAxisDirection.X) {
...
var ZoomScroller = class {
  ...
  scaleZoomToPointer(sourceEvent, isScalingX, isScalingY, bbox, oldZoom, newZoom) {
    ...
    const origin = pointToRatio(
      bbox,
      (_a = sourceEvent.offsetX) != null ? _a : sourceEvent.clientX,
...
// packages/ag-charts-enterprise/src/features/zoom/zoom.ts
var { BOOLEAN: BOOLEAN8, NUMBER: NUMBER5, RATIO: RATIO7, UNION: UNION3, ActionOnSet: ActionOnSet4, ChartAxisDirection: ChartAxisDirection7, ChartUpdateType, Validate: Validate15 } = import_ag_charts_community28._ModuleSupport;
var ANCHOR_CORD = UNION3(["pointer", "start", "middle", "end"], "an anchor cord");
var CONTEXT_ZOOM_ACTION_ID = "zoom-action";
var CONTEXT_PAN_ACTION_ID = "pan-action";
var CURSOR_ID = "zoom-cursor";
var TOOLTIP_ID2 = "zoom-tooltip";
var ZOOM_ID = "zoom";
var DECIMALS = 3;
var round = (value, decimals = DECIMALS) => {
  const pow = Math.pow(10, decimals);
  return Math.round(value * pow) / pow;
};
var Zoom = class extends import_ag_charts_community28._ModuleSupport.BaseModuleInstance {
  constructor(ctx) {
    var _a;
    super();
    this.ctx = ctx;
    ...
    (_a = this.scene.root) == null ? void 0 : _a.appendChild(selectionRect);
    this.destroyFns.push(() => {
      var _a2;
      return (_a2 = this.scene.root) == null ? void 0 : _a2.removeChild(selectionRect);
    });
  }
  ...
  onDoubleClick(event) {
    ...
    } else if (((_a = this.seriesRect) == null ? void 0 : _a.containsPoint(event.offsetX, event.offsetY)) && this.highlightManager.getActivePicked() === void 0) {
  ...
  onDrag(event) {
    ...
    this.tooltipManager.updateTooltip(TOOLTIP_ID2);
    const zoom = definedZoomState(this.zoomManager.getZoom());
    if (this.enableAxisDragging && this.hoveredAxis) {
      const { id: axisId, direction } = this.hoveredAxis;
      const anchor = direction === import_ag_charts_community28._ModuleSupport.ChartAxisDirection.X ? this.anchorPointX : this.anchorPointY;
      const axisZoom = (_a = this.zoomManager.getAxisZoom(axisId)) != null ? _a : __spreadValues({}, UNIT);
  ...
  onDragEnd() {
    ...
    this.isDragging = false;
    this.tooltipManager.removeTooltip(TOOLTIP_ID2);
  }
  onWheel(event) {
    ...
    if (isAxisScrolling) {
      isScalingX = this.hoveredAxis.direction === import_ag_charts_community28._ModuleSupport.ChartAxisDirection.X;
...
} = import_ag_charts_community29._ModuleSupport;
var { BBox: BBox4, Group: Group4, Rect, LinearGradientFill, Triangle } = import_ag_charts_community29._Scene;
var { createId: createId2, Logger } = import_ag_charts_community29._Util;
...
__decorateClass([
  Validate16(POSITIVE_NUMBER5)
], GradientBar.prototype, "thickness", 2);
__decorateClass([
  Validate16(POSITIVE_NUMBER5)
], GradientBar.prototype, "preferredLength", 2);
var GradientLegendAxisTick = class extends import_ag_charts_community29._ModuleSupport.AxisTick {
  constructor() {
    super(...arguments);
    this.enabled = false;
    this.size = 0;
...
__decorateClass([
  Validate16(MIN_SPACING3),
  Default4(NaN)
], GradientLegendAxisTick.prototype, "maxSpacing", 2);
var GradientLegendAxis = class extends import_ag_charts_community29._ModuleSupport.CartesianAxis {
  constructor(ctx) {
    super(ctx, new import_ag_charts_community29._Scale.LinearScale());
    this.colorDomain = [];
    this.nice = false;
...
var GradientLegend = class {
  constructor(ctx) {
    ...
    this.group = new Group4({ name: "legend", layer: true, zIndex: Layers4.LEGEND_ZINDEX });
    ...
    this.axisGridGroup = new Group4({ name: "legend-axis-grid-group" });
    this.group.append(this.axisGridGroup);
    this.axisGroup = new Group4({ name: "legend-axis-group" });
  ...
  updateArrow(gradientBox) {
    ...
    const vertical = this.getOrientation() === "vertical";
    const size = (_a = label.fontSize) != null ? _a : 0;
...
__decorateClass([
  Validate16(BOOLEAN9, { optional: true })
...
var GRADIENT_LEGEND_THEME = {
  ...
  scale: {
    padding: 8,
    label: {
      color: import_ag_charts_community30._Theme.DEFAULT_LABEL_COLOUR,
      fontStyle: void 0,
      fontWeight: void 0,
      fontSize: 12,
      fontFamily: import_ag_charts_community30._Theme.DEFAULT_FONT_FAMILY,
      formatter: void 0
    },
    interval: {
      minSpacing: 1,
...
var _LicenseManager = class _LicenseManager {
  ...
  validateLicense() {
    ...
    if (licenseDetails.missing) {
      ...
      const formattedReleaseDate = _LicenseManager.formatDate(chartsReleaseDate);
  ...
  getLicenseDetails(licenseKey) {
    ...
    let expired = void 0;
    let expiry = null;
    let incorrectLicenseType = void 0;
    let licenseType = void 0;
  ...
  isForceWatermark() {
    ...
    const win = ((_b = (_a = this.document) == null ? void 0 : _a.defaultView) != null ? _b : typeof window != "undefined") ? window : void 0;
    if (!win) {
      return false;
    }
...
// packages/ag-charts-enterprise/src/series/box-plot/boxPlotDefaults.ts
var import_ag_charts_community32 = require("ag-charts-community");
var { CARTESIAN_AXIS_TYPES, CARTESIAN_AXIS_POSITIONS } = import_ag_charts_community32._Theme;
var BOX_PLOT_SERIES_DEFAULTS = {
  axes: [
    {
...
var BoxPlotGroup = class extends import_ag_charts_community33._Scene.Group {
  constructor() {
    super();
    this.append([
      new import_ag_charts_community33._Scene.Rect({ tag: 0 /* Box */ }),
      new import_ag_charts_community33._Scene.Rect({ tag: 0 /* Box */ }),
      new import_ag_charts_community33._Scene.Rect({ tag: 2 /* Outline */ }),
      new import_ag_charts_community33._Scene.Rect({ tag: 1 /* Median */ }),
      new import_ag_charts_community33._Scene.Line({ tag: 3 /* Whisker */ }),
      new import_ag_charts_community33._Scene.Line({ tag: 3 /* Whisker */ }),
      new import_ag_charts_community33._Scene.Line({ tag: 4 /* Cap */ }),
      new import_ag_charts_community33._Scene.Line({ tag: 4 /* Cap */ })
    ]);
  }
  updateDatumStyles(datum, activeStyles, isVertical, isReversedValueAxis) {
    ...
    const selection = import_ag_charts_community33._Scene.Selection.select(this, import_ag_charts_community33._Scene.Rect);
    ...
    if (isVertical) {
      import_ag_charts_community33._ModuleSupport.invertShapeDirection(outline, median, ...boxes, ...caps, ...whiskers);
    }
...
var {
  ...
  RATIO: RATIO8,
  STRING: STRING4
} = import_ag_charts_community34._ModuleSupport;
...
__decorateClass([
  Validate17(COLOR_STRING5, { optional: true })
...
__decorateClass([
  Validate17(LINE_DASH4, { optional: true })
...
__decorateClass([
  Validate17(STRING4, { optional: true })
...
} = import_ag_charts_community35._ModuleSupport;
var { motion } = import_ag_charts_community35._Scene;
var BoxPlotSeriesNodeClickEvent = class extends import_ag_charts_community35._ModuleSupport.SeriesNodeClickEvent {
...
var BoxPlotSeries = class _BoxPlotSeries extends import_ag_charts_community35._ModuleSupport.AbstractBarSeries {
  constructor(moduleCtx) {
    super({
      moduleCtx,
     ...
     */
    this.groupScale = new import_ag_charts_community35._Scale.BandScale();
  ...
  processData(dataController) {
    return __async(this, null, function* () {
      ...
      const isContinuousX = ((_a = this.getCategoryAxis()) == null ? void 0 : _a.scale) instanceof import_ag_charts_community35._Scale.ContinuousScale;
      const extraProps = [];
  ...
  createNodeData() {
    return __async(this, null, function* () {
      ...
      const xBandWidth = xAxis.scale instanceof import_ag_charts_community35._Scale.ContinuousScale ? xAxis.scale.calcBandwidth(smallestDataInterval == null ? void 0 : smallestDataInterval.x) : xAxis.scale.bandwidth;
      const domain = [];
      ...
      if (xAxis instanceof import_ag_charts_community35._ModuleSupport.CategoryAxis) {
      ...
      (_a = this.processedData) == null ? void 0 : _a.data.forEach(({ datum, keys, values }) => {
    ...
    return [
      {
        ...
        enabled: visible,
        label: {
          text: (_a = legendItemName != null ? legendItemName : yName) != null ? _a : id
        },
  ...
  getTooltipHtml(nodeDatum) {
    ...
    if (!xAxis || !yAxis || !this.properties.isValid())
      return "";
    const title = import_ag_charts_community35._Util.sanitizeHtml(yName);
    const contentData = [
      [xKey, xName, xAxis],
    ...
    const content = contentData.map(([key, name, axis]) => import_ag_charts_community35._Util.sanitizeHtml(`${name != null ? name : key}: ${axis.formatDatum(datum[key])}`)).join(title ? "<br/>" : ", ");
  ...
  updateDatumSelection(opts) {
    return __async(this, null, function* () {
      var _a;
      const data = (_a = opts.nodeData) != null ? _a : [];
  ...
  updateDatumNodes(_0) {
    return __async(this, arguments, function* ({
      ...
      var _a;
      const isVertical = this.isVertical();
      const isReversedValueAxis = (_a = this.getValueAxis()) == null ? void 0 : _a.isReversed();
      datumSelection.each((boxPlotGroup, nodeDatum) => {
        let activeStyles = this.getFormattedStyles(nodeDatum, highlighted);
        if (highlighted) {
          activeStyles = mergeDefaults3(this.properties.highlightStyle.item, activeStyles);
        }
        const { stroke, strokeWidth, strokeOpacity, lineDash, lineDashOffset } = activeStyles;
        activeStyles.whisker = mergeDefaults3(activeStyles.whisker, {
          stroke,
          strokeWidth,
          strokeOpacity,
          lineDash,
  ...
  getFormattedStyles(nodeDatum, highlighted = false) {
    ...
    if (formatter) {
      ...
      if (formatStyles) {
        return mergeDefaults3(formatStyles, activeStyles);
      }
    }
    return activeStyles;
  }
...
var BOX_PLOT_SERIES_THEME = {
  __extends__: import_ag_charts_community36._Theme.EXTENDS_SERIES_DEFAULTS,
  strokeWidth: 2
};
...
var BoxPlotModule = {
  ...
  paletteFactory: ({ takeColors, userPalette, themeTemplateParameters }) => {
    var _a;
    const themeBackgroundColor = themeTemplateParameters.properties.get(import_ag_charts_community37._Theme.DEFAULT_BACKGROUND_COLOUR);
    ...
    return {
      fill: userPalette ? fill : import_ag_charts_community37._Util.Color.interpolate(fill, backgroundFill)(0.7),
      stroke
    };
  },
...
// packages/ag-charts-enterprise/src/series/bullet/bulletDefaults.ts
var import_ag_charts_community38 = require("ag-charts-community");
var { CARTESIAN_AXIS_TYPES: CARTESIAN_AXIS_TYPES2, CARTESIAN_AXIS_POSITIONS: CARTESIAN_AXIS_POSITIONS2 } = import_ag_charts_community38._Theme;
var BULLET_DEFAULTS = {
  axes: [
    {
      type: CARTESIAN_AXIS_TYPES2.NUMBER,
      position: CARTESIAN_AXIS_POSITIONS2.LEFT,
      nice: false,
      max: void 0,
      crosshair: { enabled: false }
    },
    {
      type: CARTESIAN_AXIS_TYPES2.CATEGORY,
      position: CARTESIAN_AXIS_POSITIONS2.BOTTOM
    }
  ]
};
...
var TargetStyle = class extends BaseProperties3 {
  constructor() {
    super(...arguments);
    this.fill = "black";
    this.fillOpacity = 1;
...
var BulletScale = class extends BaseProperties3 {
  // alias for AgChartOptions.axes[0].max
};
__decorateClass([
  Validate18(POSITIVE_NUMBER7, { optional: true })
], BulletScale.prototype, "max", 2);
var BulletColorRange = class extends BaseProperties3 {
  constructor() {
    super(...arguments);
...
__decorateClass([
  Validate18(STRING5, { optional: true })
...
__decorateClass([
  Validate18(ARRAY2.restrict({ minLength: 1 }))
...
var { fromToMotion } = import_ag_charts_community40._Scene.motion;
var { sanitizeHtml } = import_ag_charts_community40._Util;
var STYLING_KEYS = [
  "fill",
  "fillOpacity",
  "stroke",
...
var BulletSeries = class _BulletSeries extends import_ag_charts_community40._ModuleSupport.AbstractBarSeries {
  constructor(moduleCtx) {
    super({
      moduleCtx,
      pickModes: [import_ag_charts_community40._ModuleSupport.SeriesNodePickMode.EXACT_SHAPE_MATCH],
      hasHighlightedLabels: true,
      animationResetFns: {
    ...
    this.colorRangesGroup = new import_ag_charts_community40._Scene.Group({ name: `${this.id}-colorRanges` });
    this.colorRangesSelection = import_ag_charts_community40._Scene.Selection.select(this.colorRangesGroup, import_ag_charts_community40._Scene.Rect, false);
    this.rootGroup.append(this.colorRangesGroup);
    this.targetLinesSelection = import_ag_charts_community40._Scene.Selection.select(this.annotationGroup, import_ag_charts_community40._Scene.Line, false);
  }
  destroy() {
  ...
  processData(dataController) {
    return __async(this, null, function* () {
      ...
      const isContinuousX = import_ag_charts_community40._Scale.ContinuousScale.is((_a = this.getCategoryAxis()) == null ? void 0 : _a.scale);
      const isContinuousY = import_ag_charts_community40._Scale.ContinuousScale.is((_b = this.getValueAxis()) == null ? void 0 : _b.scale);
      const extraProps = [];
      if (targetKey !== void 0) {
  ...
  getMaxValue() {
    var _a, _b;
    return Math.max(...(_b = (_a = this.getValueAxis()) == null ? void 0 : _a.dataDomain.domain) != null ? _b : [0]);
  }
  getSeriesDomain(direction) {
    var _a;
    ...
    } else if (direction == ((_a = this.getValueAxis()) == null ? void 0 : _a.direction)) {
    ...
    return __async(this, null, function* () {
      ...
      for (const { datum, values } of processedData.data) {
        ...
        if (values[0][valueIndex] < 0) {
          import_ag_charts_community40._Util.Logger.warnOnce("negative values are not supported, clipping to 0.");
        }
        ...
        const barAlongX = this.getBarDirection() === import_ag_charts_community40._ModuleSupport.ChartAxisDirection.X;
        const rect = {
        ...
        if (values[0][targetIndex] < 0) {
          import_ag_charts_community40._Util.Logger.warnOnce("negative targets are not supported, ignoring.");
        }
      ...
      this.normalizedColorRanges = sortedRanges.map((item) => {
        var _a2;
        const stop = Math.min(maxValue, (_a2 = item.stop) != null ? _a2 : Infinity);
  ...
  nodeFactory() {
    return new import_ag_charts_community40._Scene.Rect();
  }
  updateDatumSelection(opts) {
    return __async(this, null, function* () {
  ...
  updateColorRanges() {
    return __async(this, null, function* () {
      ...
      const computeRect = this.getBarDirection() === import_ag_charts_community40._ModuleSupport.ChartAxisDirection.Y ? (rect, colorRange) => {
        rect.x = min;
  ...
  animateWaitingUpdateReady(data) {
    ...
    const diff7 = (_b = (_a = this.processedData) == null ? void 0 : _a.reduced) == null ? void 0 : _b.diff;
    const fns = prepareBarAnimationFunctions(collapsedStartingBarPosition(this.isVertical(), this.axes));
    fromToMotion(
      this.id,
      "nodes",
...
// packages/ag-charts-enterprise/src/series/bullet/bulletModule.ts
var { CARTESIAN_AXIS_POSITIONS: CARTESIAN_AXIS_POSITIONS3 } = import_ag_charts_community42._Theme;
var BulletModule = {
  type: "series",
  optionsKey: "series[]",
  packageType: "enterprise",
  ...
  customDefaultsFunction: (series) => {
    var _a;
    const axis0 = __spreadValues({}, BULLET_DEFAULTS.axes[0]);
    const axis1 = __spreadValues({}, BULLET_DEFAULTS.axes[1]);
    if (series.direction === "horizontal") {
      axis0.position = CARTESIAN_AXIS_POSITIONS3.BOTTOM;
      axis1.position = CARTESIAN_AXIS_POSITIONS3.LEFT;
    }
    if (((_a = series.scale) == null ? void 0 : _a.max) !== void 0) {
      axis0.max = series.scale.max;
    }
    return __spreadProps(__spreadValues({}, BULLET_DEFAULTS), { axes: [axis0, axis1] });
  },
  paletteFactory: ({ takeColors, colorsCount, themeTemplateParameters }) => {
    ...
    const themeBackgroundColor = themeTemplateParameters.properties.get(import_ag_charts_community42._Theme.DEFAULT_BACKGROUND_COLOUR);
    const backgroundFill = (_a = Array.isArray(themeBackgroundColor) ? themeBackgroundColor[0] : themeBackgroundColor) != null ? _a : "white";
    const targetStroke = properties.get(import_ag_charts_community42._Theme.DEFAULT_CROSS_LINES_COLOUR);
    const colorRangeColor = import_ag_charts_community42._Util.Color.interpolate(fill, backgroundFill)(0.7);
    return {
      fill,
      stroke,
...
// packages/ag-charts-enterprise/src/series/heatmap/heatmapDefaults.ts
var import_ag_charts_community43 = require("ag-charts-community");
var { CARTESIAN_AXIS_TYPES: CARTESIAN_AXIS_TYPES3, CARTESIAN_AXIS_POSITIONS: CARTESIAN_AXIS_POSITIONS4 } = import_ag_charts_community43._Theme;
var HEATMAP_DEFAULTS = {
  axes: [
    {
      type: CARTESIAN_AXIS_TYPES3.CATEGORY,
      position: CARTESIAN_AXIS_POSITIONS4.LEFT
    },
    {
      type: CARTESIAN_AXIS_TYPES3.CATEGORY,
      position: CARTESIAN_AXIS_POSITIONS4.BOTTOM
    }
  ],
  gradientLegend: {
    enabled: true
...
var { Validate: Validate19, NUMBER: NUMBER6, TEXT_WRAP, OVERFLOW_STRATEGY } = import_ag_charts_community44._ModuleSupport;
var { Logger: Logger2 } = import_ag_charts_community44._Util;
var { Text: Text4, Label } = import_ag_charts_community44._Scene;
var BaseAutoSizedLabel = class extends Label {
  ...
  static lineHeight(fontSize) {
    return Math.ceil(fontSize * Text4.defaultLineHeightRatio);
  }
};
__decorateClass([
  Validate19(TEXT_WRAP)
], BaseAutoSizedLabel.prototype, "wrapping", 2);
__decorateClass([
  Validate19(OVERFLOW_STRATEGY)
...
function formatStackedLabels(labelValue, labelProps, secondaryLabelValue, secondaryLabelProps, { padding }, sizeFittingHeight) {
  ...
  const minimumHeight = ((_a = labelProps.minimumFontSize) != null ? _a : labelProps.fontSize) + ((_b = secondaryLabelProps.minimumFontSize) != null ? _b : secondaryLabelProps.fontSize);
  ...
  const secondaryLabelTextNode = new Text4();
  ...
  return maximumValueSatisfying(0, fontSizeCandidates.length - 1, (index) => {
    ...
    if (label == null || label.fontSize !== labelFontSize) {
      ...
      const { lines: labelLines } = Text4.wrapLines(
        labelValue,
        availableWidth,
        availableHeight,
        labelTextSizeProps,
    ...
    if (secondaryLabel == null || secondaryLabel.fontSize !== secondaryLabelFontSize) {
      ...
      const { lines: secondaryLabelLines } = Text4.wrapLines(
        secondaryLabelValue,
        availableWidth,
        availableHeight,
...
function formatSingleLabel(value, props, { padding }, sizeFittingHeight) {
  ...
  const minimumFontSize = Math.min((_a = props.minimumFontSize) != null ? _a : props.fontSize, props.fontSize);
  const textNode = new Text4();
...
function formatLabels(baseLabelValue, labelProps, baseSecondaryLabelValue, secondaryLabelProps, layoutParams, sizeFittingHeight) {
  ...
  if (hasInvalidFontSize(labelProps) || hasInvalidFontSize(secondaryLabelProps)) {
    Logger2.warnOnce(`minimumFontSize should be set to a value less than or equal to the font size`);
  }
  let value;
...
var {
  ...
  TEXT_ALIGN,
  VERTICAL_ALIGN
} = import_ag_charts_community45._ModuleSupport;
var HeatmapSeriesProperties = class extends SeriesProperties {
  constructor() {
    super(...arguments);
...
__decorateClass([
  Validate20(STRING6, { optional: true })
...
__decorateClass([
  Validate20(AND5(COLOR_STRING_ARRAY, ARRAY3.restrict({ minLength: 1 })))
], HeatmapSeriesProperties.prototype, "colorRange", 2);
__decorateClass([
  Validate20(COLOR_STRING7, { optional: true })
], HeatmapSeriesProperties.prototype, "stroke", 2);
__decorateClass([
  Validate20(POSITIVE_NUMBER8, { optional: true })
], HeatmapSeriesProperties.prototype, "strokeWidth", 2);
__decorateClass([
  Validate20(TEXT_ALIGN)
], HeatmapSeriesProperties.prototype, "textAlign", 2);
__decorateClass([
  Validate20(VERTICAL_ALIGN)
...
__decorateClass([
  Validate20(FUNCTION4, { optional: true })
...
// packages/ag-charts-enterprise/src/series/heatmap/heatmapSeries.ts
var { SeriesNodePickMode: SeriesNodePickMode2, valueProperty: valueProperty4, ChartAxisDirection: ChartAxisDirection9 } = import_ag_charts_community46._ModuleSupport;
var { Rect: Rect2, PointerEvents } = import_ag_charts_community46._Scene;
var { ColorScale } = import_ag_charts_community46._Scale;
var { sanitizeHtml: sanitizeHtml2, Color, Logger: Logger3 } = import_ag_charts_community46._Util;
var HeatmapSeriesNodeClickEvent = class extends import_ag_charts_community46._ModuleSupport.CartesianSeriesNodeClickEvent {
  constructor(type, nativeEvent, datum, series) {
    super(type, nativeEvent, datum, series);
...
var _HeatmapSeries = class _HeatmapSeries extends import_ag_charts_community46._ModuleSupport.CartesianSeries {
  constructor(moduleCtx) {
    super({
      moduleCtx,
  ...
  processData(dataController) {
    return __async(this, null, function* () {
      ...
      if (!xAxis || !yAxis || !this.properties.isValid() || !((_a = this.data) == null ? void 0 : _a.length)) {
        return;
      }
  ...
  updateDatumNodes(opts) {
    return __async(this, null, function* () {
      ...
      const xAxis = this.axes[ChartAxisDirection9.X];
      const [visibleMin, visibleMax] = (_a = xAxis == null ? void 0 : xAxis.visibleRange) != null ? _a : [];
      ...
      opts.datumSelection.each((rect, datum) => {
        ...
        rect.fill = (_a2 = format == null ? void 0 : format.fill) != null ? _a2 : fill;
        rect.stroke = (_b = format == null ? void 0 : format.stroke) != null ? _b : stroke;
        rect.strokeWidth = (_c = format == null ? void 0 : format.strokeWidth) != null ? _c : strokeWidth;
      });
    });
  }
  updateLabelSelection(opts) {
  ...
  getTooltipHtml(nodeDatum) {
    ...
    const color = (_b = (_a = format == null ? void 0 : format.fill) != null ? _a : fill) != null ? _b : "gray";
  ...
  getLegendData(legendType) {
    var _a;
    if (legendType !== "gradient" || !((_a = this.data) == null ? void 0 : _a.length) || !this.properties.isValid() || !this.isColorScaleValid() || !this.dataModel) {
      return [];
    }
    return [
      {
...
var HEATMAP_SERIES_THEME = {
  __extends__: import_ag_charts_community47._Theme.EXTENDS_SERIES_DEFAULTS,
  label: {
    __overrides__: import_ag_charts_community47._Theme.OVERRIDE_SERIES_LABEL_DEFAULTS,
    enabled: false,
    color: import_ag_charts_community47._Theme.DEFAULT_LABEL_COLOUR,
    fontStyle: void 0,
    fontSize: import_ag_charts_community47._Theme.FONT_SIZE.SMALL,
    minimumFontSize: void 0,
    fontFamily: import_ag_charts_community47._Theme.DEFAULT_FONT_FAMILY,
    wrapping: "on-space",
...
var HeatmapModule = {
  ...
  paletteFactory: ({ takeColors, colorsCount, userPalette, themeTemplateParameters }) => {
    var _a;
    const { properties } = themeTemplateParameters;
    const defaultColorRange = properties.get(import_ag_charts_community48._Theme.DEFAULT_DIVERGING_SERIES_COLOUR_RANGE);
    const defaultBackgroundColor = properties.get(import_ag_charts_community48._Theme.DEFAULT_BACKGROUND_COLOUR);
...
// packages/ag-charts-enterprise/src/series/nightingale/nightingaleDefaults.ts
var import_ag_charts_community49 = require("ag-charts-community");
var { POLAR_AXIS_TYPES, CIRCLE } = import_ag_charts_community49._Theme;
var NIGHTINGALE_DEFAULTS = {
  axes: [
    {
...
var { BandScale: BandScale3 } = import_ag_charts_community50._Scale;
var { motion: motion2 } = import_ag_charts_community50._Scene;
var { isNumber, normalizeAngle360: normalizeAngle3605, sanitizeHtml: sanitizeHtml3 } = import_ag_charts_community50._Util;
var RadialColumnSeriesNodeClickEvent = class extends import_ag_charts_community50._ModuleSupport.SeriesNodeClickEvent {
  constructor(type, nativeEvent, datum, series) {
    super(type, nativeEvent, datum, series);
...
var RadialColumnSeriesBase = class extends import_ag_charts_community50._ModuleSupport.PolarSeries {
  constructor(moduleCtx, {
    animationResetFns
  }) {
    super({
    ...
    return __async(this, null, function* () {
      ...
      yield this.requestDataModel(dataController, (_a = this.data) != null ? _a : [], {
        props: [
          ...
          ...groupAccumulativeValueProperty(this, radiusKey, true, "normal", "current", __spreadValues({
            id: `radiusValue-end`,
            invalidValue: null,
            groupId: stackGroupId
          }, visibleProps)),
          ...groupAccumulativeValueProperty(this, radiusKey, true, "trailing", "current", __spreadValues({
  ...
  isRadiusAxisReversed() {
    var _a;
    return (_a = this.axes[ChartAxisDirection10.Y]) == null ? void 0 : _a.isReversed();
  }
  ...
  createNodeData() {
    return __async(this, null, function* () {
      ...
      const groupAngleStep = (_a = angleScale.bandwidth) != null ? _a : 0;
      ...
      const nodeData = processedData.data.map((group, index) => {
        ...
        const startAngle = normalizeAngle3605(groupAngle + groupScale.convert(String(groupIndex)));
        const endAngle = normalizeAngle3605(startAngle + groupScale.bandwidth);
  ...
  updateSectorSelection(selection, highlight) {
    ...
    let selectionData = [];
    if (highlight) {
      const highlighted = (_a = this.ctx.highlightManager) == null ? void 0 : _a.getActiveHighlight();
    ...
    selection.update(selectionData, void 0, idFn).each((node, datum) => {
      ...
      node.fill = (_a2 = format == null ? void 0 : format.fill) != null ? _a2 : fill;
  ...
  getTooltipHtml(nodeDatum) {
    ...
    const { fill: color } = (_a = formatter && this.ctx.callbackCache.call(formatter, {
      seriesId,
      datum,
      fill,
      stroke,
...
var { Label: Label2 } = import_ag_charts_community51._Scene;
var {
...
var RadialColumnSeriesBaseProperties = class extends SeriesProperties2 {
  constructor() {
    super(...arguments);
    this.fill = "black";
    this.fillOpacity = 1;
...
__decorateClass([
  Validate21(NUMBER7, { optional: true })
...
var { motion: motion3 } = import_ag_charts_community52._Scene;
function createAngleMotionCalculator() {
  ...
  const calculate = (node, datum, status) => {
    angleKeys.forEach((key) => {
      ...
      if (isNaN(to2)) {
        to2 = (_b = (_a = node.previousDatum) == null ? void 0 : _a[key]) != null ? _b : NaN;
      }
...
function prepareRadialColumnAnimationFunctions(axisZeroRadius) {
  ...
  const fromFn = (node, datum, status) => {
    ...
    const mixin = motion3.FROM_TO_MIXINS[status];
...
// packages/ag-charts-enterprise/src/series/nightingale/nightingaleUtil.ts
var { motion: motion4 } = import_ag_charts_community53._Scene;
function prepareNightingaleAnimationFunctions(axisZeroRadius) {
  ...
  const fromFn = (sect, datum, status) => {
    ...
    const mixin = motion4.FROM_TO_MIXINS[status];
    return __spreadValues({ innerRadius, outerRadius, startAngle, endAngle }, mixin);
  };
...
// packages/ag-charts-enterprise/src/series/nightingale/nightingaleSeries.ts
var { Sector: Sector3 } = import_ag_charts_community54._Scene;
var NightingaleSeries = class extends RadialColumnSeriesBase {
  ...
  getStackId() {
    var _a, _b;
    const groupIndex = (_b = (_a = this.seriesGrouping) == null ? void 0 : _a.groupIndex) != null ? _b : this.id;
...
var NIGHTINGALE_SERIES_THEME = {
  ...
  label: {
    ...
    __overrides__: import_ag_charts_community55._Theme.OVERRIDE_SERIES_LABEL_DEFAULTS
  }
};
...
var NightingaleModule = {
  ...
  paletteFactory: ({ takeColors, userPalette }) => {
    ...
    return {
      fill,
      stroke: userPalette ? stroke : import_ag_charts_community56._Theme.DEFAULT_POLAR_SERIES_STROKE
    };
  },
  stackable: true,
  groupable: true,
...
// packages/ag-charts-enterprise/src/series/polarDefaults.ts
var import_ag_charts_community57 = require("ag-charts-community");
var { POLAR_AXIS_TYPES: POLAR_AXIS_TYPES2 } = import_ag_charts_community57._Theme;
var POLAR_DEFAULTS = {
  axes: [
    {
      type: POLAR_AXIS_TYPES2.ANGLE_CATEGORY,
      label: {
        padding: 10
      }
    },
    {
      type: POLAR_AXIS_TYPES2.RADIUS_NUMBER
    }
  ]
};
...
var { Label: Label3 } = import_ag_charts_community58._Scene;
var {
  SeriesMarker,
...
var RadarSeriesProperties = class extends SeriesProperties3 {
  constructor() {
    super(...arguments);
    this.stroke = "black";
    this.strokeWidth = 1;
...
var {
  ...
  ADD_PHASE
} = import_ag_charts_community59._ModuleSupport;
var { BBox: BBox5, Group: Group5, Path: Path5, PointerEvents: PointerEvents2, Selection: Selection2, Text: Text5, getMarker } = import_ag_charts_community59._Scene;
var { extent: extent2, isNumber: isNumber2, isNumberEqual: isNumberEqual8, sanitizeHtml: sanitizeHtml4, toFixed } = import_ag_charts_community59._Util;
var RadarSeriesNodeClickEvent = class extends import_ag_charts_community59._ModuleSupport.SeriesNodeClickEvent {
  constructor(type, nativeEvent, datum, series) {
    super(type, nativeEvent, datum, series);
    this.angleKey = series.properties.angleKey;
    this.radiusKey = series.properties.radiusKey;
...
var RadarSeries = class extends import_ag_charts_community59._ModuleSupport.PolarSeries {
  constructor(moduleCtx) {
    super({
      moduleCtx,
      useLabelLayer: true,
  ...
  createNodeData() {
    return __async(this, null, function* () {
      ...
      const angleScale = (_a = this.axes[ChartAxisDirection11.X]) == null ? void 0 : _a.scale;
  ...
  getMarkerFill(highlightedStyle) {
    var _a;
    return (_a = highlightedStyle == null ? void 0 : highlightedStyle.fill) != null ? _a : this.properties.marker.fill;
  }
  updateMarkers(selection, highlight) {
    ...
    selection.update(selectionData).each((node, datum) => {
      ...
      const stroke = (_b = (_a2 = highlightedStyle == null ? void 0 : highlightedStyle.stroke) != null ? _a2 : marker.stroke) != null ? _b : this.properties.stroke;
  ...
  getTooltipHtml(nodeDatum) {
    ...
    const { fill: color } = (_a = markerFormatter && this.ctx.callbackCache.call(markerFormatter, {
      datum,
      angleKey,
      radiusKey,
      fill,
  ...
  pickNodeClosestDatum(point) {
    ...
    if (closestDatum) {
      const distance = Math.max(minDistance - ((_b = (_a = closestDatum.point) == null ? void 0 : _a.size) != null ? _b : 0), 0);
  ...
  animateEmptyUpdateReady() {
    ...
    animationManager.animate(__spreadProps(__spreadValues({
      id: `${this.id}_'path`,
      groupId: this.id
    }, animationOptions), {
      duration,
...
var { RATIO: RATIO12, COLOR_STRING: COLOR_STRING10, Validate: Validate23 } = import_ag_charts_community60._ModuleSupport;
...
// packages/ag-charts-enterprise/src/series/radar-area/radarAreaSeries.ts
var { Group: Group6, Path: Path6, PointerEvents: PointerEvents3, Selection: Selection3 } = import_ag_charts_community61._Scene;
var { ChartAxisDirection: ChartAxisDirection12 } = import_ag_charts_community61._ModuleSupport;
var RadarAreaSeries = class extends RadarSeries {
  constructor(moduleCtx) {
    super(moduleCtx);
    this.properties = new RadarAreaSeriesProperties();
    this.resetInvalidToZero = true;
    const areaGroup = new Group6();
  ...
  getMarkerFill(highlightedStyle) {
    var _a, _b;
    return (_b = (_a = highlightedStyle == null ? void 0 : highlightedStyle.fill) != null ? _a : this.properties.marker.fill) != null ? _b : this.properties.fill;
  }
  beforePathAnimation() {
  ...
  getAreaPoints() {
    ...
    const getPolarAxis = (direction) => {
      ...
      return axis instanceof import_ag_charts_community61._ModuleSupport.PolarAxis ? axis : void 0;
    };
    ...
    const { points: zeroLinePoints = [] } = (_b = (_a = angleAxis == null ? void 0 : angleAxis.getAxisLinePoints) == null ? void 0 : _a.call(angleAxis)) != null ? _b : {};
...
// packages/ag-charts-enterprise/src/series/radar-area/radarAreaThemes.ts
var RADAR_AREA_SERIES_THEME = __spreadProps(__spreadValues({}, RADAR_SERIES_THEME), {
  fillOpacity: 0.8,
  strokeWidth: 2,
  marker: __spreadProps(__spreadValues({}, RADAR_SERIES_THEME.marker), {
    enabled: false
  })
});

// packages/ag-charts-enterprise/src/series/radar-area/radarAreaModule.ts
var { markerPaletteFactory } = import_ag_charts_community63._ModuleSupport;
var RadarAreaModule = {
  type: "series",
  optionsKey: "series[]",
  packageType: "enterprise",
...
// packages/ag-charts-enterprise/src/series/radar-line/radarLineThemes.ts
var RADAR_LINE_SERIES_THEME = __spreadProps(__spreadValues({}, RADAR_SERIES_THEME), {
  strokeWidth: 2
});
...
// packages/ag-charts-enterprise/src/series/radial-bar/radialBarDefaults.ts
var import_ag_charts_community64 = require("ag-charts-community");
var { POLAR_AXIS_TYPES: POLAR_AXIS_TYPES3 } = import_ag_charts_community64._Theme;
var RADIAL_BAR_DEFAULTS = {
  axes: [
    {
      type: POLAR_AXIS_TYPES3.ANGLE_NUMBER
    },
    {
      type: POLAR_AXIS_TYPES3.RADIUS_CATEGORY,
...
var { Label: Label4 } = import_ag_charts_community65._Scene;
var {
  ...
  RATIO: RATIO13,
  STRING: STRING9
} = import_ag_charts_community65._ModuleSupport;
var RadialBarSeriesProperties = class extends SeriesProperties4 {
  constructor() {
    super(...arguments);
    this.fill = "black";
    this.fillOpacity = 1;
...
var { motion: motion5 } = import_ag_charts_community66._Scene;
...
function prepareRadialBarSeriesAnimationFunctions(axisZeroAngle) {
  const fromFn = (sect, datum, status) => {
    ...
    const mixin = motion5.FROM_TO_MIXINS[status];
    return __spreadValues({ startAngle, endAngle, innerRadius, outerRadius }, mixin);
  };
...
var { BandScale: BandScale4 } = import_ag_charts_community67._Scale;
var { Sector: Sector4, motion: motion6 } = import_ag_charts_community67._Scene;
var { angleBetween: angleBetween3, isNumber: isNumber3, sanitizeHtml: sanitizeHtml5 } = import_ag_charts_community67._Util;
var RadialBarSeriesNodeClickEvent = class extends import_ag_charts_community67._ModuleSupport.SeriesNodeClickEvent {
  constructor(type, nativeEvent, datum, series) {
    super(type, nativeEvent, datum, series);
    this.angleKey = series.properties.angleKey;
    this.radiusKey = series.properties.radiusKey;
...
var RadialBarSeries = class extends import_ag_charts_community67._ModuleSupport.PolarSeries {
  constructor(moduleCtx) {
    super({
      moduleCtx,
      useLabelLayer: true,
    ...
    return __async(this, null, function* () {
      ...
      yield this.requestDataModel(dataController, (_a = this.data) != null ? _a : [], {
        props: [
          ...
          ...groupAccumulativeValueProperty2(this, angleKey, true, "normal", "current", __spreadValues({
            id: `angleValue-end`,
            invalidValue: null,
            groupId: stackGroupId
          }, visibleProps)),
          ...groupAccumulativeValueProperty2(this, angleKey, true, "trailing", "current", __spreadValues({
            id: `angleValue-start`,
            invalidValue: null,
            groupId: stackGroupTrailingId
          }, visibleProps)),
  ...
  createNodeData() {
    return __async(this, null, function* () {
      ...
      const { index: groupIndex, visibleGroupCount } = this.ctx.seriesStateManager.getVisiblePeerGroupIndex(this);
      groupScale.domain = Array.from({ length: visibleGroupCount }).map((_, i) => String(i));
      groupScale.range = [0, Math.abs((_a = radiusScale.bandwidth) != null ? _a : 0)];
      groupScale.paddingInner = visibleGroupCount > 1 ? groupPaddingInner : 0;
  ...
  getBarTransitionFunctions() {
    var _a;
    const angleScale = (_a = this.axes[ChartAxisDirection13.X]) == null ? void 0 : _a.scale;
    let axisZeroAngle = 0;
    if (!angleScale) {
...
var RADIAL_BAR_SERIES_THEME = {
  __extends__: import_ag_charts_community68._Theme.EXTENDS_SERIES_DEFAULTS,
  strokeWidth: 0,
  label: {
    enabled: false,
    fontSize: 12,
    fontFamily: import_ag_charts_community68._Theme.DEFAULT_FONT_FAMILY,
    color: import_ag_charts_community68._Theme.DEFAULT_INVERTED_LABEL_COLOUR,
    __overrides__: import_ag_charts_community68._Theme.OVERRIDE_SERIES_LABEL_DEFAULTS
  }
};
...
// packages/ag-charts-enterprise/src/series/radial-column/radialColumnDefaults.ts
var import_ag_charts_community69 = require("ag-charts-community");
var { POLAR_AXIS_TYPES: POLAR_AXIS_TYPES4, CIRCLE: CIRCLE2 } = import_ag_charts_community69._Theme;
var RADIAL_COLUMN_DEFAULTS = {
  axes: [
    {
      type: POLAR_AXIS_TYPES4.ANGLE_CATEGORY,
      shape: CIRCLE2,
      groupPaddingInner: 0,
      paddingInner: 0,
      label: {
    ...
    {
      type: POLAR_AXIS_TYPES4.RADIUS_NUMBER,
      shape: CIRCLE2,
...
var { Validate: Validate25, RATIO: RATIO14 } = import_ag_charts_community70._ModuleSupport;
var RadialColumnSeriesProperties = class extends RadialColumnSeriesBaseProperties {
};
__decorateClass([
  Validate25(RATIO14, { optional: true })
], RadialColumnSeriesProperties.prototype, "columnWidthRatio", 2);
__decorateClass([
  Validate25(RATIO14, { optional: true })
], RadialColumnSeriesProperties.prototype, "maxColumnWidthRatio", 2);

// packages/ag-charts-enterprise/src/series/radial-column/radialColumnShape.ts
var import_ag_charts_community71 = require("ag-charts-community");
var { Path: Path7, Path2D, ScenePathChangeDetection } = import_ag_charts_community71._Scene;
var { angleBetween: angleBetween4, isNumberEqual: isNumberEqual9, normalizeAngle360: normalizeAngle3606 } = import_ag_charts_community71._Util;
...
var RadialColumnShape = class extends Path7 {
  constructor() {
    super(...arguments);
  ...
  getRotation() {
    ...
    const midAngle = angleBetween4(startAngle, endAngle);
    return normalizeAngle3606(startAngle + midAngle / 2 + Math.PI / 2);
  }
  updatePath() {
  ...
  updateBeveledPath() {
    ...
    const isStackBottom = isNumberEqual9(innerRadius, axisInnerRadius);
    ...
    const isEmpty = isNumberEqual9(innerRadius, outerRadius);
    ...
    if (isEmpty && shouldConnectBottomCircle) {
      path.arc(
        ...
        0,
        innerRadius,
        normalizeAngle3606(-sideRotation - Math.PI / 2) + pointRotation,
        normalizeAngle3606(sideRotation - Math.PI / 2) + pointRotation,
        false
      );
      ...
      if (!isNumberEqual9(topIntersectionX, 0)) {
...
function getRadialColumnWidth(startAngle, endAngle, axisOuterRadius, columnWidthRatio, maxColumnWidthRatio) {
  const rotation = angleBetween4(startAngle, endAngle);
...
// packages/ag-charts-enterprise/src/series/radial-column/radialColumnSeries.ts
var { ChartAxisDirection: ChartAxisDirection14, PolarAxis: PolarAxis4 } = import_ag_charts_community72._ModuleSupport;
...
var RADIAL_COLUMN_SERIES_THEME = {
  __extends__: import_ag_charts_community73._Theme.EXTENDS_SERIES_DEFAULTS,
  ...
  label: {
    enabled: false,
    fontSize: 12,
    fontFamily: import_ag_charts_community73._Theme.DEFAULT_FONT_FAMILY,
    color: import_ag_charts_community73._Theme.DEFAULT_LABEL_COLOUR,
    __overrides__: import_ag_charts_community73._Theme.OVERRIDE_SERIES_LABEL_DEFAULTS
  }
};
...
var { DropShadow, Label: Label5 } = import_ag_charts_community74._Scene;
var {
...
__decorateClass([
  Validate26(PLACEMENT)
], RangeAreaSeriesLabel.prototype, "placement", 2);
__decorateClass([
  Validate26(POSITIVE_NUMBER12)
], RangeAreaSeriesLabel.prototype, "padding", 2);
var RangeAreaProperties = class extends CartesianSeriesProperties {
  constructor() {
    super(...arguments);
    this.fill = "#99CCFF";
    this.fillOpacity = 1;
...
__decorateClass([
  Validate26(STRING10, { optional: true })
...
var { getMarker: getMarker2, PointerEvents: PointerEvents4 } = import_ag_charts_community75._Scene;
var { sanitizeHtml: sanitizeHtml6, extent: extent3, isNumber: isNumber4 } = import_ag_charts_community75._Util;
var DEFAULT_DIRECTION_KEYS = {
  [import_ag_charts_community75._ModuleSupport.ChartAxisDirection.X]: ["xKey"],
  [import_ag_charts_community75._ModuleSupport.ChartAxisDirection.Y]: ["yLowKey", "yHighKey"]
};
var DEFAULT_DIRECTION_NAMES = {
  [ChartAxisDirection15.X]: ["xName"],
  [ChartAxisDirection15.Y]: ["yLowName", "yHighName", "yName"]
};
var RangeAreaSeriesNodeClickEvent = class extends import_ag_charts_community75._ModuleSupport.SeriesNodeClickEvent {
  constructor(type, nativeEvent, datum, series) {
    super(type, nativeEvent, datum, series);
    this.xKey = series.properties.xKey;
...
var _RangeAreaSeries = class _RangeAreaSeries extends import_ag_charts_community75._ModuleSupport.CartesianSeries {
  constructor(moduleCtx) {
    super({
      moduleCtx,
      hasHighlightedLabels: true,
  ...
  updateMarkerNodes(opts) {
    return __async(this, null, function* () {
      ...
      const baseStyle = mergeDefaults4(highlighted && this.properties.highlightStyle.item, marker.getStyle(), {
        fill,
        fillOpacity,
        stroke,
        strokeWidth,
    ...
    return [
      {
        ...
        marker: {
          shape: marker.shape,
          fill: (_a = marker.fill) != null ? _a : fill,
  ...
  nodeFactory() {
    return new import_ag_charts_community75._Scene.Group();
  }
...
// packages/ag-charts-enterprise/src/series/range-area/rangeAreaDefaults.ts
var import_ag_charts_community76 = require("ag-charts-community");
var { CARTESIAN_AXIS_TYPES: CARTESIAN_AXIS_TYPES4, CARTESIAN_AXIS_POSITIONS: CARTESIAN_AXIS_POSITIONS5 } = import_ag_charts_community76._Theme;
var RANGE_AREA_DEFAULTS = {
  axes: [
    {
      type: CARTESIAN_AXIS_TYPES4.NUMBER,
      position: CARTESIAN_AXIS_POSITIONS5.LEFT,
      crosshair: {
        enabled: true,
        snap: false
      }
    ...
    {
      type: CARTESIAN_AXIS_TYPES4.CATEGORY,
      position: CARTESIAN_AXIS_POSITIONS5.BOTTOM
    }
  ]
};
...
var RANGE_AREA_SERIES_THEME = {
  __extends__: import_ag_charts_community77._Theme.EXTENDS_SERIES_DEFAULTS,
  xKey: "",
  yLowKey: "",
  yHighKey: "",
  fillOpacity: 0.7,
  ...
  label: {
    ...
    fontWeight: void 0,
    fontSize: 12,
    fontFamily: import_ag_charts_community77._Theme.DEFAULT_FONT_FAMILY,
    color: import_ag_charts_community77._Theme.DEFAULT_LABEL_COLOUR,
    __overrides__: import_ag_charts_community77._Theme.OVERRIDE_SERIES_LABEL_DEFAULTS
  }
};

// packages/ag-charts-enterprise/src/series/range-area/rangeAreaModule.ts
var { markerPaletteFactory: markerPaletteFactory2 } = import_ag_charts_community78._ModuleSupport;
var RangeAreaModule = {
  type: "series",
  optionsKey: "series[]",
  packageType: "enterprise",
...
var { DropShadow: DropShadow2, Label: Label6 } = import_ag_charts_community79._Scene;
var {
...
__decorateClass([
  Validate27(PLACEMENT2)
], RangeBarSeriesLabel.prototype, "placement", 2);
__decorateClass([
  Validate27(POSITIVE_NUMBER13)
...
__decorateClass([
  Validate27(STRING11, { optional: true })
...
__decorateClass([
  Validate27(FUNCTION8, { optional: true })
...
} = import_ag_charts_community80._ModuleSupport;
var { ContinuousScale, BandScale: BandScale5, Rect: Rect3, PointerEvents: PointerEvents5, motion: motion7 } = import_ag_charts_community80._Scene;
var { sanitizeHtml: sanitizeHtml7, isNumber: isNumber5, extent: extent4 } = import_ag_charts_community80._Util;
var DEFAULT_DIRECTION_KEYS2 = {
  [import_ag_charts_community80._ModuleSupport.ChartAxisDirection.X]: ["xKey"],
  [import_ag_charts_community80._ModuleSupport.ChartAxisDirection.Y]: ["yLowKey", "yHighKey"]
};
var DEFAULT_DIRECTION_NAMES2 = {
  [ChartAxisDirection16.X]: ["xName"],
  [ChartAxisDirection16.Y]: ["yLowName", "yHighName", "yName"]
};
var RangeBarSeriesNodeClickEvent = class extends import_ag_charts_community80._ModuleSupport.SeriesNodeClickEvent {
  constructor(type, nativeEvent, datum, series) {
    super(type, nativeEvent, datum, series);
    this.xKey = series.properties.xKey;
    this.yLowKey = series.properties.yLowKey;
...
var _RangeBarSeries = class _RangeBarSeries extends import_ag_charts_community80._ModuleSupport.AbstractBarSeries {
  constructor(moduleCtx) {
    super({
      moduleCtx,
  ...
  getSeriesDomain(direction) {
    ...
    if (direction === this.getCategoryDirection()) {
      ...
      const keysExtent = (_a = extent4(keys)) != null ? _a : [NaN, NaN];
      const categoryAxis = this.getCategoryAxis();
      const isReversed = categoryAxis == null ? void 0 : categoryAxis.isReversed();
  ...
  animateEmptyUpdateReady({ datumSelections, labelSelections }) {
    const fns = prepareBarAnimationFunctions2(midpointStartingBarPosition(this.isVertical()));
  ...
  animateWaitingUpdateReady(data) {
    ...
    const diff7 = (_a = processedData == null ? void 0 : processedData.reduced) == null ? void 0 : _a.diff;
    this.ctx.animationManager.stopByAnimationGroupId(this.id);
    const fns = prepareBarAnimationFunctions2(midpointStartingBarPosition(this.isVertical()));
...
// packages/ag-charts-enterprise/src/series/range-bar/rangeBarDefaults.ts
var import_ag_charts_community81 = require("ag-charts-community");
var { CARTESIAN_AXIS_TYPES: CARTESIAN_AXIS_TYPES5, CARTESIAN_AXIS_POSITIONS: CARTESIAN_AXIS_POSITIONS6 } = import_ag_charts_community81._Theme;
var RANGE_BAR_DEFAULTS = {
  axes: [
    {
      type: CARTESIAN_AXIS_TYPES5.CATEGORY,
      position: CARTESIAN_AXIS_POSITIONS6.BOTTOM
    },
    {
      type: CARTESIAN_AXIS_TYPES5.NUMBER,
      position: CARTESIAN_AXIS_POSITIONS6.LEFT,
      crosshair: {
        enabled: true,
        snap: false
      }
...
var RANGE_BAR_SERIES_THEME = {
  __extends__: import_ag_charts_community82._Theme.EXTENDS_SERIES_DEFAULTS,
  xKey: "",
  yLowKey: "",
  yHighKey: "",
  strokeWidth: 0,
  label: {
    ...
    fontWeight: void 0,
    fontSize: 12,
    fontFamily: import_ag_charts_community82._Theme.DEFAULT_FONT_FAMILY,
    color: import_ag_charts_community82._Theme.DEFAULT_INSIDE_SERIES_LABEL_COLOUR,
    formatter: void 0,
    placement: "inside",
    __overrides__: import_ag_charts_community82._Theme.OVERRIDE_SERIES_LABEL_DEFAULTS
  }
};
...
// packages/ag-charts-enterprise/src/series/sunburst/sunburstSeries.ts
var { fromToMotion: fromToMotion2 } = import_ag_charts_community84._ModuleSupport;
var { Sector: Sector5, Group: Group7, Selection: Selection4, Text: Text6 } = import_ag_charts_community84._Scene;
var { sanitizeHtml: sanitizeHtml8 } = import_ag_charts_community84._Util;
...
var _SunburstSeries = class _SunburstSeries extends import_ag_charts_community84._ModuleSupport.HierarchySeries {
  constructor() {
    super(...arguments);
    this.properties = new SunburstSeriesProperties();
    this.groupSelection = Selection4.select(this.contentGroup, Group7);
  ...
  updateSelections() {
    return __async(this, null, function* () {
      ...
      const updateGroup = (group) => {
        group.append([
          new Sector5(),
          new Text6({ tag: 0 /* Primary */ }),
          new Text6({ tag: 1 /* Secondary */ })
        ]);
      };
  ...
  updateNodes() {
    return __async(this, null, function* () {
      ...
      const highlightedNode = (_a = this.ctx.highlightManager) == null ? void 0 : _a.getActiveHighlight();
      const labelTextNode = new Text6();
      ...
      const updateSector = (node, sector, highlighted) => {
        ...
        const fill = (_b = (_a2 = format == null ? void 0 : format.fill) != null ? _a2 : highlightedFill) != null ? _b : node.fill;
      ...
      const labelMeta = Array.from(this.rootNode, (node, index) => {
        ...
        const sizeFittingHeight = (height3) => {
          var _a2;
          const isCenterCircle = depth === 0 && ((_a2 = node.parent) == null ? void 0 : _a2.sumSize) === node.sumSize;
          if (isCenterCircle) {
      ...
      this.groupSelection.selectByClass(Text6).forEach((text) => {
        updateText(text.datum, text, text.tag, false);
      });
      this.highlightSelection.selectByClass(Text6).forEach((text) => {
  ...
  getTooltipHtml(node) {
    ...
    const color = (_a = format == null ? void 0 : format.fill) != null ? _a : node.fill;
...
// packages/ag-charts-enterprise/src/series/sunburst/sunburstSeriesModule.ts
var { EXTENDS_SERIES_DEFAULTS, DEFAULT_INSIDE_SERIES_LABEL_COLOUR } = import_ag_charts_community85._Theme;
var SunburstSeriesModule = {
  ...
  paletteFactory: ({ takeColors, colorsCount, themeTemplateParameters }) => {
    const { properties } = themeTemplateParameters;
    const { fills, strokes } = takeColors(colorsCount);
    const defaultColorRange = properties.get(import_ag_charts_community85._Theme.DEFAULT_DIVERGING_SERIES_COLOUR_RANGE);
...
var { Label: Label7 } = import_ag_charts_community86._Scene;
var {
...
var TreemapSeriesGroup = class extends BaseProperties4 {
  constructor() {
    super(...arguments);
    this.fillOpacity = 1;
    this.strokeWidth = 1;
...
__decorateClass([
  Validate29(POSITIVE_NUMBER15, { optional: true })
...
var TreemapSeriesGroupHighlightStyle = class extends BaseProperties4 {
  constructor() {
    super(...arguments);
    this.label = new AutoSizedLabel();
  }
...
__decorateClass([
  Validate29(RATIO18, { optional: true })
...
var TreemapSeriesTileHighlightStyle = class extends BaseProperties4 {
  constructor() {
    super(...arguments);
    this.label = new AutoSizedLabel();
    this.secondaryLabel = new AutoSizeableSecondaryLabel();
...
__decorateClass([
  Validate29(FUNCTION10, { optional: true })
...
// packages/ag-charts-enterprise/src/series/treemap/treemapSeries.ts
var { Rect: Rect4, Group: Group8, BBox: BBox6, Selection: Selection5, Text: Text7 } = import_ag_charts_community87._Scene;
var { Color: Color2, Logger: Logger4, isEqual, sanitizeHtml: sanitizeHtml9 } = import_ag_charts_community87._Util;
var tempText = new Text7();
...
var _TreemapSeries = class _TreemapSeries extends import_ag_charts_community87._ModuleSupport.HierarchySeries {
  constructor() {
    super(...arguments);
    this.properties = new TreemapSeriesProperties();
    this.groupSelection = Selection5.select(this.contentGroup, Group8);
  ...
  groupTitleHeight(node, bbox) {
    var _a, _b;
    const label = (_b = (_a = this.labelData) == null ? void 0 : _a[node.index]) == null ? void 0 : _b.label;
  ...
  processData() {
    return __async(this, null, function* () {
      ...
      if (!((_a = this.data) == null ? void 0 : _a.length)) {
  ...
  squarify(node, bbox, outputBoxes) {
    ...
    const allLeafNodes = sortedChildrenIndices.every((index2) => childAt(index2).children.length === 0);
    ...
    const innerBox = new BBox6(bbox.x + padding.left, bbox.y + padding.top, width, height);
    ...
    for (let i = 0; i < numChildren; i++) {
      ...
      for (let j = startIndex; j < i; j++) {
        ...
        const childBbox = new BBox6(x, y, width2, height2);
    ...
    for (let i = startIndex; i < numChildren; i++) {
      ...
      const childBox = new BBox6(x, y, width2, height2);
  ...
  updateSelections() {
    return __async(this, null, function* () {
      ...
      this.nodeDataRefresh = false;
      const { seriesRect } = (_a = this.chart) != null ? _a : {};
      if (!seriesRect)
        return;
      const descendants = Array.from(this.rootNode);
      const updateGroup = (group) => {
  ...
  getTileFormat(node, isHighlighted) {
    ...
    const isLeaf = children.length === 0;
    const fill = (_a = isLeaf ? tile.fill : group.fill) != null ? _a : node.fill;
  ...
  getNodeFill(node) {
    ...
    if (isLeaf) {
      return (_a = this.properties.tile.fill) != null ? _a : node.fill;
    }
  ...
  getNodeStroke(node) {
    ...
    const isLeaf = node.children.length === 0;
    if (isLeaf) {
      return (_a = this.properties.tile.stroke) != null ? _a : node.stroke;
    }
  ...
  updateNodes() {
    return __async(this, null, function* () {
      ...
      this.squarify(rootNode, new BBox6(0, 0, width, height), bboxes);
      ...
      const updateRectFn = (node, rect, highlighted) => {
        ...
        const fill = (_b2 = (_a2 = format == null ? void 0 : format.fill) != null ? _a2 : highlightedFill) != null ? _b2 : this.getNodeFill(node);
      ...
      this.highlightSelection.selectByClass(Rect4).forEach((rect) => {
        ...
        rect.visible = isDatumHighlighted || ((_a2 = highlightedNode == null ? void 0 : highlightedNode.contains(rect.datum)) != null ? _a2 : false);
        if (rect.visible) {
      ...
      const labelMeta = Array.from(this.rootNode, (node) => {
        ...
        const labelDatum = (_a2 = this.labelData) == null ? void 0 : _a2[index];
        ...
        if (children.length === 0) {
          ...
          const { text } = Text7.wrap(labelDatum.label, bbox.width - 2 * padding, Infinity, group.label, "never");
      ...
      this.highlightSelection.selectByClass(Text7).forEach((text) => {
        ...
        text.visible = isDatumHighlighted || ((_a2 = highlightedNode == null ? void 0 : highlightedNode.contains(text.datum)) != null ? _a2 : false);
        if (text.visible) {
  ...
  getTooltipHtml(node) {
    ...
    const color = (_a = format == null ? void 0 : format.fill) != null ? _a : this.getNodeFill(node);
    if (!tooltip.renderer && !title) {
      return "";
    }
    const contentArray = [];
...
} = import_ag_charts_community88._Theme;
...
// packages/ag-charts-enterprise/src/series/waterfall/waterfallDefaults.ts
var import_ag_charts_community89 = require("ag-charts-community");
var { CARTESIAN_AXIS_TYPES: CARTESIAN_AXIS_TYPES6, CARTESIAN_AXIS_POSITIONS: CARTESIAN_AXIS_POSITIONS7 } = import_ag_charts_community89._Theme;
var WATERFALL_DEFAULTS = {
  axes: [
    {
      type: CARTESIAN_AXIS_TYPES6.CATEGORY,
      position: CARTESIAN_AXIS_POSITIONS7.BOTTOM
    },
    {
      type: CARTESIAN_AXIS_TYPES6.NUMBER,
      position: CARTESIAN_AXIS_POSITIONS7.LEFT
    }
  ],
  legend: {
    enabled: true,
...
var { DropShadow: DropShadow3, Label: Label8 } = import_ag_charts_community90._Scene;
var {
...
__decorateClass([
  Validate30(UNION4(["subtotal", "total"], "a total type"))
...
__decorateClass([
  Validate30(FUNCTION11, { optional: true })
...
__decorateClass([
  Validate30(UNION4(["start", "end", "inside"], "a placement"))
], WaterfallSeriesLabel.prototype, "placement", 2);
__decorateClass([
  Validate30(POSITIVE_NUMBER16)
...
var { ContinuousScale: ContinuousScale2, Rect: Rect5, motion: motion8 } = import_ag_charts_community91._Scene;
var { sanitizeHtml: sanitizeHtml10, isContinuous, isNumber: isNumber6 } = import_ag_charts_community91._Util;
var _WaterfallSeries = class _WaterfallSeries extends import_ag_charts_community91._ModuleSupport.AbstractBarSeries {
  constructor(moduleCtx) {
    super({
      moduleCtx,
  ...
  processData(dataController) {
    return __async(this, null, function* () {
      ...
      data.forEach((datum, i) => {
        ...
        (_a2 = totalsMap.get(i)) == null ? void 0 : _a2.forEach((total) => dataWithTotals.push(__spreadProps(__spreadValues({}, total.toJson()), { [xKey]: total.axisLabel })));
      });
      const isContinuousX = ContinuousScale2.is((_a = this.getCategoryAxis()) == null ? void 0 : _a.scale);
      const extraProps = [];
      if (!this.ctx.animationManager.isSkipped()) {
      ...
      const { processedData } = yield this.requestDataModel(dataController, dataWithTotals, {
        props: [
          ...
          ...isContinuousX ? [import_ag_charts_community91._ModuleSupport.SMALLEST_KEY_INTERVAL] : [],
          ...extraProps
        ],
        dataVisible: this.visible
      });
  ...
  getSeriesDomain(direction) {
    ...
    const {
      ...
      reduced: { [import_ag_charts_community91._ModuleSupport.SMALLEST_KEY_INTERVAL.property]: smallestX } = {}
    } = processedData;
    const keyDef = dataModel.resolveProcessedDataDefById(this, `xValue`);
    if (direction === this.getCategoryDirection()) {
      if ((keyDef == null ? void 0 : keyDef.def.type) === "key" && (keyDef == null ? void 0 : keyDef.def.valueType) === "category") {
      ...
      const scalePadding = smallestX != null && isFinite(smallestX) ? smallestX : 0;
      const keysExtent = (_a = import_ag_charts_community91._ModuleSupport.extent(keys)) != null ? _a : [NaN, NaN];
      const categoryAxis = this.getCategoryAxis();
      const isReversed = categoryAxis == null ? void 0 : categoryAxis.isReversed();
  ...
  createNodeData() {
    return __async(this, null, function* () {
      ...
      const barWidth = (_a = ContinuousScale2.is(xScale) ? xScale.calcBandwidth(smallestDataInterval == null ? void 0 : smallestDataInterval.x) : xScale.bandwidth) != null ? _a : 10;
  ...
  updateSeriesItemTypes() {
    ...
    const totalTypeIndex = dataModel.resolveProcessedDataIndexById(this, `totalTypeValue`).index;
    const positiveDomain = (_a = processedData.domain.values[yPositiveIndex]) != null ? _a : [];
  ...
  animateEmptyUpdateReady({ datumSelections, labelSelections, contextData, paths }) {
    const fns = prepareBarAnimationFunctions3(collapsedStartingBarPosition2(this.isVertical(), this.axes));
  ...
  animateConnectorLinesHorizontal(lineNode, pointData) {
    ...
    this.ctx.animationManager.animate({
      ...
      from: startX,
      to: endX,
      ease: import_ag_charts_community91._ModuleSupport.Motion.easeOut,
      onUpdate(pointX) {
        linePath.clear({ trackChanges: true });
  ...
  updateLineNode(lineNode) {
    ...
    lineNode.setProperties({
      ...
      lineDashOffset,
      lineJoin: "round",
      pointerEvents: import_ag_charts_community91._Scene.PointerEvents.None
    });
  }
  isLabelEnabled() {
...
var WATERFALL_SERIES_THEME = {
  __extends__: import_ag_charts_community92._Theme.EXTENDS_SERIES_DEFAULTS,
  item: {
    positive: {
      strokeWidth: 0,
      label: {
  ...
  line: {
    stroke: import_ag_charts_community92._Theme.DEFAULT_WATERFALL_SERIES_CONNECTOR_LINE_STROKE,
    strokeOpacity: 1,
    lineDash: [0],
    lineDashOffset: 0,
    strokeWidth: 2
...
var WaterfallModule = {
  ...
  paletteFactory: ({ takeColors, colorsCount, userPalette, themeTemplateParameters }) => {
    ...
    return userPalette ? {
      ...
      item: {
        positive: properties.get(import_ag_charts_community93._Theme.DEFAULT_WATERFALL_SERIES_POSITIVE_COLOURS),
        negative: properties.get(import_ag_charts_community93._Theme.DEFAULT_WATERFALL_SERIES_NEGATIVE_COLOURS),
        total: properties.get(import_ag_charts_community93._Theme.DEFAULT_WATERFALL_SERIES_TOTAL_COLOURS)
      }
    };
  }
};
...
import_ag_charts_community94._ModuleSupport.registerModule(AngleCategoryAxisModule);
import_ag_charts_community94._ModuleSupport.registerModule(AngleNumberAxisModule);
import_ag_charts_community94._ModuleSupport.registerModule(AnimationModule);
import_ag_charts_community94._ModuleSupport.registerModule(BackgroundModule);
import_ag_charts_community94._ModuleSupport.registerModule(BoxPlotModule);
import_ag_charts_community94._ModuleSupport.registerModule(BulletModule);
import_ag_charts_community94._ModuleSupport.registerModule(ContextMenuModule);
import_ag_charts_community94._ModuleSupport.registerModule(CrosshairModule);
import_ag_charts_community94._ModuleSupport.registerModule(ErrorBarsModule);
import_ag_charts_community94._ModuleSupport.registerModule(GradientLegendModule);
import_ag_charts_community94._ModuleSupport.registerModule(HeatmapModule);
import_ag_charts_community94._ModuleSupport.registerModule(NightingaleModule);
import_ag_charts_community94._ModuleSupport.registerModule(RadarAreaModule);
import_ag_charts_community94._ModuleSupport.registerModule(RadarLineModule);
import_ag_charts_community94._ModuleSupport.registerModule(RadialBarModule);
import_ag_charts_community94._ModuleSupport.registerModule(RadialColumnModule);
import_ag_charts_community94._ModuleSupport.registerModule(RadiusCategoryAxisModule);
import_ag_charts_community94._ModuleSupport.registerModule(RadiusNumberAxisModule);
import_ag_charts_community94._ModuleSupport.registerModule(RangeBarModule);
import_ag_charts_community94._ModuleSupport.registerModule(RangeAreaModule);
import_ag_charts_community94._ModuleSupport.registerModule(SunburstSeriesModule);
import_ag_charts_community94._ModuleSupport.registerModule(TreemapSeriesModule);
import_ag_charts_community94._ModuleSupport.registerModule(WaterfallModule);
import_ag_charts_community94._ModuleSupport.registerModule(ZoomModule);
import_ag_charts_community94._ModuleSupport.enterpriseModule.isEnterprise = true;
import_ag_charts_community94._ModuleSupport.enterpriseModule.licenseManager = (options) => {
  var _a, _b;
  return new LicenseManager((_b = (_a = options.container) == null ? void 0 : _a.ownerDocument) != null ? _b : typeof document !== "undefined" ? document : void 0);
};
import_ag_charts_community94._ModuleSupport.enterpriseModule.injectWatermark = injectWatermark;
