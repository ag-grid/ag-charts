...
__export(main_exports, {
  AgCharts: () => import_ag_charts_community96.AgCharts,
  time: () => import_ag_charts_community96.time
});
...
var { Image } = import_ag_charts_community14._Scene;
var { BaseProperties, ObserveChanges, ProxyProperty, Validate: Validate10, NUMBER: NUMBER3, POSITIVE_NUMBER: POSITIVE_NUMBER3, RATIO: RATIO4 } = import_ag_charts_community14._ModuleSupport;
...
// packages/ag-charts-enterprise/src/features/background/background.ts
var { ActionOnSet: ActionOnSet2, OBJECT, Validate: Validate11 } = import_ag_charts_community15._ModuleSupport;
var Background = class extends import_ag_charts_community15._ModuleSupport.Background {
  constructor(ctx) {
    super(ctx);
  ...
  onImageLoad() {
    this.updateService.update(import_ag_charts_community15._ModuleSupport.ChartUpdateType.SCENE_RENDER);
  }
};
__decorateClass([
...
// packages/ag-charts-enterprise/src/features/context-menu/contextMenu.ts
var { BOOLEAN: BOOLEAN4, Validate: Validate12 } = import_ag_charts_community16._ModuleSupport;
var _ContextMenu = class _ContextMenu extends import_ag_charts_community16._ModuleSupport.BaseModuleInstance {
  constructor(ctx) {
    ...
    const { Default: Default5, ContextMenu: ContextMenuState, All } = import_ag_charts_community16._ModuleSupport.InteractionState;
  ...
  show() {
    this.interactionManager.pushState(import_ag_charts_community16._ModuleSupport.InteractionState.ContextMenu);
  ...
  hide() {
    this.interactionManager.popState(import_ag_charts_community16._ModuleSupport.InteractionState.ContextMenu);
    if (this.menuElement) {
...
var ContextMenuModule = {
  ...
  themeTemplate: {
    contextMenu: {
      enabled: true,
      darkTheme: import_ag_charts_community17._Theme.IS_DARK_THEME
    }
  }
};
...
var { ActionOnSet: ActionOnSet3, BaseProperties: BaseProperties2, BOOLEAN: BOOLEAN5, FUNCTION, NUMBER: NUMBER4, STRING: STRING2, Validate: Validate13 } = import_ag_charts_community18._ModuleSupport;
var { BBox } = import_ag_charts_community18._Scene;
...
var _CrosshairLabel = class _CrosshairLabel extends BaseProperties2 {
  ...
  computeBBox() {
    const { element } = this;
    return new import_ag_charts_community18._Scene.BBox(element.clientLeft, element.clientTop, element.clientWidth, element.clientHeight);
  }
...
// packages/ag-charts-enterprise/src/features/crosshair/crosshair.ts
var { Group: Group3, Line, BBox: BBox2 } = import_ag_charts_community19._Scene;
var { POSITIVE_NUMBER: POSITIVE_NUMBER4, RATIO: RATIO5, BOOLEAN: BOOLEAN6, COLOR_STRING: COLOR_STRING2, LINE_DASH: LINE_DASH2, OBJECT: OBJECT2, Validate: Validate14, Layers: Layers3 } = import_ag_charts_community19._ModuleSupport;
var Crosshair = class extends import_ag_charts_community19._ModuleSupport.BaseModuleInstance {
  constructor(ctx) {
    var _a2, _b;
    super();
    this.ctx = ctx;
...
var AXIS_CROSSHAIR_THEME = {
  crosshair: {
    enabled: true,
    snap: true,
    stroke: import_ag_charts_community20._Theme.DEFAULT_MUTED_LABEL_COLOUR,
    strokeWidth: 1,
    strokeOpacity: 1,
    lineDash: [5, 6],
    lineDashOffset: 0,
...
var { BOOLEAN: BOOLEAN7, FUNCTION: FUNCTION2, ActionOnSet: ActionOnSet4, Validate: Validate15 } = import_ag_charts_community21._ModuleSupport;
var DataSource = class extends import_ag_charts_community21._ModuleSupport.BaseModuleInstance {
  constructor(ctx) {
    super();
    this.enabled = false;
...
var { partialAssign, mergeDefaults } = import_ag_charts_community22._ModuleSupport;
var { BBox: BBox3 } = import_ag_charts_community22._Scene;
...
var ErrorBarNode = class extends import_ag_charts_community22._Scene.Group {
  constructor() {
    super();
    this.capLength = NaN;
    this._datum = void 0;
    this.whiskerPath = new import_ag_charts_community22._Scene.Path();
    this.capsPath = new import_ag_charts_community22._Scene.Path();
...
var ErrorBarGroup = class extends import_ag_charts_community22._Scene.Group {
  get children() {
    return super.children;
  }
  nearestSquared(point) {
    const { nearest, distanceSquared } = import_ag_charts_community22._Scene.nearestSquaredInContainer(point, this);
...
function toErrorBoundCartesianSeries(ctx) {
  for (const supportedType of import_ag_charts_community24.AgErrorBarSupportedSeriesTypes) {
    if (supportedType == ctx.series.type) {
      return ctx.series;
    }
  }
  throw new Error(
    `AG Charts - unsupported series type '${ctx.series.type}', error bars supported series types: ${import_ag_charts_community24.AgErrorBarSupportedSeriesTypes.join(", ")}`
  );
}
var ErrorBars = class _ErrorBars extends import_ag_charts_community24._ModuleSupport.BaseModuleInstance {
  constructor(ctx) {
    super();
    ...
    this.groupNode = new ErrorBarGroup({
      ...
      zIndex: import_ag_charts_community24._ModuleSupport.Layers.SERIES_LAYER_ZINDEX,
      zIndexSubOrder: series.getGroupZIndexSubOrder("annotation")
    });
    annotationGroup.appendChild(this.groupNode);
    this.selection = import_ag_charts_community24._Scene.Selection.select(this.groupNode, () => this.errorBarFactory());
  ...
  static getDatumKey(datum, key, offset) {
    ...
    if (typeof value !== "number") {
      import_ag_charts_community24._Util.Logger.warnOnce(`Found [${key}] error value of type ${typeof value}. Expected number type`);
      return void 0;
    }
    return value + offset;
  }
...
var ERROR_BARS_THEME = {
  series: {
    errorBar: {
      visible: true,
      stroke: import_ag_charts_community25._Theme.DEFAULT_LABEL_COLOUR,
      strokeWidth: 1,
      strokeOpacity: 1,
      cap: {
        length: void 0,
...
var ErrorBarsModule = {
  ...
  packageType: "enterprise",
  chartTypes: ["cartesian"],
  seriesTypes: import_ag_charts_community26.AgErrorBarSupportedSeriesTypes,
...
var { Validate: Validate17, BOOLEAN: BOOLEAN9, POSITIVE_NUMBER: POSITIVE_NUMBER6, Layers: Layers4, ActionOnSet: ActionOnSet5, CategoryAxis, GroupedCategoryAxis } = import_ag_charts_community27._ModuleSupport;
var { toRadians: toRadians4, Padding, Logger } = import_ag_charts_community27._Util;
var { Text: Text4, Group: Group4, BBox: BBox4 } = import_ag_charts_community27._Scene;
...
var MiniChart = class extends import_ag_charts_community27._ModuleSupport.BaseModuleInstance {
  constructor() {
    super(...arguments);
    this.enabled = false;
...
// packages/ag-charts-enterprise/src/features/navigator/navigator.ts
var { ObserveChanges: ObserveChanges2 } = import_ag_charts_community28._ModuleSupport;
var _Navigator = class _Navigator extends import_ag_charts_community28._ModuleSupport.Navigator {
  constructor() {
    super(...arguments);
...
var NavigatorModule = {
  ...
  themeTemplate: __spreadProps(__spreadValues({}, import_ag_charts_community29._ModuleSupport.NavigatorModule.themeTemplate), {
    navigator: __spreadProps(__spreadValues({}, (_a = import_ag_charts_community29._ModuleSupport.NavigatorModule.themeTemplate) == null ? void 0 : _a.navigator), {
      miniChart: {
        enabled: false,
        label: {
          color: import_ag_charts_community29._Theme.DEFAULT_LABEL_COLOUR,
          fontStyle: void 0,
          fontWeight: void 0,
          fontSize: 10,
          fontFamily: import_ag_charts_community29._Theme.DEFAULT_FONT_FAMILY,
          formatter: void 0,
          padding: 0
        },
        padding: {
...
var {
  ...
  Validate: Validate18
} = import_ag_charts_community30._ModuleSupport;
var { Logger: Logger2 } = import_ag_charts_community30._Util;
...
var { COLOR_STRING: COLOR_STRING4, RATIO: RATIO7, Validate: Validate19 } = import_ag_charts_community31._ModuleSupport;
var ZoomRect = class extends import_ag_charts_community31._Scene.Rect {
  constructor() {
    super(...arguments);
...
var { clamp } = import_ag_charts_community32._ModuleSupport;
...
var ZoomAxisDragger = class {
  ...
  update(event, direction, anchor, bbox, zoom, axisZoom) {
    ...
    (_a2 = this.oldZoom) != null ? _a2 : this.oldZoom = definedZoomState(
      direction === import_ag_charts_community33._ModuleSupport.ChartAxisDirection.X ? __spreadProps(__spreadValues({}, zoom), { x: axisZoom }) : __spreadProps(__spreadValues({}, zoom), { y: axisZoom })
    );
  ...
  updateZoom(direction, anchor, bbox) {
    ...
    if (!coords || !oldZoom) {
      if (direction === import_ag_charts_community33._ModuleSupport.ChartAxisDirection.X)
        return newZoom.x;
      return newZoom.y;
    }
...
var ZoomPanner = class {
  ...
  translateZooms(bbox, currentZooms, coords) {
    ...
    for (const [axisId, { direction, zoom: currentZoom }] of Object.entries(currentZooms)) {
      let zoom;
      if (direction === import_ag_charts_community34._ModuleSupport.ChartAxisDirection.X) {
...
var Zoom = class extends import_ag_charts_community35._ModuleSupport.BaseModuleInstance {
  constructor(ctx) {
    var _a2;
    super();
    this.ctx = ctx;
    ...
    const { Default: Default5, ZoomDrag, Animation: Animation2 } = import_ag_charts_community35._ModuleSupport.InteractionState;
  ...
  onDrag(event) {
    if (!this.enabled || !this.paddedRect || !this.seriesRect)
      return;
    this.ctx.interactionManager.pushState(import_ag_charts_community35._ModuleSupport.InteractionState.ZoomDrag);
    const sourceEvent = event.sourceEvent;
    ...
    if (this.enableAxisDragging && this.hoveredAxis) {
      ...
      const anchor = direction === import_ag_charts_community35._ModuleSupport.ChartAxisDirection.X ? this.anchorPointX : this.anchorPointY;
  ...
  onDragEnd() {
    this.ctx.interactionManager.popState(import_ag_charts_community35._ModuleSupport.InteractionState.ZoomDrag);
  ...
  onWheel(event) {
    ...
    if (isAxisScrolling) {
      isScalingX = this.hoveredAxis.direction === import_ag_charts_community35._ModuleSupport.ChartAxisDirection.X;
...
} = import_ag_charts_community36._ModuleSupport;
var { BBox: BBox5, Group: Group5, Rect, LinearGradientFill, Triangle } = import_ag_charts_community36._Scene;
var { createId: createId2, Logger: Logger3 } = import_ag_charts_community36._Util;
...
var GradientLegendAxisTick = class extends import_ag_charts_community36._ModuleSupport.AxisTick {
  constructor() {
    super(...arguments);
    this.enabled = false;
    this.size = 0;
...
var GradientLegendAxis = class extends import_ag_charts_community36._ModuleSupport.CartesianAxis {
  constructor(ctx) {
    super(ctx, new import_ag_charts_community36._Scale.LinearScale(), { respondsToZoom: false });
    this.colorDomain = [];
    this.nice = false;
...
var GRADIENT_LEGEND_THEME = {
  ...
  scale: {
    padding: 8,
    label: {
      color: import_ag_charts_community37._Theme.DEFAULT_LABEL_COLOUR,
      fontStyle: void 0,
      fontWeight: void 0,
      fontSize: 12,
      fontFamily: import_ag_charts_community37._Theme.DEFAULT_FONT_FAMILY,
      formatter: void 0
    },
    interval: {
      minSpacing: 1
...
var { injectStyle } = import_ag_charts_community38._ModuleSupport;
var watermarkStyles = `
.ag-watermark {
    position: absolute;
    bottom: 20px;
...
var BoxPlotGroup = class extends import_ag_charts_community39._Scene.Group {
  constructor() {
    super();
    this.append([
      new import_ag_charts_community39._Scene.Rect({ tag: 0 /* Box */ }),
      new import_ag_charts_community39._Scene.Rect({ tag: 0 /* Box */ }),
      new import_ag_charts_community39._Scene.Rect({ tag: 2 /* Outline */ }),
      new import_ag_charts_community39._Scene.Rect({ tag: 1 /* Median */ }),
      new import_ag_charts_community39._Scene.Line({ tag: 3 /* Whisker */ }),
      new import_ag_charts_community39._Scene.Line({ tag: 3 /* Whisker */ }),
      new import_ag_charts_community39._Scene.Line({ tag: 4 /* Cap */ }),
      new import_ag_charts_community39._Scene.Line({ tag: 4 /* Cap */ })
    ]);
  }
  updateDatumStyles(datum, activeStyles, isVertical, isReversedValueAxis) {
    ...
    const selection = import_ag_charts_community39._Scene.Selection.select(this, import_ag_charts_community39._Scene.Rect);
    ...
    if (isVertical) {
      import_ag_charts_community39._ModuleSupport.invertShapeDirection(outline, median, ...boxes, ...caps, ...whiskers);
    }
...
var { motion } = import_ag_charts_community41._Scene;
var BoxPlotSeriesNodeClickEvent = class extends import_ag_charts_community41._ModuleSupport.SeriesNodeClickEvent {
...
var _BoxPlotSeries = class _BoxPlotSeries extends import_ag_charts_community41._ModuleSupport.AbstractBarSeries {
  constructor(moduleCtx) {
    super({
      moduleCtx,
     ...
     */
    this.groupScale = new import_ag_charts_community41._Scale.BandScale();
  ...
  processData(dataController) {
    return __async(this, null, function* () {
      ...
      const isContinuousX = ((_a2 = this.getCategoryAxis()) == null ? void 0 : _a2.scale) instanceof import_ag_charts_community41._Scale.ContinuousScale;
      const extraProps = [];
  ...
  createNodeData() {
    return __async(this, null, function* () {
      ...
      const xBandWidth = xAxis.scale instanceof import_ag_charts_community41._Scale.ContinuousScale ? xAxis.scale.calcBandwidth(smallestDataInterval == null ? void 0 : smallestDataInterval.x) : xAxis.scale.bandwidth;
      const domain = [];
      ...
      if (xAxis instanceof import_ag_charts_community41._ModuleSupport.CategoryAxis) {
  ...
  getTooltipHtml(nodeDatum) {
    ...
    if (!xAxis || !yAxis || !this.properties.isValid())
      return "";
    const title = import_ag_charts_community41._Util.sanitizeHtml(yName);
    const contentData = [
      [xKey, xName, xAxis],
    ...
    const content = contentData.map(([key, name, axis]) => import_ag_charts_community41._Util.sanitizeHtml(`${name != null ? name : key}: ${axis.formatDatum(datum[key])}`)).join(title ? "<br/>" : ", ");
...
var BOX_PLOT_SERIES_THEME = {
  series: {
    __extends__: import_ag_charts_community42._Theme.EXTENDS_SERIES_DEFAULTS,
    direction: "vertical",
    strokeWidth: 2
  },
  axes: {
    [import_ag_charts_community42._Theme.CARTESIAN_AXIS_TYPE.NUMBER]: {
      crosshair: {
        snap: false
      }
    },
    [import_ag_charts_community42._Theme.CARTESIAN_AXIS_TYPE.CATEGORY]: {
...
var BoxPlotModule = {
  ...
  seriesDefaults: {
    axes: [
      {
        type: import_ag_charts_community43._Theme.CARTESIAN_AXIS_TYPE.NUMBER,
        position: import_ag_charts_community43._Theme.POSITION.LEFT
      },
      {
        type: import_ag_charts_community43._Theme.CARTESIAN_AXIS_TYPE.CATEGORY,
        position: import_ag_charts_community43._Theme.POSITION.BOTTOM
      }
    ]
  },
  ...
  paletteFactory: ({ takeColors, userPalette, themeTemplateParameters }) => {
    var _a2;
    const themeBackgroundColor = themeTemplateParameters.properties.get(import_ag_charts_community43._Theme.DEFAULT_BACKGROUND_COLOUR);
    ...
    return {
      fill: userPalette ? fill : import_ag_charts_community43._Util.Color.interpolate(fill, backgroundFill)(0.7),
      stroke
    };
  },
...
var { fromToMotion } = import_ag_charts_community45._Scene.motion;
var { sanitizeHtml } = import_ag_charts_community45._Util;
var STYLING_KEYS = [
  "fill",
  "fillOpacity",
  "stroke",
...
var BulletSeries = class _BulletSeries extends import_ag_charts_community45._ModuleSupport.AbstractBarSeries {
  constructor(moduleCtx) {
    super({
      moduleCtx,
      pickModes: [import_ag_charts_community45._ModuleSupport.SeriesNodePickMode.EXACT_SHAPE_MATCH],
      hasHighlightedLabels: true,
      animationResetFns: {
    ...
    this.colorRangesGroup = new import_ag_charts_community45._Scene.Group({ name: `${this.id}-colorRanges` });
    this.colorRangesSelection = import_ag_charts_community45._Scene.Selection.select(this.colorRangesGroup, import_ag_charts_community45._Scene.Rect, false);
    this.rootGroup.append(this.colorRangesGroup);
    this.targetLinesSelection = import_ag_charts_community45._Scene.Selection.select(this.annotationGroup, import_ag_charts_community45._Scene.Line, false);
  }
  destroy() {
  ...
  processData(dataController) {
    return __async(this, null, function* () {
      ...
      const isContinuousX = import_ag_charts_community45._Scale.ContinuousScale.is((_a2 = this.getCategoryAxis()) == null ? void 0 : _a2.scale);
      const isContinuousY = import_ag_charts_community45._Scale.ContinuousScale.is((_b = this.getValueAxis()) == null ? void 0 : _b.scale);
      const extraProps = [];
      if (targetKey !== void 0) {
    ...
    return __async(this, null, function* () {
      ...
      for (const { datum, values } of processedData.data) {
        ...
        if (values[0][valueIndex] < 0) {
          import_ag_charts_community45._Util.Logger.warnOnce("negative values are not supported, clipping to 0.");
        }
        ...
        const barAlongX = this.getBarDirection() === import_ag_charts_community45._ModuleSupport.ChartAxisDirection.X;
        const rect = {
        ...
        if (values[0][targetIndex] < 0) {
          import_ag_charts_community45._Util.Logger.warnOnce("negative targets are not supported, ignoring.");
        }
  ...
  getColorRanges() {
    ...
    defaultColorRange.color = import_ag_charts_community45._Util.Color.interpolate(fill, backgroundFill)(0.7);
  ...
  nodeFactory() {
    return new import_ag_charts_community45._Scene.Rect();
  }
  updateDatumSelection(opts) {
    return __async(this, null, function* () {
  ...
  updateColorRanges() {
    return __async(this, null, function* () {
      ...
      const computeRect = this.getBarDirection() === import_ag_charts_community45._ModuleSupport.ChartAxisDirection.Y ? (rect, colorRange) => {
        rect.x = min;
...
var BULLET_SERIES_THEME = {
  ...
  axes: {
    [import_ag_charts_community46._Theme.CARTESIAN_AXIS_TYPE.NUMBER]: {
      nice: false,
      crosshair: {
        enabled: false
      }
...
var BulletModule = {
  ...
  seriesDefaults: {
    axes: [
      {
        type: import_ag_charts_community47._Theme.CARTESIAN_AXIS_TYPE.NUMBER,
        position: import_ag_charts_community47._Theme.POSITION.LEFT
      },
      {
        type: import_ag_charts_community47._Theme.CARTESIAN_AXIS_TYPE.CATEGORY,
        position: import_ag_charts_community47._Theme.POSITION.BOTTOM
      }
    ]
  },
  ...
  paletteFactory: ({ takeColors, colorsCount, themeTemplateParameters }) => {
    ...
    const themeBackgroundColor = themeTemplateParameters.properties.get(import_ag_charts_community47._Theme.DEFAULT_BACKGROUND_COLOUR);
    const backgroundFill = (_a2 = Array.isArray(themeBackgroundColor) ? themeBackgroundColor[0] : themeBackgroundColor) != null ? _a2 : "white";
    const targetStroke = properties.get(import_ag_charts_community47._Theme.DEFAULT_CROSS_LINES_COLOUR);
    return {
      fill,
      stroke,
...
var { Validate: Validate24, NUMBER: NUMBER7, TEXT_WRAP, OVERFLOW_STRATEGY } = import_ag_charts_community48._ModuleSupport;
var { Logger: Logger4 } = import_ag_charts_community48._Util;
var { Text: Text5, Label } = import_ag_charts_community48._Scene;
...
// packages/ag-charts-enterprise/src/series/heatmap/heatmapSeries.ts
var { SeriesNodePickMode: SeriesNodePickMode2, getMissCount, valueProperty: valueProperty4, ChartAxisDirection: ChartAxisDirection9 } = import_ag_charts_community50._ModuleSupport;
var { Rect: Rect2, PointerEvents } = import_ag_charts_community50._Scene;
var { ColorScale } = import_ag_charts_community50._Scale;
var { sanitizeHtml: sanitizeHtml2, Color, Logger: Logger5 } = import_ag_charts_community50._Util;
var HeatmapSeriesNodeClickEvent = class extends import_ag_charts_community50._ModuleSupport.CartesianSeriesNodeClickEvent {
  constructor(type, nativeEvent, datum, series) {
    super(type, nativeEvent, datum, series);
...
var _HeatmapSeries = class _HeatmapSeries extends import_ag_charts_community50._ModuleSupport.CartesianSeries {
  constructor(moduleCtx) {
    super({
      moduleCtx,
...
var HEATMAP_SERIES_THEME = {
  series: {
    __extends__: import_ag_charts_community51._Theme.EXTENDS_SERIES_DEFAULTS,
    label: {
      __overrides__: import_ag_charts_community51._Theme.OVERRIDE_SERIES_LABEL_DEFAULTS,
      enabled: false,
      color: import_ag_charts_community51._Theme.DEFAULT_LABEL_COLOUR,
      fontSize: import_ag_charts_community51._Theme.FONT_SIZE.SMALL,
      fontFamily: import_ag_charts_community51._Theme.DEFAULT_FONT_FAMILY,
      wrapping: "on-space",
...
var HeatmapModule = {
  ...
  seriesDefaults: {
    axes: [
      {
        type: import_ag_charts_community52._Theme.CARTESIAN_AXIS_TYPE.CATEGORY,
        position: import_ag_charts_community52._Theme.POSITION.LEFT
      },
      {
        type: import_ag_charts_community52._Theme.CARTESIAN_AXIS_TYPE.CATEGORY,
        position: import_ag_charts_community52._Theme.POSITION.BOTTOM
      }
    ]
  },
  ...
  paletteFactory: ({ takeColors, colorsCount, userPalette, themeTemplateParameters }) => {
    var _a2;
    const { properties } = themeTemplateParameters;
    const defaultColorRange = properties.get(import_ag_charts_community52._Theme.DEFAULT_DIVERGING_SERIES_COLOUR_RANGE);
    const defaultBackgroundColor = properties.get(import_ag_charts_community52._Theme.DEFAULT_BACKGROUND_COLOUR);
...
var { BandScale: BandScale3 } = import_ag_charts_community53._Scale;
var { motion: motion2 } = import_ag_charts_community53._Scene;
var { isNumber, normalizeAngle360: normalizeAngle3605, sanitizeHtml: sanitizeHtml3 } = import_ag_charts_community53._Util;
var RadialColumnSeriesNodeClickEvent = class extends import_ag_charts_community53._ModuleSupport.SeriesNodeClickEvent {
  constructor(type, nativeEvent, datum, series) {
    super(type, nativeEvent, datum, series);
...
var RadialColumnSeriesBase = class extends import_ag_charts_community53._ModuleSupport.PolarSeries {
  constructor(moduleCtx, {
    animationResetFns
  }) {
    super({
...
var { Label: Label2 } = import_ag_charts_community54._Scene;
var {
  SeriesProperties,
...
var { motion: motion3 } = import_ag_charts_community55._Scene;
...
// packages/ag-charts-enterprise/src/series/nightingale/nightingaleUtil.ts
var { motion: motion4 } = import_ag_charts_community56._Scene;
...
// packages/ag-charts-enterprise/src/series/nightingale/nightingaleSeries.ts
var { Sector: Sector3 } = import_ag_charts_community57._Scene;
...
var NIGHTINGALE_SERIES_THEME = {
  series: {
    __extends__: import_ag_charts_community58._Theme.EXTENDS_SERIES_DEFAULTS,
    strokeWidth: 1,
    label: {
      enabled: false,
      fontSize: 12,
      fontFamily: import_ag_charts_community58._Theme.DEFAULT_FONT_FAMILY,
      color: import_ag_charts_community58._Theme.DEFAULT_LABEL_COLOUR,
      __overrides__: import_ag_charts_community58._Theme.OVERRIDE_SERIES_LABEL_DEFAULTS
    }
  },
  axes: {
    [import_ag_charts_community58._Theme.POLAR_AXIS_TYPE.ANGLE_CATEGORY]: {
      shape: import_ag_charts_community58._Theme.POLAR_AXIS_SHAPE.CIRCLE,
      groupPaddingInner: 0,
      paddingInner: 0,
      label: {
        padding: 10
    ...
    [import_ag_charts_community58._Theme.POLAR_AXIS_TYPE.RADIUS_NUMBER]: {
      shape: import_ag_charts_community58._Theme.POLAR_AXIS_SHAPE.CIRCLE
    }
  }
};
...
var NightingaleModule = {
  ...
  seriesDefaults: {
    axes: [
      {
        type: import_ag_charts_community59._Theme.POLAR_AXIS_TYPE.ANGLE_CATEGORY
      },
      {
        type: import_ag_charts_community59._Theme.POLAR_AXIS_TYPE.RADIUS_NUMBER
      }
    ]
  },
  ...
  paletteFactory({ takeColors, userPalette }) {
    ...
    return {
      fill,
      stroke: userPalette ? stroke : import_ag_charts_community59._Theme.DEFAULT_POLAR_SERIES_STROKE
    };
  },
  stackable: true,
  groupable: true,
...
var BASE_RADAR_SERIES_THEME = {
  series: {
    __extends__: import_ag_charts_community60._Theme.EXTENDS_SERIES_DEFAULTS,
    label: {
      enabled: false,
      fontSize: 12,
      fontFamily: import_ag_charts_community60._Theme.DEFAULT_FONT_FAMILY,
      color: import_ag_charts_community60._Theme.DEFAULT_LABEL_COLOUR,
      __overrides__: import_ag_charts_community60._Theme.OVERRIDE_SERIES_LABEL_DEFAULTS
    },
    marker: {
      enabled: true,
      fillOpacity: 1,
  ...
  axes: {
    [import_ag_charts_community60._Theme.POLAR_AXIS_TYPE.ANGLE_CATEGORY]: {
      label: {
        padding: 10
      }
    }
...
var RADAR_LINE_SERIES_THEME = import_ag_charts_community60._ModuleSupport.mergeDefaults(
  {
    series: {
      strokeWidth: 2
    }
...
var RADAR_AREA_SERIES_THEME = import_ag_charts_community60._ModuleSupport.mergeDefaults(
  {
    series: {
      fillOpacity: 0.8,
      strokeWidth: 2,
...
var { Label: Label3 } = import_ag_charts_community61._Scene;
var {
  SeriesMarker,
...
var { BBox: BBox6, Group: Group6, Path: Path5, PointerEvents: PointerEvents2, Selection: Selection2, Text: Text6, getMarker } = import_ag_charts_community62._Scene;
var { extent: extent2, isNumber: isNumber2, isNumberEqual: isNumberEqual8, sanitizeHtml: sanitizeHtml4, toFixed } = import_ag_charts_community62._Util;
var RadarSeriesNodeClickEvent = class extends import_ag_charts_community62._ModuleSupport.SeriesNodeClickEvent {
  constructor(type, nativeEvent, datum, series) {
    super(type, nativeEvent, datum, series);
    this.angleKey = series.properties.angleKey;
    this.radiusKey = series.properties.radiusKey;
...
var RadarSeries = class extends import_ag_charts_community62._ModuleSupport.PolarSeries {
  constructor(moduleCtx) {
    super({
      moduleCtx,
      useLabelLayer: true,
...
var { RATIO: RATIO14, COLOR_STRING: COLOR_STRING10, Validate: Validate28 } = import_ag_charts_community63._ModuleSupport;
...
// packages/ag-charts-enterprise/src/series/radar-area/radarAreaSeries.ts
var { Group: Group7, Path: Path6, PointerEvents: PointerEvents3, Selection: Selection3 } = import_ag_charts_community64._Scene;
var { ChartAxisDirection: ChartAxisDirection12 } = import_ag_charts_community64._ModuleSupport;
var RadarAreaSeries = class extends RadarSeries {
  ...
  getAreaPoints() {
    ...
    const getPolarAxis = (direction) => {
      ...
      return axis instanceof import_ag_charts_community64._ModuleSupport.PolarAxis ? axis : void 0;
    };
...
// packages/ag-charts-enterprise/src/series/radar-area/radarAreaModule.ts
var { markerPaletteFactory } = import_ag_charts_community65._ModuleSupport;
var RadarAreaModule = {
  type: "series",
  optionsKey: "series[]",
  packageType: "enterprise",
  ...
  seriesDefaults: {
    axes: [
      {
        type: import_ag_charts_community65._Theme.POLAR_AXIS_TYPE.ANGLE_CATEGORY
      },
      {
        type: import_ag_charts_community65._Theme.POLAR_AXIS_TYPE.RADIUS_NUMBER
      }
    ]
  },
...
var RadarLineModule = {
  ...
  seriesDefaults: {
    axes: [
      {
        type: import_ag_charts_community66._Theme.POLAR_AXIS_TYPE.ANGLE_CATEGORY
      },
      {
        type: import_ag_charts_community66._Theme.POLAR_AXIS_TYPE.RADIUS_NUMBER
      }
    ]
  },
...
var { Label: Label4 } = import_ag_charts_community67._Scene;
var {
...
var { motion: motion5 } = import_ag_charts_community68._Scene;
...
var { BandScale: BandScale4 } = import_ag_charts_community69._Scale;
var { Sector: Sector4, motion: motion6 } = import_ag_charts_community69._Scene;
var { angleBetween: angleBetween3, isNumber: isNumber3, sanitizeHtml: sanitizeHtml5 } = import_ag_charts_community69._Util;
var RadialBarSeriesNodeClickEvent = class extends import_ag_charts_community69._ModuleSupport.SeriesNodeClickEvent {
  constructor(type, nativeEvent, datum, series) {
    super(type, nativeEvent, datum, series);
    this.angleKey = series.properties.angleKey;
    this.radiusKey = series.properties.radiusKey;
...
var RadialBarSeries = class extends import_ag_charts_community69._ModuleSupport.PolarSeries {
  constructor(moduleCtx) {
    super({
      moduleCtx,
      useLabelLayer: true,
...
var RADIAL_BAR_SERIES_THEME = {
  series: {
    __extends__: import_ag_charts_community70._Theme.EXTENDS_SERIES_DEFAULTS,
    strokeWidth: 0,
    label: {
      enabled: false,
      fontSize: 12,
      fontFamily: import_ag_charts_community70._Theme.DEFAULT_FONT_FAMILY,
      color: import_ag_charts_community70._Theme.DEFAULT_INVERTED_LABEL_COLOUR,
      __overrides__: import_ag_charts_community70._Theme.OVERRIDE_SERIES_LABEL_DEFAULTS
    }
  },
  axes: {
    [import_ag_charts_community70._Theme.POLAR_AXIS_TYPE.RADIUS_CATEGORY]: {
...
var RadialBarModule = {
  ...
  seriesDefaults: {
    axes: [
      {
        type: import_ag_charts_community71._Theme.POLAR_AXIS_TYPE.ANGLE_NUMBER
      },
      {
        type: import_ag_charts_community71._Theme.POLAR_AXIS_TYPE.RADIUS_CATEGORY
      }
    ]
  },
...
var { Validate: Validate30, RATIO: RATIO16 } = import_ag_charts_community72._ModuleSupport;
...
// packages/ag-charts-enterprise/src/series/radial-column/radialColumnSeries.ts
var { ChartAxisDirection: ChartAxisDirection14, PolarAxis: PolarAxis4 } = import_ag_charts_community73._ModuleSupport;
var { RadialColumnShape, getRadialColumnWidth } = import_ag_charts_community73._Scene;
...
var RADIAL_COLUMN_SERIES_THEME = {
  series: {
    __extends__: import_ag_charts_community74._Theme.EXTENDS_SERIES_DEFAULTS,
    ...
    label: {
      enabled: false,
      fontSize: 12,
      fontFamily: import_ag_charts_community74._Theme.DEFAULT_FONT_FAMILY,
      color: import_ag_charts_community74._Theme.DEFAULT_LABEL_COLOUR,
      __overrides__: import_ag_charts_community74._Theme.OVERRIDE_SERIES_LABEL_DEFAULTS
    }
  },
  axes: {
    [import_ag_charts_community74._Theme.POLAR_AXIS_TYPE.ANGLE_CATEGORY]: {
      shape: import_ag_charts_community74._Theme.POLAR_AXIS_SHAPE.CIRCLE,
      groupPaddingInner: 0,
      paddingInner: 0,
      label: {
        padding: 10
    ...
    [import_ag_charts_community74._Theme.POLAR_AXIS_TYPE.RADIUS_NUMBER]: {
      shape: import_ag_charts_community74._Theme.POLAR_AXIS_SHAPE.CIRCLE,
...
var RadialColumnModule = {
  ...
  seriesDefaults: {
    axes: [
      {
        type: import_ag_charts_community75._Theme.POLAR_AXIS_TYPE.ANGLE_CATEGORY
      },
      {
        type: import_ag_charts_community75._Theme.POLAR_AXIS_TYPE.RADIUS_NUMBER
      }
    ]
  },
...
var { DropShadow, Label: Label5 } = import_ag_charts_community76._Scene;
var {
  ...
  RATIO: RATIO17,
  STRING: STRING11
} = import_ag_charts_community76._ModuleSupport;
...
var { getMarker: getMarker2, PointerEvents: PointerEvents4 } = import_ag_charts_community77._Scene;
var { sanitizeHtml: sanitizeHtml6, extent: extent3, isNumber: isNumber4 } = import_ag_charts_community77._Util;
var DEFAULT_DIRECTION_KEYS = {
  [import_ag_charts_community77._ModuleSupport.ChartAxisDirection.X]: ["xKey"],
  [import_ag_charts_community77._ModuleSupport.ChartAxisDirection.Y]: ["yLowKey", "yHighKey"]
};
var DEFAULT_DIRECTION_NAMES = {
  [ChartAxisDirection15.X]: ["xName"],
  [ChartAxisDirection15.Y]: ["yLowName", "yHighName", "yName"]
};
var RangeAreaSeriesNodeClickEvent = class extends import_ag_charts_community77._ModuleSupport.SeriesNodeClickEvent {
  constructor(type, nativeEvent, datum, series) {
    super(type, nativeEvent, datum, series);
    this.xKey = series.properties.xKey;
...
var _RangeAreaSeries = class _RangeAreaSeries extends import_ag_charts_community77._ModuleSupport.CartesianSeries {
  constructor(moduleCtx) {
    super({
      moduleCtx,
      hasMarkers: true,
  ...
  nodeFactory() {
    return new import_ag_charts_community77._Scene.Group();
  }
...
var RANGE_AREA_SERIES_THEME = {
  series: {
    __extends__: import_ag_charts_community78._Theme.EXTENDS_SERIES_DEFAULTS,
    fillOpacity: 0.7,
    nodeClickRange: "nearest",
    marker: {
      __extends__: import_ag_charts_community78._Theme.EXTENDS_CARTESIAN_MARKER_DEFAULTS,
      enabled: false,
      fillOpacity: 1,
      strokeWidth: 2,
      size: 6
    ...
    label: {
      ...
      padding: 10,
      fontSize: 12,
      fontFamily: import_ag_charts_community78._Theme.DEFAULT_FONT_FAMILY,
      color: import_ag_charts_community78._Theme.DEFAULT_LABEL_COLOUR,
      __overrides__: import_ag_charts_community78._Theme.OVERRIDE_SERIES_LABEL_DEFAULTS
    }
  },
  axes: {
    [import_ag_charts_community78._Theme.CARTESIAN_AXIS_TYPE.NUMBER]: {
      crosshair: {
        enabled: true,
        snap: false
      }
...
// packages/ag-charts-enterprise/src/series/range-area/rangeAreaModule.ts
var { markerPaletteFactory: markerPaletteFactory2 } = import_ag_charts_community79._ModuleSupport;
var RangeAreaModule = {
  type: "series",
  optionsKey: "series[]",
  packageType: "enterprise",
  ...
  seriesDefaults: {
    axes: [
      {
        type: import_ag_charts_community79._Theme.CARTESIAN_AXIS_TYPE.NUMBER,
        position: import_ag_charts_community79._Theme.POSITION.LEFT,
        crosshair: {
          enabled: true,
          snap: false
        }
      ...
      {
        type: import_ag_charts_community79._Theme.CARTESIAN_AXIS_TYPE.CATEGORY,
        position: import_ag_charts_community79._Theme.POSITION.BOTTOM
      }
    ]
  },
...
var { DropShadow: DropShadow2, Label: Label6 } = import_ag_charts_community80._Scene;
var {
...
} = import_ag_charts_community81._ModuleSupport;
var { ContinuousScale, BandScale: BandScale5, Rect: Rect3, PointerEvents: PointerEvents5, motion: motion7 } = import_ag_charts_community81._Scene;
var { sanitizeHtml: sanitizeHtml7, isNumber: isNumber5, extent: extent4 } = import_ag_charts_community81._Util;
var DEFAULT_DIRECTION_KEYS2 = {
  [import_ag_charts_community81._ModuleSupport.ChartAxisDirection.X]: ["xKey"],
  [import_ag_charts_community81._ModuleSupport.ChartAxisDirection.Y]: ["yLowKey", "yHighKey"]
};
var DEFAULT_DIRECTION_NAMES2 = {
  [ChartAxisDirection16.X]: ["xName"],
  [ChartAxisDirection16.Y]: ["yLowName", "yHighName", "yName"]
};
var RangeBarSeriesNodeClickEvent = class extends import_ag_charts_community81._ModuleSupport.SeriesNodeClickEvent {
  constructor(type, nativeEvent, datum, series) {
    super(type, nativeEvent, datum, series);
    this.xKey = series.properties.xKey;
    this.yLowKey = series.properties.yLowKey;
...
var _RangeBarSeries = class _RangeBarSeries extends import_ag_charts_community81._ModuleSupport.AbstractBarSeries {
  constructor(moduleCtx) {
    super({
      moduleCtx,
...
var RANGE_BAR_SERIES_THEME = {
  ...
  axes: {
    [import_ag_charts_community82._Theme.CARTESIAN_AXIS_TYPE.NUMBER]: {
      crosshair: {
        enabled: true,
        snap: false
      }
...
var RangeBarModule = {
  ...
  seriesDefaults: {
    axes: [
      {
        type: import_ag_charts_community83._Theme.CARTESIAN_AXIS_TYPE.CATEGORY,
        position: import_ag_charts_community83._Theme.POSITION.BOTTOM
      },
      {
        type: import_ag_charts_community83._Theme.CARTESIAN_AXIS_TYPE.NUMBER,
        position: import_ag_charts_community83._Theme.POSITION.LEFT
      }
    ]
  },
...
// packages/ag-charts-enterprise/src/series/sunburst/sunburstSeries.ts
var { fromToMotion: fromToMotion2 } = import_ag_charts_community85._ModuleSupport;
var { Sector: Sector5, Group: Group8, Selection: Selection4, Text: Text7 } = import_ag_charts_community85._Scene;
var { sanitizeHtml: sanitizeHtml8 } = import_ag_charts_community85._Util;
...
var _SunburstSeries = class _SunburstSeries extends import_ag_charts_community85._ModuleSupport.HierarchySeries {
  constructor() {
    super(...arguments);
...
// packages/ag-charts-enterprise/src/series/sunburst/sunburstSeriesModule.ts
var { EXTENDS_SERIES_DEFAULTS, DEFAULT_INSIDE_SERIES_LABEL_COLOUR } = import_ag_charts_community86._Theme;
var SunburstSeriesModule = {
  ...
  paletteFactory: ({ takeColors, colorsCount, themeTemplateParameters }) => {
    const { properties } = themeTemplateParameters;
    const { fills, strokes } = takeColors(colorsCount);
    const defaultColorRange = properties.get(import_ag_charts_community86._Theme.DEFAULT_DIVERGING_SERIES_COLOUR_RANGE);
...
var { Label: Label7 } = import_ag_charts_community87._Scene;
var {
...
} = import_ag_charts_community87._ModuleSupport;
...
// packages/ag-charts-enterprise/src/series/treemap/treemapSeries.ts
var { Rect: Rect4, Group: Group9, BBox: BBox7, Selection: Selection5, Text: Text8 } = import_ag_charts_community88._Scene;
var { Color: Color2, Logger: Logger6, isEqual, sanitizeHtml: sanitizeHtml9 } = import_ag_charts_community88._Util;
...
var _TreemapSeries = class _TreemapSeries extends import_ag_charts_community88._ModuleSupport.HierarchySeries {
  constructor() {
    super(...arguments);
...
} = import_ag_charts_community89._Theme;
...
var _WaterfallSeries = class _WaterfallSeries extends import_ag_charts_community91._ModuleSupport.AbstractBarSeries {
  ...
  getSeriesDomain(direction) {
    ...
    if (direction === this.getCategoryDirection()) {
      ...
      const scalePadding = smallestX != null && isFinite(smallestX) ? smallestX : 0;
      const keysExtent = (_a2 = import_ag_charts_community91._ModuleSupport.extent(keys)) != null ? _a2 : [NaN, NaN];
      const categoryAxis = this.getCategoryAxis();
      const isReversed = categoryAxis == null ? void 0 : categoryAxis.isReversed();
...
var WaterfallModule = {
  ...
  seriesDefaults: {
    axes: [
      {
        type: import_ag_charts_community93._Theme.CARTESIAN_AXIS_TYPE.CATEGORY,
        position: import_ag_charts_community93._Theme.POSITION.BOTTOM
      },
      {
        type: import_ag_charts_community93._Theme.CARTESIAN_AXIS_TYPE.NUMBER,
        position: import_ag_charts_community93._Theme.POSITION.LEFT
      }
    ]
  },
...
function setupEnterpriseModules() {
  ...
  import_ag_charts_community94._ModuleSupport.registerModule(DataSourceModule);
  import_ag_charts_community94._ModuleSupport.registerModule(ErrorBarsModule);
  import_ag_charts_community94._ModuleSupport.registerModule(NavigatorModule);
  ...
  import_ag_charts_community94._ModuleSupport.registerModule(SyncModule);
