...
export declare function computeSectorSeriesFocusBounds(series: SectorSeries, opts: PickFocusInputs): BBox | undefined;
export declare function computeSectorFocusBounds(datum: SectorVariables, centerX: number, centerY: number): BBox | undefined;
export {};
