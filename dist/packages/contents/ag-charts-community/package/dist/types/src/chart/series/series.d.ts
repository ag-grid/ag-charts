...
export declare function groupAccumulativeContinuityProperty<K>(propName: K, opts: Partial<DatumPropertyDefinition<K>> & {
    rangeId?: string;
    groupId: string;
}, scaleType?: ScaleType): (import("../data/dataModel").GroupValueProcessorDefinition<any, any> | DatumPropertyDefinition<K>)[];
