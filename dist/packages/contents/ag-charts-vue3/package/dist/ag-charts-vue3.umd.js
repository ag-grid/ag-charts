...
})((typeof self !== 'undefined' ? self : this), function(__WEBPACK_EXTERNAL_MODULE__504__, __WEBPACK_EXTERNAL_MODULE__203__) {
...
__webpack_require__.d(__webpack_exports__, {
  AgChartsVue: function() { return /* reexport */ AgChartsVue; }
});
...
var external_agCharts_ = __webpack_require__(504);
...
let AgChartsVue = class AgChartsVue extends Vue {
    ...
    render() {
        return (0,external_commonjs_vue_commonjs2_vue_root_Vue_.h)('div', { style: { height: '100%' }, ref: 'agChartRef' });
    }
    mounted() {
    ...
    processChanges(currentValue, previousValue) {
        if (this.isCreated && this.chart) {
            external_agCharts_.AgCharts.update(this.chart, toRaw(this.applyContainerIfNotSet(toRaw(this.options))));
        }
    }
...
//# sourceMappingURL=ag-charts-vue3.umd.js.map