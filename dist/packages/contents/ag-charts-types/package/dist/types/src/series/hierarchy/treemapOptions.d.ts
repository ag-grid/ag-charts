...
export interface AgTreemapSeriesTooltipRendererParams<TDatum> extends AgChartCallbackParams<TDatum>, AgTreemapSeriesOptionsKeys, AgTreemapSeriesOptionsNames {
...
export interface AgTreemapSeriesOptions<TDatum = any> extends Omit<AgBaseSeriesOptions<TDatum>, 'highlightStyle'>, AgTreemapSeriesOptionsKeys, AgTreemapSeriesOptionsNames, AgTreemapSeriesThemeableOptions<TDatum> {
...
export interface AgTreemapSeriesItemStylerParams<TDatum> extends DatumCallbackParams<TDatum>, AgTreemapSeriesOptionsKeys, AgTreemapSeriesStyle {
    /** The depth of the datum in the hierarchy. */
    depth: number;
}
export interface AgTreemapSeriesLabelFormatterParams<_TDatum = any> extends AgTreemapSeriesOptionsKeys, AgTreemapSeriesOptionsNames {
    /** The depth of the datum in the hierarchy. */
    depth: number;
}
