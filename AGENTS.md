...
rules[26]:
  - path: @.opencode/memories/api-contracts.md
  ...
  - path: @.opencode/memories/data-model.md
  ...
  - path: @.opencode/memories/defaults.md
  ...
  - path: @.opencode/memories/dom-performance.md
    description: "DOM performance patterns for AG Charts — caching, invalidation, and avoiding forced relayouts"
    applyTo[2]: packages/*/src/dom/**,packages/*/src/chart/tooltip/**
  - path: @.opencode/memories/examples-framework-patterns.md
  ...
  - path: @.opencode/memories/playbook-bug-fix.md
  ...
  - path: @.opencode/memories/server-side-rendering.md
